...
export type CurriculumHomePageQueryVariables = Exact<{ [key: string]: never; }>;


export type CurriculumHomePageQuery = { __typename?: 'query_root', programmes: Array<{ __typename?: 'programmes', programme_id: number, programme_fields: any }> };


export const CurriculumHomePageDocument = gql`
    query curriculumHomePage {
  programmes(
    where: {_state: {_eq: "new"}, _deleted: {_eq: false}, _not: {programme_fields: {_has_keys_any: "keystage"}}}
  ) {
    programme_id
    programme_fields
  }
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    curriculumHomePage(variables?: CurriculumHomePageQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<CurriculumHomePageQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<CurriculumHomePageQuery>(CurriculumHomePageDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'curriculumHomePage', 'query');
    }
  };
}
