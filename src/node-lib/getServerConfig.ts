...
const envVars = satisfies<Record<string, EnvVar>>()({
  ...
  curriculumApi2026AuthKey: {
    value: process.env.CURRICULUM_API_2026_AUTH_KEY,
    envName: "CURRICULUM_API_2026_AUTH_KEY",
    required: true,
    availableInBrowser: false,
    default: null,
  },
  ...
  educatorApiAuthKey: {
    value: process.env.EDUCATOR_API_AUTH_KEY,
    envName: "EDUCATOR_API_AUTH_KEY",
    required: true,
    availableInBrowser: false,
    default: null,
  },
  educatorApiAuthRole: {
    value: process.env.EDUCATOR_API_AUTH_ROLE,
    envName: "EDUCATOR_API_AUTH_ROLE",
    required: true,
    availableInBrowser: false,
    default: null,
  },
