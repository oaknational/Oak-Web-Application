import { curriculumSubjectPhaseOverviewData } from "..";

const curriculumOverviewFixture = (
  partial?: Partial<curriculumSubjectPhaseOverviewData>
...
export default curriculumOverviewFixture;
