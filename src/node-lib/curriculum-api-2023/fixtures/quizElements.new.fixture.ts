...
const withPublishedState = <T extends Omit<NonNullable<QuizQuestion>, "State">>(
  questions: T[],
): NonNullable<QuizQuestion>[] =>
...
export const quizQuestions: NonNullable<QuizQuestion>[] = withPublishedState([
  {
