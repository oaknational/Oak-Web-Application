...
const lessonOverviewFixture = (
  ...
  return {
    ...
    downloads: [
      { exists: true, type: "intro-quiz-answers", inGcsBucket: true },
      { exists: true, type: "intro-quiz-questions", inGcsBucket: true },
      { exists: true, type: "exit-quiz-answers", inGcsBucket: true },
      { exists: true, type: "exit-quiz-questions", inGcsBucket: true },
      { exists: true, type: "worksheet-pdf", inGcsBucket: true },
      { exists: true, type: "worksheet-pptx", inGcsBucket: true },
      { exists: true, type: "presentation", inGcsBucket: true },
    ],
