  ...
  if (__AVO_ENV__ !== AvoEnv.Prod) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "fOlHJypRwg",
        "94eb04c5b54d654b87aac7d22339d82b188e99e10a090e85cf2aac7200a0511c",
        messages.map((m) =>
          Object.assign(
            {},
            {
 ...
 */
export function classroomSignInCompleted(
  properties: ClassroomSignInCompletedProperties,
) {
  // @ts-ignore
  let eventPropertiesArray: array = [];
  eventPropertiesArray.push({
  ...
  properties.googleLoginHint !== undefined &&
  properties.googleLoginHint !== null
    ? eventPropertiesArray.push({
        id: "86AjgGPsfPrUhMUY_Hkkl",
        name: "Google Login Hint",
        value: properties.googleLoginHint,
      })
    : eventPropertiesArray.push({
        id: "86AjgGPsfPrUhMUY_Hkkl",
        name: "Google Login Hint",
  ...
  properties.subscribeToNewsletter !== undefined &&
  properties.subscribeToNewsletter !== null
    ? eventPropertiesArray.push({
        id: "Sza_J1MUhDDXo4a1tdel-",
        name: "Subscribe to Newsletter",
        value: properties.subscribeToNewsletter,
      })
    : eventPropertiesArray.push({
        id: "Sza_J1MUhDDXo4a1tdel-",
        name: "Subscribe to Newsletter",
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "b7534ea2-1ff5-4707-9395-b93dd01d8944",
        "e78d036e726dff9aa9fb12425ed9676f91675e2f0abb8c7af50ca7e2a2cc5acf",
        messages.map((m) =>
          Object.assign(
            {},
            {
 ...
 */
export function classroomSignInStarted(
  properties: ClassroomSignInStartedProperties,
) {
  // @ts-ignore
  let eventPropertiesArray: array = [];
  eventPropertiesArray.push({
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod) {
    ...
    if (!__AVO_NOOP__) {
      _avo_invoke(
        __AVO_ENV__,
        "NH1qVkE2GB5IFRN2i5QyY",
        "40fd3d414ff19fa3b66c1b113ca7e11d2eecdffc6e8965bfa9b829c7a04ccb65",
        messages.map((m) =>
          Object.assign(
            {},
            {
...
// AVOMODULEMAP:"Avo"
// AVOEVENTMAP:["userSignUpCompleted","userSignIn","userSignOut","classroomSignInCompleted","classroomSignInStarted"]
