...
export function userSignUpCompleted(properties: UserSignMinusUpCompletedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "fOlHJypRwg", "cedc1f91027ecf75bf50aa792cd47e0d4593b1b82b4fad5fefb929588d45d7eb", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    return Promise.all([
      ...
      __INSPECTOR__ != null
        // @ts-ignore
        ? __INSPECTOR__._avoFunctionTrackSchemaFromEvent("User Sign-Up Completed", eventProperties, "fOlHJypRwg", "cedc1f91027ecf75bf50aa792cd47e0d4593b1b82b4fad5fefb929588d45d7eb")
      : Promise.resolve(),
