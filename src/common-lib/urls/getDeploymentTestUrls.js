...
function getDeploymentTestUrls() {
  return [
    ...
    "/teachers/programmes/computing-secondary-ks4/units",
    "/teachers/programmes/maths-secondary-ks4-foundation/units/directed-numbers-fe66/lessons", // unit with tiers
    "/teachers/programmes/english-primary-ks2/units/oliver-twist-narrative-writing-280c/lessons?page=2", // unit with pagination
    "teachers/programmes/design-technology-secondary-ks3/units/packaging-pop-outs-bc35/lessons/designing-for-others-6mtk2t", // all yellow boxes
    "/teachers/programmes/maths-secondary-ks4-foundation/units/directed-numbers-fe66/lessons/adding-directed-numbers-chjk4t/downloads?preselected=slide+deck",
