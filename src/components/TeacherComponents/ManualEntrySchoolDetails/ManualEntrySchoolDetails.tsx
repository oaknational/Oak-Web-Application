...
import { OnboardingFormProps } from "@/components/TeacherViews/Onboarding/Onboarding.view";
...
type ManualEntrySchoolDetailsProps = {
  ...
  setValue: UseFormSetValue<OnboardingFormProps>;
  setRenderManualSchoolInput: Dispatch<SetStateAction<boolean>>;
  control: Control<OnboardingFormProps>;
  hasErrors: FieldErrors<OnboardingFormProps>;
  onManualSchoolInputChange: (
    manualSchoolName: string,
    schoolAddress: string,
  ) => void;
  reset: UseFormReset<OnboardingFormProps>;
};
