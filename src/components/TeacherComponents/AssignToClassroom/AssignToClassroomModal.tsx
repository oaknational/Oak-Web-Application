...
} from "@/browser-lib/google-classroom/googleClassroomApi";
  ...
  const handleAssign = async () => {
    ...
    try {
      const result = await googleClassroomApi.createCourseWork({
        ...
        programmeSlug,
        unitSlug,
        ...(exitQuizNumQuestions && { maxPoints: exitQuizNumQuestions }),
      });
      setState({
        type: "success",
        title: result.title,
        ...
        return (
          <OakFlex $flexDirection="column" $gap="spacing-24">
            ...
            <OakP id="assign-modal-description">
              Sign in with Google to assign this lesson directly to your Google
              Classroom.
            </OakP>
      ...
      case "success":
        return (
          <OakFlex $flexDirection="column" $gap="spacing-24">
            ...
            <OakP id="assign-modal-description">
              &ldquo;{state.title}&rdquo; has been added to your Google
