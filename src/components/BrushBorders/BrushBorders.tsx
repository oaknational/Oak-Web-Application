  ...
  return (
    <div aria-hidden="true" data-testid="brush-borders">
      <BrushBorderTop
        ...
        height="100%"
      >
        <use xlinkHref="#svg-sprite-brush-border-top" />
      </BrushBorderTop>
      <BrushBorderRight
        xmlns="http://www.w3.org/2000/svg"
        width="100%"
        height="100%"
      >
        <use xlinkHref="#svg-sprite-brush-border-right" />
      </BrushBorderRight>
      <BrushBorderBottom
        xmlns="http://www.w3.org/2000/svg"
        width="100%"
        height="100%"
      >
        <use xlinkHref="#svg-sprite-brush-border-bottom" />
      </BrushBorderBottom>
      <BrushBorderLeft
        xmlns="http://www.w3.org/2000/svg"
        width="100%"
        height="100%"
      >
        <use xlinkHref="#svg-sprite-brush-border-left" />
      </BrushBorderLeft>
    </div>
  );
};
