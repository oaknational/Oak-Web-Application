...
/**
 * Intro page shared by the canonical, browse and preview pupil lesson routes.
 *
 * Worksheet resolution lives here at the container level (so the nested
 * presentational `IntroContent` only receives resolved data) and is shared
 * across all three routes via this single component.
 */
const IntroPageContent = (props: PupilLessonPageProps) => {
  const {
    browseData,
    lessonContent,
    hasWorksheet,
