...
jest.mock("@/components/PupilComponents/QuizQuestions/QuizResultMCQ", () => ({
  QuizResultMCQ: () => <div>Multiple Choice Question</div>,
}));
jest.mock(
  "@/components/PupilComponents/QuizQuestions/QuizResultShortAnswer",
  () => ({
    QuizResultShortAnswer: () => <div>Short Answer Question</div>,
  }),
);
jest.mock("@/components/PupilComponents/QuizQuestions/QuizResultOrder", () => ({
  QuizResultOrder: () => <div>Order Question</div>,
}));
jest.mock("@/components/PupilComponents/QuizQuestions/QuizResultMatch", () => ({
