...
export const BlogSectionHeading = Template.bind({});
BlogSectionHeading.args = {
  portableText: [sectionHeading],
};

export const BlogVideo = Template.bind({});
BlogVideo.args = {
  portableText: [video],
};

export const BlogQuote = Template.bind({});
BlogQuote.args = {
  portableText: [quote],
};

export const BlogTextAndMedia = Template.bind({});
BlogTextAndMedia.args = {
  portableText: [textAndMedia],
};

export const BlogCallout = Template.bind({});
BlogCallout.args = {
