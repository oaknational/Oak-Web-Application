...
import { SerializedBlogPostPreview } from "../../components/GenericPagesViews/BlogIndex.page";
import { SerializedWebinarPreview } from "../../components/GenericPagesViews/WebinarsIndex.page";
