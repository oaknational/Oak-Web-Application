// Generated by Avo VERSION 166.6.0. You should never have to make changes to this file.
...
export function teacherNoteDialogueOpened(properties: TeacherNoteDialogueOpenedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "ZfGgVMk2GGv2hxZQMZDBl", "b182da6114d394120d30390c288e26ace8d21cc3d1e76a51ec7065e991baac38", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Teacher Note Dialogue Opened", eventProperties, "ZfGgVMk2GGv2hxZQMZDBl", "b182da6114d394120d30390c288e26ace8d21cc3d1e76a51ec7065e991baac38");
    }
    // destination PostHogEU
