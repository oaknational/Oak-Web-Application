// Generated by Avo VERSION 167.1.0. You should never have to make changes to this file.
...
export function teacherShareActivated(properties: TeacherShareActivatedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "ttpIP3aUQX2", "77b2b96ce8a1f7a8d4f88dc7730f1f1a7851c19f681c6bf377cc30591383b9fc", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Teacher Share Activated", eventProperties, "ttpIP3aUQX2", "77b2b96ce8a1f7a8d4f88dc7730f1f1a7851c19f681c6bf377cc30591383b9fc");
    }
    // destination PostHogEU
...
export function teacherNoteSaved(properties: TeacherNoteSavedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "rY3jUdERBSrdNUQPY_2h-", "62d89ca85101b63872c607bbcd892614383a04b7090fcf03f724e3072195aee4", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Teacher Note Saved", eventProperties, "rY3jUdERBSrdNUQPY_2h-", "62d89ca85101b63872c607bbcd892614383a04b7090fcf03f724e3072195aee4");
    }
    // destination PostHogEU
