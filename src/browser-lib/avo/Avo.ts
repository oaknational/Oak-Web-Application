// Generated by Avo VERSION 124.38.0. You should never have to make changes to this file.
...
export function lessonSectionCompleted(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "sBllxa-nuz", "342aaabd9abb6eff17c117ce8ace3ed52350e389f1a2811439bd278e7c5a24bd", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Section Completed", eventProperties, "sBllxa-nuz", "342aaabd9abb6eff17c117ce8ace3ed52350e389f1a2811439bd278e7c5a24bd");
    }
    // destination PostHogEU
...
export function lessonSectionStarted(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "8LfOc60dl", "f1c3cc4b4f35c140aeacabb2ed98af2cba96c56feff89e825e2df7afb919f377", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Section Started", eventProperties, "8LfOc60dl", "f1c3cc4b4f35c140aeacabb2ed98af2cba96c56feff89e825e2df7afb919f377");
    }
    // destination PostHogEU
...
export function lessonSectionAbandoned(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "lucA3x3s4", "9e63c13320d92fdd7e481ed8fa9e4d05a5ac215623fd3ba1d327ccd681ace732", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Section Abandoned", eventProperties, "lucA3x3s4", "9e63c13320d92fdd7e481ed8fa9e4d05a5ac215623fd3ba1d327ccd681ace732");
    }
    // destination PostHogEU
