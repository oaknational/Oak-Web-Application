// Generated by Avo VERSION 174.1.0. You should never have to make changes to this file.
...
export function contentGuidanceAccepted(properties: ContentGuidanceAcceptedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "1u1gDPFXp3", "97933617d28688ddbf961c33c179927101fc9235391ce528d6d66a849fc6cfab", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Content Guidance Accepted", eventProperties, "1u1gDPFXp3", "97933617d28688ddbf961c33c179927101fc9235391ce528d6d66a849fc6cfab");
    }
    // destination PostHogEU
