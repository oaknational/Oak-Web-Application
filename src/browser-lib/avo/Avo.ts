// Generated by Avo VERSION 178.1.0. You should never have to make changes to this file.
...
export function lessonResourcesDownloaded(properties: LessonResourcesDownloadedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "k9ZQJai7ws", "7e6d3f04a975389e450971af824537e02e68766d8409064a440a34fd8eec65e9", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Resources Downloaded", eventProperties, "k9ZQJai7ws", "7e6d3f04a975389e450971af824537e02e68766d8409064a440a34fd8eec65e9");
    }
    // destination PostHogEU
