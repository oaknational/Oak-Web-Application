...
export function classroomLessonsAttached(properties: ClassroomLessonsAttachedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "t7nhIQuz1fXoUi0xheAxT", "2572970fd5ce17f7ecabffbde8b7fda58e38f4c992fe60d7b043e9b9a0a14157", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Classroom Lessons Attached", eventProperties, "t7nhIQuz1fXoUi0xheAxT", "2572970fd5ce17f7ecabffbde8b7fda58e38f4c992fe60d7b043e9b9a0a14157");
    }
    // destination PostHogEU
