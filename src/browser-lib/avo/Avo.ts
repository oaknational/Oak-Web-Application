// Generated by Avo VERSION 114.79.0. You should never have to make changes to this file.
 ...
 * @param properties.unitId: Unique ID of the unit
 ...
 * @param properties.lessonId: Unique ID of the lesson
...
export function resourcesDownloaded(properties: ResourcesDownloadedProperties
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "k9ZQJai7ws", "8d165b4bbe8bcc99eff03bbbc2ee703f76225513df1f8615cb947254a8fd15a9", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
    ...
    if (__WEB_DEBUGGER__) {
      ...
      {id: "6gnvRDRbh", name: "Unit ID", value: properties.unitId},
      ...
      {id: "Cr15RqxLq", name: "Lesson ID", value: properties.lessonId},
  ...
  eventProperties["Unit ID"] = properties.unitId;
  ...
  eventProperties["Lesson ID"] = properties.lessonId;
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Resources Downloaded", {
        ...
        "Resource Type": properties.resourceType,
        "Use Case": properties.useCase,
        }, "k9ZQJai7ws", "8d165b4bbe8bcc99eff03bbbc2ee703f76225513df1f8615cb947254a8fd15a9");
    }
    // destination PostHog
...
export function unitSelected(properties: UnitSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "Me4ouIgPxh", "b52ab57af9cf87237bd225b5dc3cec645de4e89a04c86bb0f04a454bdc24a2ca", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Unit Selected", {
        ...
        "Unit ID": properties.unitId,
        "Use Case": properties.useCase,
        }, "Me4ouIgPxh", "b52ab57af9cf87237bd225b5dc3cec645de4e89a04c86bb0f04a454bdc24a2ca");
    }
    // destination PostHog
...
export function lessonSelected(properties: LessonSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "iUvld79OSb", "73fd5394cb579ecf49c31ce2c3fa43759a7450672d9120580cfdbfeec6897085", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Selected", {
        ...
        "Lesson ID": properties.lessonId,
        "Use Case": properties.useCase,
        }, "iUvld79OSb", "73fd5394cb579ecf49c31ce2c3fa43759a7450672d9120580cfdbfeec6897085");
    }
    // destination PostHog
...
export function learningThemeSelected(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "Vg3AmapucP", "146f3a6dd5bb72d110b24283cf49ea9708923f980fd7a414a0cd3e4844e4cbba", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Learning Theme Selected", {
        ...
        "Use Case": properties.useCase,
        "Learning Theme Name": properties.learningThemeName,
        }, "Vg3AmapucP", "146f3a6dd5bb72d110b24283cf49ea9708923f980fd7a414a0cd3e4844e4cbba");
    }
    // destination PostHog
...
export function tierSelected(properties: TierSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "6lyU_rQz42", "88476ff39694ad17736935d04e487f6becf01506d1331af29f7572aba7134292", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Tier Selected", {
        ...
        "Tier Name": properties.tierName,
        "Use Case": properties.useCase,
        }, "6lyU_rQz42", "88476ff39694ad17736935d04e487f6becf01506d1331af29f7572aba7134292");
    }
    // destination PostHog
 ...
 * @param properties the properties associatied with this event
 * @param properties.linkUrl: The href of a link
 * @param properties.pageType: The main pages of a user journey eg. subject listing, unit listing, etc
 * @param properties.useCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
...
export function pageView(properties: PageViewProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "iYVEEwNT0q", "0c1ffb2affe4b451bac1bbcbff1f9148cd00e6e482daf2f634335612e91ad5e0", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
    InternalAvoLogger.logEventSent("Page View", {
      "Link URL": properties.linkUrl,
      "Page Type": properties.pageType,
      "Use Case": properties.useCase,
      }, {});
    if (__WEB_DEBUGGER__) {
      // Avo web debugger
      ...
      {id: "cJ1c_F_Qih", name: "Link URL", value: properties.linkUrl},
      {id: "LgWcfE0FOm", name: "Page Type", value: properties.pageType},
      {id: "DAS5R4dcvH", name: "Use Case", value: properties.useCase},
      ], [], []);
    }
  }
  ...
  let eventProperties: any = {};
  eventProperties["Link URL"] = properties.linkUrl;
  eventProperties["Page Type"] = properties.pageType;
  eventProperties["Use Case"] = properties.useCase;
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Page View", {
        ...
        "Page Type": properties.pageType,
        "Use Case": properties.useCase,
        }, "iYVEEwNT0q", "0c1ffb2affe4b451bac1bbcbff1f9148cd00e6e482daf2f634335612e91ad5e0");
    }
    // destination PostHog
...
export function resourceContainerExpanded(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "B-ti6Ajp8", "134fc7dbe2b8e971ffeb53053d3aaa9aaa70ed96f76da2294851a32b05d37e87", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Resource Container Expanded", {
        ...
        "Page Type": properties.pageType,
        "Container Title": properties.containerTitle,
        }, "B-ti6Ajp8", "134fc7dbe2b8e971ffeb53053d3aaa9aaa70ed96f76da2294851a32b05d37e87");
    }
    // destination PostHog
