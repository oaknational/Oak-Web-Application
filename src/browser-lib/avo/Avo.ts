// Generated by Avo VERSION 219.5.0. You should never have to make changes to this file.
...
export function lessonShared(properties: LessonSharedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "RnJu4EY4bA", "02a0dacff8e1bb43714599c0383fd38f870e8629cc13db867487b329ad329342", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Shared", eventProperties, "RnJu4EY4bA", "02a0dacff8e1bb43714599c0383fd38f870e8629cc13db867487b329ad329342");
    }
    // destination PostHogEU
...
export function browseRefined(properties: BrowseRefinedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "qqX_ISnl2q", "594457bbfcf58bd16ac7b51e52f71e5fabfe3c78738cbb46371bb228cef3a30e", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Browse Refined", eventProperties, "qqX_ISnl2q", "594457bbfcf58bd16ac7b51e52f71e5fabfe3c78738cbb46371bb228cef3a30e");
    }
    // destination PostHogEU
...
export function browseRefinedAccessed(properties: BrowseRefinedAccessedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "qqX_ISnl2q.oU4o61r0g", "fa336a9680958609642a1d14a3a04392487519dcb35a744f6af154a325586fc0", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
    InternalAvoLogger.logEventSent("Browse Refined", eventProperties, userProperties);
    if (__WEB_DEBUGGER__) {
      // Avo web debugger
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Browse Refined", eventProperties, "qqX_ISnl2q.oU4o61r0g", "fa336a9680958609642a1d14a3a04392487519dcb35a744f6af154a325586fc0");
    }
    // destination PostHogEU
    PostHogEU.logEvent("Browse Refined", (Object as any).assign({}, eventProperties));
  } else {
...
export function searchFilterModified(properties: SearchFilterModifiedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "JbWzId2dPo6mN6Y3aHwMr", "3ea8a5c9ed7c10bd0777a4bbc1dcdc374803af1800e8e445fcefb6d8deab542b", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Search Filter Modified", eventProperties, "JbWzId2dPo6mN6Y3aHwMr", "3ea8a5c9ed7c10bd0777a4bbc1dcdc374803af1800e8e445fcefb6d8deab542b");
    }
    // destination PostHogEU
...
export function classroomSignInStarted(properties: ClassroomSignInStartedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "NH1qVkE2GB5IFRN2i5QyY", "4bfba88f92b1732a8eb319175b39cc044240d010a4b95378ba674990a76af4dc", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Classroom Sign in Started", eventProperties, "NH1qVkE2GB5IFRN2i5QyY", "4bfba88f92b1732a8eb319175b39cc044240d010a4b95378ba674990a76af4dc");
    }
    // destination PostHogEU
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/oSWvaTUE8hKucXrR3I4V4/trigger/GC1EHCHa7Lm7iUZfbZh7q
 * 
 * @param properties the properties associated with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA, Aila and Google Classroom. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * NB - This will be removed, but keeping to ease transition from AUC to 'product'
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/oSWvaTUE8hKucXrR3I4V4}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/GTkyUItOAwx_e4-aU1pXH/trigger/jCTVX9nXJdT7DwN9dxeKS
 * 
 * @param properties the properties associated with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA, Aila and Google Classroom. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * NB - This will be removed, but keeping to ease transition from AUC to 'product'
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/GTkyUItOAwx_e4-aU1pXH}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/1kAeBL_oSYtSUA_xJrLFz/trigger/CZqCjnoNG1tfXzDfGMQZf
 * 2. User clicks 'get in touch' (component_type = 'get_in_touch')
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/1kAeBL_oSYtSUA_xJrLFz/trigger/0mHzNpxH8P4Eh0nu7LGYK
 * 3. User clicks on 'permanent roles' or 'freelance roles' (component type = 'permanent_roles'/'freelance roles')
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/1kAeBL_oSYtSUA_xJrLFz/trigger/f_oDDB8k7c9p_8ZRnnlsO
 * 
 * @param properties the properties associated with this event
 * @param properties.platform: Describes the 'platform' or 'codebase' from which the event was sent. Historically this would have been acorn, but now this will cover OWA, Aila and Google Classroom. These should typically also have a one to one relationship with the 'sources' as defined in this Avo project (Oak's Tracking Plan).
 * @param properties.product: Product that the event was sent from to clear distinguish between Oak products
 ...
 * NB - This will be removed, but keeping to ease transition from AUC to 'product'
 * 
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/MRpLjEZ3xK-ZX8Dox-YXT/events/1kAeBL_oSYtSUA_xJrLFz}
 */
