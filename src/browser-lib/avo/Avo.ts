...
export function pageView(properties: PageViewProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "iYVEEwNT0q", "c72642cce23b61947fa0ea7463014b5e65597a7fe173a43cb5bbbba011a68fc2", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Page View", {
        ...
        "Page Name": properties.pageName,
        "Analytics Use Case": properties.analyticsUseCase,
        }, "iYVEEwNT0q", "c72642cce23b61947fa0ea7463014b5e65597a7fe173a43cb5bbbba011a68fc2");
    }
    // destination PostHog
...
export function resourceContainerExpanded(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "B-ti6Ajp8", "599ab7226260da2896f749faf989954726e223e174e4aa603c379a1e94332753", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Resource Container Expanded", {
        ...
        "Page Name": properties.pageName,
        "Container Title": properties.containerTitle,
        }, "B-ti6Ajp8", "599ab7226260da2896f749faf989954726e223e174e4aa603c379a1e94332753");
    }
    // destination PostHog
...
export function searchAttempted(properties: SearchAttemptedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "I_dSzYI2PB", "78d4d5c9ded5ee71a456182be859e8676e7bc04aaf3d59fbaaa8d2d7d6390481", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Search Attempted", {
        ...
        "Search Filter Option Selected": properties.searchFilterOptionSelected,
        "Search Source": properties.searchSource,
        }, "I_dSzYI2PB", "78d4d5c9ded5ee71a456182be859e8676e7bc04aaf3d59fbaaa8d2d7d6390481");
    }
    // destination PostHog
...
export function searchResultClicked(properties: SearchResultClickedProperties
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "_TD-gtSgIj", "4832e2f0539ba44d589649811be5392ddf0c58a193264fa71c96a613252cfecc", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Search Result Clicked", {
        ...
        "Search Result Count": properties.searchResultCount,
        "Search Result Type": properties.searchResultType,
        }, "_TD-gtSgIj", "4832e2f0539ba44d589649811be5392ddf0c58a193264fa71c96a613252cfecc");
    }
    // destination PostHog
...
export function searchCompleted(properties: SearchCompletedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "QI7bIsW3os", "946bc247c5a8bea055543ab043d172ab1e2459935cc10c9c2a7c4867a5831447", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Search Completed", {
        ...
        "Search Results Status": properties.searchResultsStatus,
        "Search Results Load Time": properties.searchResultsLoadTime,
        }, "QI7bIsW3os", "946bc247c5a8bea055543ab043d172ab1e2459935cc10c9c2a7c4867a5831447");
    }
    // destination PostHog
...
export function searchJourneyInitiated(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "rYxJBK8Kpm", "a074ee150e57f49f196e9fb675b11c5286543d55c8df933a1e1c0742a07932e1", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Search Journey Initiated", {
        "Search Source": properties.searchSource,
        "Analytics Use Case": properties.analyticsUseCase,
        }, "rYxJBK8Kpm", "a074ee150e57f49f196e9fb675b11c5286543d55c8df933a1e1c0742a07932e1");
    }
    // destination PostHog
...
export function curriculumMapDownloaded(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "W9R2vOSii_", "29349f609b91f38af9756c06090726185d68ec1c5909c6919df8163bb7708c65", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Curriculum Map Downloaded", {
        ...
        "Analytics Use Case": properties.analyticsUseCase,
        "Page Name": properties.pageName,
        }, "W9R2vOSii_", "29349f609b91f38af9756c06090726185d68ec1c5909c6919df8163bb7708c65");
    }
    // destination PostHog
