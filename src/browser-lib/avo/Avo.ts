// Generated by Avo VERSION 110.38.0. You should never have to make changes to this file.
...
export function planALessonSelected() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "6FJxOlnzBp", "e8f9871cf8c59b3deaef829e853da17ddb3dc176717308e9196bc3409c6e79d0", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Plan a Lesson Selected", {}, "6FJxOlnzBp", "e8f9871cf8c59b3deaef829e853da17ddb3dc176717308e9196bc3409c6e79d0");
    }
...
export function newsletterSignUpCompleted() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "sLqKBjU-Wt", "e5e573c0f0c74aab4a3b8c04269ed4a470d862f4e4a2438fa81377ff494b38bb", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Newsletter Sign Up Completed", {}, "sLqKBjU-Wt", "e5e573c0f0c74aab4a3b8c04269ed4a470d862f4e4a2438fa81377ff494b38bb");
    }
    // destination PostHogEU
...
export function classroomSelected(properties: ClassroomSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "esgLdNSBsj", "2e4ba2e0e2598cfd6643594060a948585df3864ef55ac72d0227eaad446e0930", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Classroom Selected", {
        "Navigated From": properties.navigatedFrom,
        }, "esgLdNSBsj", "2e4ba2e0e2598cfd6643594060a948585df3864ef55ac72d0227eaad446e0930");
    }
    // destination PostHogEU
...
export function teacherHubSelected(properties: TeacherHubSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "kp-dTd4WU3", "f0dd098437e60752a0b7484b15ee332f5248e82fcca6aae064fca66d3dbdd335", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Teacher Hub Selected", {
        "Navigated From": properties.navigatedFrom,
        }, "kp-dTd4WU3", "f0dd098437e60752a0b7484b15ee332f5248e82fcca6aae064fca66d3dbdd335");
    }
    // destination PostHogEU
...
export function developYourCurriculumSelected() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "pI9xLEeG6a", "4641c0f5ae2b4488817ae99db0b180614d4e41e596a15e70fef3d97971819745", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Develop Your Curriculum Selected", {}, "pI9xLEeG6a", "4641c0f5ae2b4488817ae99db0b180614d4e41e596a15e70fef3d97971819745");
    }
    // destination PostHogEU
...
export function notificationSelected(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "M_zZRmq4zA", "72e7f72a66a62380a16a98451d3bed9c49a118b397ebac6dbfee86e319749398", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Notification Selected", {
        "Link URL": properties.linkUrl,
        "Notification Headline": properties.notificationHeadline,
        }, "M_zZRmq4zA", "72e7f72a66a62380a16a98451d3bed9c49a118b397ebac6dbfee86e319749398");
    }
    // destination PostHogEU
...
export function aboutSelected() {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "Aj3imCEK7t", "167787563859bc11f13ddd19ef6ffc99fda0ce08a3a06c818a4a238ff7e56890", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("About Selected", {}, "Aj3imCEK7t", "167787563859bc11f13ddd19ef6ffc99fda0ce08a3a06c818a4a238ff7e56890");
    }
    // destination PostHogEU
...
export function videoStarted(properties: VideoStartedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "G0I28K0B2f", "a45710cff3ac3dd61740a98b0e62d72767deead251246defa39c05b7a1f73ac4", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Video Started", {
        ...
        "Time Elapsed (Seconds)": properties.timeElapsedSeconds,
        "Is Muted": properties.isMuted,
        }, "G0I28K0B2f", "a45710cff3ac3dd61740a98b0e62d72767deead251246defa39c05b7a1f73ac4");
    }
    // destination PostHogEU
...
export function videoPaused(properties: VideoPausedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "z91WauKeVB", "91fcea43a7cfe5b2f048eb9ceb33ee46c63793628cd979e71816d9c31505d27b", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Video Paused", {
        ...
        "Time Elapsed (Seconds)": properties.timeElapsedSeconds,
        "Is Muted": properties.isMuted,
        }, "z91WauKeVB", "91fcea43a7cfe5b2f048eb9ceb33ee46c63793628cd979e71816d9c31505d27b");
    }
    // destination PostHogEU
...
export function videoPlayed(properties: VideoPlayedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "r4DFADUHFh", "ab45ae11f124af6fce90600554da35bc71325a66d7861751361efa0293208ef0", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Video Played", {
        ...
        "Time Elapsed (Seconds)": properties.timeElapsedSeconds,
        "Is Muted": properties.isMuted,
        }, "r4DFADUHFh", "ab45ae11f124af6fce90600554da35bc71325a66d7861751361efa0293208ef0");
    }
    // destination PostHogEU
...
export function videoFinished(properties: VideoFinishedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "NP9klWkaki", "7f4de495718acd1e50db3bd246e58ca929560c2939d0705f5fcafac94758409d", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Video Finished", {
        ...
        "Time Elapsed (Seconds)": properties.timeElapsedSeconds,
        "Is Muted": properties.isMuted,
        }, "NP9klWkaki", "7f4de495718acd1e50db3bd246e58ca929560c2939d0705f5fcafac94758409d");
    }
    // destination PostHogEU
