// Generated by Avo VERSION 122.286.0. You should never have to make changes to this file.
 ...
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6FJxOlnzBp/trigger/Hgd_u_6rr
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6FJxOlnzBp}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/sLqKBjU-Wt/trigger/_MC_apwfp
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/sLqKBjU-Wt}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/esgLdNSBsj/trigger/d46nqqMBY
 * 2. Classroom app selected from menu
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/esgLdNSBsj/trigger/M_vqoTLFQ
 *
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/esgLdNSBsj}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/kp-dTd4WU3/trigger/8sYQASFRC
 * 2. Teacher Hub selected from menu
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/kp-dTd4WU3/trigger/_JhfvPPiP
 *
 * @param properties the properties associatied with this event
 * @param properties.navigatedFrom: The location of the link used to navigate to the current page
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/kp-dTd4WU3}
 */
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/pI9xLEeG6a/trigger/dRt9RWsfe
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/pI9xLEeG6a}
 */
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/LqBk-euseD/trigger/F9AZuqUAA
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/LqBk-euseD}
 */
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/M_zZRmq4zA/trigger/8JSZfjNwi
 *
 * @param properties the properties associatied with this event
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/M_zZRmq4zA}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Aj3imCEK7t}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/G0I28K0B2f}
 */
 ...
 * @param properties.videoLocation: Where is the video on the site (eg. webinar, marketing, lesson, blog, etc)
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/z91WauKeVB}
 */
 ...
 * @param properties.videoLocation: Where is the video on the site (eg. webinar, marketing, lesson, blog, etc)
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/r4DFADUHFh}
 */
 ...
 * @param properties.videoLocation: Where is the video on the site (eg. webinar, marketing, lesson, blog, etc)
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/NP9klWkaki}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/k9ZQJai7ws/trigger/sAqordxVG
 *
 * @param properties the properties associatied with this event
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/k9ZQJai7ws}
 */
 ...
 * When to trigger this event:
 * 1.
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/7ONADbQPez/trigger/bkIRr49k7
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/7ONADbQPez}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/ufkcMq0HT4/trigger/Pl87P0XPk
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/ufkcMq0HT4}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Me4ouIgPxh/trigger/t8lbfIsGe
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Me4ouIgPxh}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/iUvld79OSb/trigger/TnGi5eBdB
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/iUvld79OSb}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6DwKZEuYUk/trigger/Y36tMwp1l
 *
 * @param properties the properties associatied with this event
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6DwKZEuYUk}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/-9FHudlATb}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Ls0Ou1w7qK/trigger/RAhU-otN8
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Ls0Ou1w7qK}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Vg3AmapucP/trigger/ssM2tCEE3
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Vg3AmapucP}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6lyU_rQz42/trigger/HHKzuwVa4
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectTitle: Title of the current subject.
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/6lyU_rQz42}
 */
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/iYVEEwNT0q}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/B-ti6Ajp8/trigger/57LUx8uOY
 *
 * @param properties the properties associatied with this event
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 * @param properties.pageName: The main pages of a user journey eg. subject listing, unit listing, etc
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/B-ti6Ajp8}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/W9R2vOSii_/trigger/l30pZnEW3
 * 2. User clicks the Curriculum download (PDF) button on a lesson listing page
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/W9R2vOSii_/trigger/0LJTo1tA3
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectTitle: Title of the current subject.
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.pageName: The main pages of a user journey eg. subject listing, unit listing, etc
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/W9R2vOSii_}
 */
export function curriculumMapDownloaded(
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "W9R2vOSii_", "e5a218ab15db32ac0babe3d4882c583608e1f30b9d882462c709d50804568b9f", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Curriculum Map Downloaded", eventProperties, "W9R2vOSii_", "e5a218ab15db32ac0babe3d4882c583608e1f30b9d882462c709d50804568b9f");
    }
    // destination PostHogEU
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/0n50tfMg2N/trigger/w2ACuk2F3
 * 2. An individual resource download button on an expandable container is clicked (eg. slide deck, starter quiz, worksheet, etc)
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/0n50tfMg2N/trigger/5PBz6j66G
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/0n50tfMg2N}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/I_dSzYI2PB/trigger/GRZ05_zLD
...
clicking "Go", or
pressing ENTER
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/I_dSzYI2PB/trigger/SG8O6HFoP
 * 3. A search is initiated from the homepage by clicking on one of the search suggestion option beneath the search box
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/I_dSzYI2PB/trigger/5gULgsDoY
 *
 * @param properties the properties associatied with this event
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/I_dSzYI2PB}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/_TD-gtSgIj/trigger/ZezXTZ0ri
 *
 * @param properties the properties associatied with this event
 * @param properties.keyStageTitle: Title of the current key stage.
 * @param properties.keyStageSlug: Human-readable unique ID of the current key stage.
 ...
 * @param properties.context: Relates to the application or view from which a action was performed
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/_TD-gtSgIj}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/QI7bIsW3os/trigger/IQb7tOYbR
 *
 * @param properties the properties associatied with this event
 * @param properties.searchFilterOptionSelected: The specific search filter option that has been selected (eg. 'ks2,ks3')
NB. ensure filters are sent in a consistent order
 ...
 * @param properties.context: Relates to the application or view from which a action was performed
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/QI7bIsW3os}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/rYxJBK8Kpm/trigger/aeEheVqLW
 * 2. A user types in the search bar on the search page (first letter is typed)
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/rYxJBK8Kpm/trigger/5OM1jFoWf
 *
 * @param properties the properties associatied with this event
 * @param properties.searchSource: The location of the search box/entry point.
eg. homepage search box, search page search box, hamburger menu search box (future)
 * @param properties.context: Relates to the application or view from which a action was performed
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/rYxJBK8Kpm}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/_ImUDkApb7/trigger/R19ayisHj
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/_ImUDkApb7/trigger/LFOFUdkpr
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectTitle: Title of the current subject.
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/_ImUDkApb7}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/sR1S6swOBk/trigger/0ajfpuq__
 *
 * @param properties the properties associatied with this event
 * @param properties.subjectTitle: Title of the current subject.
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/sR1S6swOBk}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/OnjKTo8kYs/trigger/I6HnzeUNk
 *
 * @param properties the properties associatied with this event
 * @param properties.unitName: Title of the current unit.
 * @param properties.unitSlug: Human-readable unique ID of the current unit.
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/OnjKTo8kYs}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/H9jrWEk8wy/trigger/t_FkWxgTH
 *
 * @param properties the properties associatied with this event
 * @param properties.unitName: Title of the current unit.
 * @param properties.unitSlug: Human-readable unique ID of the current unit.
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/H9jrWEk8wy}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/RnJu4EY4bA/trigger/lvtGVFDJo
 *
 * @param properties the properties associatied with this event
 * @param properties.lessonName: Name of the current lesson.
 * @param properties.lessonSlug: Human-readable unique ID of the current lesson.
 ...
 * @param properties.emailSupplied: A user has signed up for updates on the downloads page
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/RnJu4EY4bA}
 */
 ...
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/PS8tcnGrN2/trigger/Lsaaeanis
 * 2. Share activities with pupils button clicked at the resource level

NB. There is no sharing of slide decks at this time
 * View in Avo: https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/PS8tcnGrN2/trigger/QMYuEgDaG
 *
 * @param properties the properties associatied with this event
 * @param properties.lessonName: Name of the current lesson.
 * @param properties.lessonSlug: Human-readable unique ID of the current lesson.
 ...
 * @param properties.subjectSlug: Human-readable unique ID of the current subject.
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/PS8tcnGrN2}
 */
 ...
 * @param properties.searchResultCount: total number of search results returned
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/XpQ27vPNH4}
 */
 ...
 * @param properties.searchResultType: The type of result returned (eg. unit or lesson)
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/eP2lOQQj8C}
 */
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/Hy-6QNrYKU}
 */
export function lessonCompleted(properties: LessonCompletedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "Hy-6QNrYKU", "906f6f03a51924133ea1579135d91aceb94f246047f59c680614eefea6dcb0b4", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      // @ts-ignore
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Lesson Completed", eventProperties, "Hy-6QNrYKU", "906f6f03a51924133ea1579135d91aceb94f246047f59c680614eefea6dcb0b4");
    }
    // destination PostHogEU
 ...
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/sBllxa-nuz}
 */
 ...
 * @param properties.analyticsUseCase: User is engaging with the site as a pupil or a teacher as defined by the page url (eg. thenational.academy/pupils or thenational.academy/teachers
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/9zz1OCsT2}
 */
 ...
 * @param properties.pupilExperienceLessonSection: no description
 *
 * @see {@link https://www.avo.app/schemas/5PhajbVijwhXVKIJtGMT/branches/ZnZhxgYCK/events/8LfOc60dl}
 */
