// Generated by Avo VERSION 108.101.0. You should never have to make changes to this file.
...
/**
 * Classroom Selected: Classroom app is selected from the Launch Homepage (card or menu)
 *
 * When to trigger this event:
...
export function classroomSelected(properties: ClassroomSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "esgLdNSBsj", "e55d5c75220192db8e1809eb703288d30a649699fb0239401bfbda2d6ae19a30", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Classroom Selected", {
        "Navigated From": properties.navigatedFrom,
        }, "esgLdNSBsj", "e55d5c75220192db8e1809eb703288d30a649699fb0239401bfbda2d6ae19a30");
    }
    // destination PostHog
...
export function teacherHubSelected(properties: TeacherHubSelectedProperties) {
  ...
  if (__AVO_ENV__ !== AvoEnv.Prod || __WEB_DEBUGGER__) {
    ...
    // debug console in Avo
    if (!__AVO_NOOP__) {
      _avo_invoke(__AVO_ENV__, "kp-dTd4WU3", "4d372c982d6f3215e4810c14eac8498d7d1dcb9a8cf3eb127dc73e532d6a93e8", messages.map(m => Object.assign({}, {tag: m.tag, propertyId: m.propertyId, additionalProperties: m.additionalProperties, actualType: m.actualType})), 'event');
    }
  ...
  if (!__AVO_NOOP__) {
    if (__INSPECTOR__ != null) {
      ...
      __INSPECTOR__._avoFunctionTrackSchemaFromEvent("Teacher Hub Selected", {
        "Navigated From": properties.navigatedFrom,
        }, "kp-dTd4WU3", "4d372c982d6f3215e4810c14eac8498d7d1dcb9a8cf3eb127dc73e532d6a93e8");
    }
    // destination PostHog
 ...
 *
 * @param properties the properties associatied with this event
 * @param properties.linkUrl: no description
 * @param properties.notificationHeadline: no description
 *
