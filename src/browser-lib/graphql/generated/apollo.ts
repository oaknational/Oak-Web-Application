...
export type BookmarkedLessonAddMutation = { __typename?: 'mutation_root', insert_bookmarked_lesson_one?: { __typename?: 'bookmarked_lesson', created_at?: any | null, lesson?: { __typename?: 'lesson', id: number, slug: string, title: string } | null } | null };
...
export type BookmarkedLessonRemoveMutation = { __typename?: 'mutation_root', delete_bookmarked_lesson_by_pk?: { __typename?: 'bookmarked_lesson', lesson_id: number, user_id: number } | null };
...
export type BookmarkedLessonsQuery = { __typename?: 'query_root', bookmarked_lesson: Array<{ __typename?: 'bookmarked_lesson', created_at?: any | null, lesson?: { __typename?: 'lesson', id: number, slug: string, title: string } | null }> };
...
export const BookmarkedLessonAddDocument = gql`
    mutation bookmarkedLessonAdd($lessonId: Int!) {
  insert_bookmarked_lesson_one(object: {lesson_id: $lessonId}) {
    lesson {
      id
      slug
      title
...
export const BookmarkedLessonRemoveDocument = gql`
    mutation bookmarkedLessonRemove($lessonId: Int!, $userId: Int!) {
  delete_bookmarked_lesson_by_pk(lesson_id: $lessonId, user_id: $userId) {
    lesson_id
    user_id
  }
}
...
export const BookmarkedLessonsDocument = gql`
  ...
  bookmarked_lesson(order_by: {created_at: desc}) {
    lesson {
      id
      slug
      title
...
/**
 * __useLessonsBySlugQuery__
 *
 * To run a query within a React component, call `useLessonsBySlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useLessonsBySlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLessonsBySlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useLessonsBySlugQuery(baseOptions: Apollo.QueryHookOptions<LessonsBySlugQuery, LessonsBySlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<LessonsBySlugQuery, LessonsBySlugQueryVariables>(LessonsBySlugDocument, options);
      }
export function useLessonsBySlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LessonsBySlugQuery, LessonsBySlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LessonsBySlugQuery, LessonsBySlugQueryVariables>(LessonsBySlugDocument, options);
        }
export type LessonsBySlugQueryHookResult = ReturnType<typeof useLessonsBySlugQuery>;
export type LessonsBySlugLazyQueryHookResult = ReturnType<typeof useLessonsBySlugLazyQuery>;
export type LessonsBySlugQueryResult = Apollo.QueryResult<LessonsBySlugQuery, LessonsBySlugQueryVariables>;