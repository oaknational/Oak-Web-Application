...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    bookmarkedLessonAdd(variables: BookmarkedLessonAddMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<BookmarkedLessonAddMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<BookmarkedLessonAddMutation>(BookmarkedLessonAddDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'bookmarkedLessonAdd');
    },
    bookmarkedLessonRemove(variables: BookmarkedLessonRemoveMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<BookmarkedLessonRemoveMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<BookmarkedLessonRemoveMutation>(BookmarkedLessonRemoveDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'bookmarkedLessonRemove');
    },
    ...
    bookmarkedLessons(variables?: BookmarkedLessonsQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<BookmarkedLessonsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<BookmarkedLessonsQuery>(BookmarkedLessonsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'bookmarkedLessons');
    },
