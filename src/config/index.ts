...
const envVars: Record<ConfigKey, EnvVar> = {
  ...
  sanityGraphqlApiUrl: {
    value: process.env.NEXT_PUBLIC_SANITY_GRAPHQL_URL,
    envName: "NEXT_PUBLIC_SANITY_GRAPHQL_URL",
    required: true,
    availableInBrowser: false,
    default: null,
  },
  sanityGraphqlApiSecret: {
    value: process.env.NEXT_PUBLIC_SANITY_AUTH_SECRET,
    envName: "NEXT_PUBLIC_SANITY_AUTH_SECRET",
    required: true,
    availableInBrowser: false,
    default: null,
  },
