...
const prodCspHeaderFixture = `
    ...
    media-src 'self' blob: *.thenational.academy/ https://res.cloudinary.com https://oaknationalacademy-res.cloudinary.com https://*.cloudinary.com https://*.mux.com/ https://stream.mux.com/ https://*.gleap.io/;
