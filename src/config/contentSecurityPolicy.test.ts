...
const prodCspHeaderFixture = `
    ...
    img-src 'self' blob: data: *.thenational.academy thenational.academy https://vercel.live/ https://vercel.com *.pusher.com/ data: blob: https://res.cloudinary.com https://oaknationalacademy-res.cloudinary.com https://img.clerk.com https://*.mux.com https://stream.mux.com;
    ...
    connect-src *.thenational.academy thenational.academy https://vercel.live/ https://vercel.com *.pusher.com *.pusherapp.com https://eu.i.posthog.com https://api.avo.app/ *.clerk.accounts.dev clerk-telemetry.com https://mux.com https://*.mux.com https://stream.mux.com https://inferred.litix.io *.gleap.io wss://*.gleap.io *.google.com *.bugsnag.smartbear.com *.bugsnag.com;
...
const devCspHeaderFixture = `
    ...
    connect-src *.thenational.academy thenational.academy http://localhost:* https://localhost:* wss://localhost:* ws://localhost:* https://vercel.live/ https://vercel.com *.pusher.com *.pusherapp.com https://eu.i.posthog.com https://api.avo.app/ *.clerk.accounts.dev clerk-telemetry.com https://mux.com https://*.mux.com https://stream.mux.com https://inferred.litix.io *.gleap.io wss://*.gleap.io *.google.com *.bugsnag.smartbear.com *.bugsnag.com;
    media-src 'self' blob: *.thenational.academy https://*.mux.com https://stream.mux.com;
    frame-src 'self' *.thenational.academy https://vercel.live/ https://vercel.com https://challenges.cloudflare.com https://www.avo.app/ https://stream.mux.com https://*.mux.com *.google.com;
    worker-src 'self' blob:;
    report-to oak-csp;
...
//     script-src 'self' 'unsafe-inline' https: http: https://vercel.live https://vercel.com *.clerk.accounts.dev https://cdn.mux.com https://mux.com https://*.mux.com https://stream.mux.com;
//     style-src 'self' 'unsafe-inline' https://vercel.live/ https://*.mux.com;
//     img-src 'self' blob: data: *.thenational.academy thenational.academy https://vercel.live/ https://vercel.com *.pusher.com/ data: blob: https://*.hubspot.com https://*.hsforms.com https://res.cloudinary.com https://oaknationalacademy-res.cloudinary.com https://img.clerk.com https://*.mux.com https://stream.mux.com;
//     font-src 'self' gstatic-fonts.thenational.academy fonts.gstatic.com https://vercel.live/ https://assets.vercel.com;
//     object-src 'self';
//     base-uri 'self';
//     form-action 'self';
//     frame-ancestors 'self' *.google.com;
//     connect-src *.thenational.academy thenational.academy https://vercel.live/ https://vercel.com *.pusher.com *.pusherapp.com *.hubspot.com https://eu.i.posthog.com https://api.avo.app/ *.clerk.accounts.dev clerk-telemetry.com https://mux.com https://*.mux.com https://stream.mux.com https://inferred.litix.io *.gleap.io wss://*.gleap.io *.google.com *.bugsnag.smartbear.com *.bugsnag.com;
//     media-src 'self' blob: *.thenational.academy https://*.mux.com https://stream.mux.com;
//     frame-src 'self' *.thenational.academy https://vercel.live/ https://vercel.com https://challenges.cloudflare.com https://www.avo.app/ https://stream.mux.com https://*.mux.com *.google.com;
//     worker-src 'self' blob:;
...
//     form-action 'self';
//     frame-ancestors 'self' http://localhost:* https://localhost:* *.google.com;
//     connect-src *.thenational.academy thenational.academy http://localhost:* https://localhost:* wss://localhost:* ws://localhost:* https://vercel.live/ https://vercel.com *.pusher.com *.pusherapp.com *.hubspot.com https://eu.i.posthog.com https://api.avo.app/ *.clerk.accounts.dev clerk-telemetry.com https://mux.com https://*.mux.com https://stream.mux.com https://inferred.litix.io *.gleap.io wss://*.gleap.io *.google.com *.bugsnag.smartbear.com *.bugsnag.com;
//     media-src 'self' blob: *.thenational.academy https://*.mux.com https://stream.mux.com;
//     frame-src 'self' *.thenational.academy https://vercel.live/ https://vercel.com https://challenges.cloudflare.com https://www.avo.app/ https://stream.mux.com https://*.mux.com *.google.com;
//     worker-src 'self' blob:;
//     report-uri: http://localhost:3000/api/csp-report;
