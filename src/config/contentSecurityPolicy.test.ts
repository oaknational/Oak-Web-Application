...
const prodCspHeaderFixture = `
    ...
    img-src 'self' blob: data: *.thenational.academy thenational.academy https://vercel.live/ https://vercel.com *.pusher.com/ data: blob: https://*.hubspot.com https://*.hsforms.com https://img.clerk.com https://*.mux.com https://stream.mux.com;
