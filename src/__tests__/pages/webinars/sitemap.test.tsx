...
import { getServerSideProps as getServerSidePropsSitemap } from "@/pages/webinars/sitemap.xml";
  ...
  describe("getServerSideProps", () => {
    it("fetches data and generates fields correctly - sitemap.xml ", async () => {
      ...
      for (const expectedString of [
        "http://example.com/webinars/foo",
        "http://example.com/webinars/bar",
        "http://example.com/webinars/baz",
      ]) {
