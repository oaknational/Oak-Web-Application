...
import PupilLessonExitQuizPage, {
  getStaticProps,
} from "@/pages/pupils/beta/previews/lessons/[lessonSlug]/exit-quiz";
...
describe("pages/pupils/beta/previews/lessons/[lessonSlug]/exit-quiz", () => {
  ...
  describe("getStaticProps", () => {
    it("delegates to getPageProps with an exit-quiz-bound preview context", async () => {
      ...
      expect(buildPageProps).toHaveBeenCalledWith(
        expect.objectContaining({
          page: "pupils-lesson-preview-exit-quiz::getStaticProps",
          context: ctx,
