...
import PupilLessonStarterQuizPage, {
  getStaticProps,
} from "@/pages/pupils/beta/previews/lessons/[lessonSlug]/starter-quiz";
...
describe("pages/pupils/beta/previews/lessons/[lessonSlug]/starter-quiz", () => {
  describe("page component", () => {
    it("renders the QuizPageContent inside the PupilLayout", () => {
      const { getByTestId } = renderWithTheme(
        <PupilLessonStarterQuizPage
  ...
  describe("getStaticProps", () => {
    it("delegates to getPageProps with a starter-quiz-bound preview context", async () => {
      ...
      expect(buildPageProps).toHaveBeenCalledWith(
        expect.objectContaining({
          page: "pupils-lesson-preview-starter-quiz::getStaticProps",
          context: ctx,
