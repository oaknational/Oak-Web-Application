...
import PupilLessonVideoPage, {
  getStaticProps,
} from "@/pages/pupils/beta/previews/lessons/[lessonSlug]/video";
...
describe("pages/pupils/beta/previews/lessons/[lessonSlug]/video", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the video section and delegates to getProps as preview", async () => {
