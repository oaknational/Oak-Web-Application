...
import PupilLessonReviewPage, {
  getStaticProps,
} from "@/pages/pupils/beta/previews/lessons/[lessonSlug]/review";
...
describe("pages/pupils/beta/previews/lessons/[lessonSlug]/review", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the review section and delegates to getProps as preview", async () => {
