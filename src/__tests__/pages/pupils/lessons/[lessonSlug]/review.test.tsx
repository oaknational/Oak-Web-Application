...
import PupilLessonReviewPage, {
  getStaticProps,
} from "@/pages/pupils/lessons/[lessonSlug]/review";
...
describe("pages/pupils/lessons/[lessonSlug]/review", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the review section and delegates to getProps as canonical", async () => {
