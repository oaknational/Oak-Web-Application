...
import PupilLessonIntroPage, {
  getStaticProps,
} from "@/pages/pupils/lessons/[lessonSlug]/intro";
...
describe("pages/pupils/lessons/[lessonSlug]/intro", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the intro section and delegates to getProps as canonical", async () => {
