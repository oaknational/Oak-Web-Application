...
import PupilLessonStarterQuizPage, {
  getStaticProps,
} from "@/pages/pupils/lessons/[lessonSlug]/starter-quiz";
...
describe("pages/pupils/lessons/[lessonSlug]/starter-quiz", () => {
  ...
  describe("getStaticProps", () => {
    it("delegates to getPageProps with a starter-quiz-bound canonical context", async () => {
