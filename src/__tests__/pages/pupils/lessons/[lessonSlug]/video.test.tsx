...
import PupilLessonVideoPage, {
  getStaticProps,
} from "@/pages/pupils/lessons/[lessonSlug]/video";
...
describe("pages/pupils/lessons/[lessonSlug]/video", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the video section and delegates to getProps as canonical", async () => {
      ...
      expect(buildPageProps).toHaveBeenCalledWith(
        expect.objectContaining({
          page: "pupils-lesson-canonical-video::getStaticProps",
        }),
      );
    });
