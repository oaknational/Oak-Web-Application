...
import PupilLessonExitQuizPage, {
  getStaticProps,
} from "@/pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/exit-quiz";
...
describe("pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/exit-quiz", () => {
  ...
  describe("getStaticProps", () => {
    it("delegates to getPageProps with an exit-quiz-bound browse context", async () => {
