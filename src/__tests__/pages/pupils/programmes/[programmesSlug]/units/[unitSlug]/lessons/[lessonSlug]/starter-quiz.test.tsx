...
import PupilLessonStarterQuizPage, {
  getStaticProps,
} from "@/pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/starter-quiz";
...
describe("pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/starter-quiz", () => {
  ...
  describe("getStaticProps", () => {
    it("delegates to getPageProps with a starter-quiz-bound browse context", async () => {
