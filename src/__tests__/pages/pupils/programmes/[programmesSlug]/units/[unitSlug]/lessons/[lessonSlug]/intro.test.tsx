...
import PupilLessonIntroPage, {
  getStaticProps,
} from "@/pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/intro";
...
describe("pages/pupils/programmes/[programmeSlug]/units/[unitSlug]/lessons/[lessonSlug]/intro", () => {
  ...
  describe("getStaticProps", () => {
    it("binds the intro section and delegates to getProps as browse", async () => {
