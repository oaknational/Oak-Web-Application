...
const getAppVersion = function () {
  ...
  if (!Array.isArray(appVersionMatches)) {
    throw new TypeError("Could not determine app version from commit message.");
  }
 ...
 */
const getIsPluginDisabled = function (envName) {
  if (!envName) {
    throw new TypeError(
...
export { getIsPluginDisabled, getAppVersion };
export default { getIsPluginDisabled, getAppVersion };
