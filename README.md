...
- `npm run test` will run the tests in `watch` mode, with coverage statistics disabled.
- `npm run test:coverage` will run tests in `watch` mode, with coverage statistics enabled.
