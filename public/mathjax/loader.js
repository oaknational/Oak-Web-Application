!(function () {
  ...
  var e = {
      515: function (e, t, r) {
        ...
        function i(e, t) {
          ...
          try {
            for (
              var c = n(Object.keys(t)), s = c.next();
              !s.done;
              s = c.next()
            ) {
              var l = s.value;
        ...
        (t.isObject = a),
          ...
          (t.combineDefaults = function e(t, r, o) {
            ...
            try {
              for (
                var s = n(Object.keys(o)), l = s.next();
                !l.done;
                l = s.next()
              ) {
                var u = l.value;
              ...
              (e.preLoad = function () {
                ...
                try {
                  for (var i = a(n), s = i.next(); !s.done; s = i.next()) {
                    ...
                    u ||
                      (u = new c.Package(l, !0)).provides(t.CONFIG.provides[l]),
                      u.loaded();
                  }
                } catch (t) {
                  e = { error: t };
  ...
  (r.g = (function () {
    ...
    (function () {
      ...
      MathJax.loader &&
        MathJax.loader.checkVersion("loader", t.VERSION, "loader"),
        (0, e.combineWithMathJax)({
          _: { components: { loader: n, package: o } },
        });
      var i,
        c = {
