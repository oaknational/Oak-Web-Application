!(function () {
          ...
          u = (function (t) {
            ...
            return (
              ...
              (e.prototype.toMml = function () {
                ...
                a &&
                  this.Push(
                    new l.default(a, e.stack.env, e.configuration).mml(),
                  );
        ...
        (d.Quantity = function (t, e, a, r, n, o, m) {
          ...
          if ("\\" === v) {
            if ((t.i++, !(g = t.GetCS()).match(p))) {
              ...
              return (
                t.Push(l.default.fenced(t.configuration, a, x, r)),
                void (t.i = h)
              );
            }
            v = t.GetNext();
  ...
  (t = c(955)),
    ...
    (n = c(458)),
    MathJax.loader &&
      MathJax.loader.checkVersion("[tex]/physics", e.q, "tex-extension"),
    (0, t.r8)({
      _: {
        input: {
          tex: {
            physics: {
              PhysicsConfiguration: a,
              PhysicsItems: r,
              PhysicsMethods: n,
            },
          },
