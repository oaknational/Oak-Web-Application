!(function () {
    ...
    n = {
      ...
      359: function (t, a, e) {
        ...
        a.ConfigMacrosConfiguration = r.Configuration.create("configmacros", {
          ...
          items:
            ((n = {}), (n[M.BeginEnvItem.prototype.kind] = M.BeginEnvItem), n),
          options: {
            macros: (0, p.expandable)({}),
            environments: (0, p.expandable)({}),
          },
        });
      },
      955: function (t, a) {
  ...
  (t = i(955)),
    ...
    (e = i(359)),
    MathJax.loader &&
      MathJax.loader.checkVersion("[tex]/configmacros", a.q, "tex-extension"),
    (0, t.r8)({
      _: { input: { tex: { configmacros: { ConfigMacrosConfiguration: e } } } },
    });
})();
