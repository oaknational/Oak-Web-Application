  ...
  var t = {
      ...
      2827: function (t, e, r) {
        ...
        function h(t, e, r, n, a, o, i) {
          ...
          return (
            (m = t.create("node", "mrow", c)),
            p.setProperty(m, "labelledRule", u),
            m
          );
        }
        function g(t, e) {
        ...
        var s = i(r(4748)),
          ...
          _ = function (t, e, r) {
            ...
            if (t !== e.parent) {
              var a = t.childNodes,
                o = r ? a.length - 1 : 0;
              s.default.isType(a[o], "mspace") && (n += d(a[o])),
                (t = e.parent);
            }
            if (t === e) return n;
            var i = t.childNodes,
          ...
          A = function (t, r) {
            ["inference", "proof", "maxAdjust", "labelledRule"].forEach(
              function (n) {
                ...
                null != a &&
                  ((0, e.setProperty)(r, n, a), (0, e.removeProperty)(t, n));
              },
            );
          },
      ...
      6248: function (t, e, r) {
        ...
        var a = n(r(4748)),
          ...
          i = function (t, e) {
            ...
            return (
              a.default.copyChildren(r, o), a.default.copyAttributes(r, o), o
            );
          };
        e.default = o;
      },
      ...
      2178: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          SetOptions: function (t, e) {
            ...
            try {
              for (
                var u = o(Object.keys(c)), p = u.next();
                !p.done;
                p = u.next()
              ) {
                var f = p.value;
            ...
            Let: function (t, e) {
              ...
              if ("\\" !== n) {
                ...
                if (s instanceof l.MacroMap) {
                  var c = s.lookup(e);
                  return void d.default.addMacro(
                    t,
                    r,
                    c.func,
                    c.args,
        ...
        (p.Quantity = function (t, e, r, n, a, o, d) {
          ...
          if ("\\" === h) {
            if ((t.i++, !(v = t.GetCS()).match(m))) {
              ...
              return (
                t.Push(c.default.fenced(t.configuration, r, y, n)),
                void (t.i = g)
              );
            }
            h = t.GetNext();
