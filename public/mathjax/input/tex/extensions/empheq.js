!(function () {
        ...
        (t.EmpheqBeginItem = d),
          (t.EmpheqMethods = {
            ...
            EmpheqDelim: function (e, t) {
              ...
              e.Push(
                e.create("token", "mo", { stretchy: !0, symmetric: !0 }, a),
              );
            },
          }),
      ...
      301: function (e, t, a) {
        ...
        t.EmpheqUtil = {
          ...
          splitOptions: function (e, t) {
            return (
              void 0 === t && (t = null), l.default.keyvalOptions(e, t, !0)
            );
          },
          ...
          right: function (e, a, n, r, i) {
            void 0 === i && (i = ""),
              0 === e.childNodes.length &&
                e.appendChild(r.create("node", "mtr"));
            for (
  ...
  (e = o(955)),
    ...
    (n = o(301)),
    MathJax.loader &&
      MathJax.loader.checkVersion("[tex]/empheq", t.q, "tex-extension"),
    (0, e.r8)({
      _: {
        input: { tex: { empheq: { EmpheqConfiguration: a, EmpheqUtil: n } } },
      },
    });
})();
