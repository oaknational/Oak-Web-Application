!(function () {
      ...
      16: function (t, e, a) {
        ...
        (e.AmsMethods = {}),
          ...
          (e.AmsMethods.AlignAt = function (t, a, r, n) {
            ...
            for (var c = parseInt(i, 10); c > 0; )
              (u += "rl"), m.push("0em 0em"), c--;
            var h = m.join(" ");
          ...
          (e.AmsMethods.CFrac = function (t, e) {
            ...
            a && s.default.setProperties(h, { numalign: a, denomalign: a }),
              t.Push(h);
          }),
  ...
  (t = o(955)),
    ...
    (n = o(16)),
    MathJax.loader &&
      MathJax.loader.checkVersion("[tex]/ams", e.q, "tex-extension"),
    (0, t.r8)({
      _: {
        input: {
          tex: { ams: { AmsConfiguration: a, AmsItems: r, AmsMethods: n } },
        },
      },
    });
})();
