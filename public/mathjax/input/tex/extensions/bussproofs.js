!(function () {
    ...
    i = {
      ...
      827: function (e, t, r) {
        ...
        function h(e, t, r, o, n, a, i) {
          ...
          return (
            (m = e.create("node", "mrow", f)),
            c.setProperty(m, "labelledRule", s),
            m
          );
        }
        function y(e, t) {
      ...
      378: function (e, t, r) {
        ...
        var l = i(r(748)),
          ...
          b = function (e) {
            for (; e && null == (0, t.getProperty)(e, "inference"); )
              e = e.parent;
            return e;
          },
          _ = function (e, t, r) {
            ...
            if (e !== t.parent) {
              var n = e.childNodes,
                a = r ? n.length - 1 : 0;
              l.default.isType(n[a], "mspace") && (o += d(n[a])),
                (e = t.parent);
            }
            if (e === t) return o;
            var i = e.childNodes,
          ...
          M = function (e, r, o, n) {
            ...
            l.default.isType(f, "mspace")
              ...
              : ((f = e.nodeFactory.create("node", "mspace", [], {
                ...
                n
                  ? r.appendChild(f)
                  : ((f.parent = r), r.childNodes.unshift(f)));
          },
          w = function (e, r) {
            ["inference", "proof", "maxAdjust", "labelledRule"].forEach(
              function (o) {
                ...
                null != n &&
                  ((0, t.setProperty)(r, o, n), (0, t.removeProperty)(e, o));
              },
            );
          },
            ...
            for (var l = a(i), u = l.next(); !u.done; u = l.next()) {
              ...
              if (null != (0, t.getProperty)(S, "inference")) {
                ...
                if (!d && (L = P(f))) {
                  ...
                  M(
                    n,
                    (0, t.getProperty)(f, "proof") ? f : f.parent,
                    N - j,
                    !0,
                  );
              }
  ...
  (e = u(955)),
    ...
    (a = u(378)),
    MathJax.loader &&
      MathJax.loader.checkVersion("[tex]/bussproofs", t.q, "tex-extension"),
    (0, e.r8)({
      _: {
        input: {
          tex: {
