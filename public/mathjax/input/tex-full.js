!(function () {
  ...
  var t = {
              ...
              (e.prototype.findMathInString = function (t, e, r) {
                ...
                for (this.start.lastIndex = 0; (n = this.start.exec(r)); ) {
                  if (void 0 !== n[this.env] && this.env) {
                    ...
                    o =
                      2 === i.length
                        ? (0, l.protoItem)("", i.substr(1), "", e, n.index, a)
                ...
                try {
                  for (var l = n(r), c = l.next(); !c.done; c = l.next()) {
                    ...
                    if (u) {
                      ...
                      h &&
                        (f
                          ? (this.Pop(), this.Push.apply(this, a([], o(f), !1)))
                          : (this.stack.push(p),
                            p.env
      ...
      2684: function (t, e, r) {
        ...
        (e.AmsMethods = {}),
          ...
          (e.AmsMethods.AlignAt = function (t, r, n, o) {
            ...
            for (var d = parseInt(a, 10); d > 0; )
              (c += "rl"), u.push("0em 0em"), d--;
            var f = u.join(" ");
          ...
          (e.AmsMethods.CFrac = function (t, e) {
            ...
            r && l.default.setProperties(f, { numalign: r, denomalign: r }),
              t.Push(f);
          }),
        ...
        (x.Open = function (t, e) {
          ...
          (x.CrLaTeX = function (t, e, r) {
            ...
            d instanceof c.ArrayItem
              ? n && d.addRowSpacing(n)
              : (n &&
                  ((u = t.create("node", "mspace", [], { depth: n })),
                  t.Push(u)),
      ...
      9267: function (t, e, r) {
        ...
        (u[s.TexConstant.Variant.NORMAL] = s.TexConstant.Variant.BOLD),
          ...
          (u[s.TexConstant.Variant.FRAKTUR] =
            s.TexConstant.Variant.BOLDFRAKTUR),
          (u[s.TexConstant.Variant.SCRIPT] = s.TexConstant.Variant.BOLDSCRIPT),
          (u[s.TexConstant.Variant.SANSSERIF] =
      ...
      3583: function (t, e, r) {
        ...
        function m(t, e, r, n, o, a, i) {
          ...
          return (
            ...
            d.setProperty(h, "labelledRule", u),
            h
          );
        }
        function g(t, e) {
      ...
      3118: function (t, e, r) {
        ...
        var s = i(r(8321)),
          ...
          x = function (t) {
            for (; t && null == (0, e.getProperty)(t, "inference"); )
              t = t.parent;
            return t;
          },
          _ = function (t, e, r) {
            ...
            if (t !== e.parent) {
              var o = t.childNodes,
                a = r ? o.length - 1 : 0;
              s.default.isType(o[a], "mspace") && (n += p(o[a])),
                (t = e.parent);
            }
            if (t === e) return n;
            var i = t.childNodes,
          ...
          A = function (t, r) {
            ["inference", "proof", "maxAdjust", "labelledRule"].forEach(
              function (n) {
                ...
                null != o &&
                  ((0, e.setProperty)(r, n, o), (0, e.removeProperty)(t, n));
              },
            );
          },
            ...
            for (var s = a(i), l = s.next(); !l.done; l = s.next()) {
              ...
              if (null != (0, e.getProperty)(T, "inference")) {
                ...
                if (!p && (N = v(c))) {
                  ...
                  w(
                    o,
                    (0, e.getProperty)(c, "proof") ? c : c.parent,
                    k - E,
                    !0,
                  );
              }
      ...
      3997: function (t, e, r) {
        ...
        (e.ColorModel = l),
          ...
          s.set("gray", function (t) {
            ...
            return (
              r.length < 2 && (r = "0" + r), "#".concat(r).concat(r).concat(r)
            );
          });
      },
      9570: function (t, e, r) {
      ...
      3904: function (t, e, r) {
        ...
        e.EmpheqUtil = {
          ...
          splitOptions: function (t, e) {
            return (
              void 0 === e && (e = null), s.default.keyvalOptions(t, e, !0)
            );
          },
      ...
      2565: function (t, e, r) {
        ...
        var o = n(r(8321)),
          ...
          i = function (t, e) {
            ...
            return (
              o.default.copyChildren(r, a), o.default.copyAttributes(r, a), a
            );
          };
        e.default = a;
      },
      ...
      8155: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          UnderOverBracket: function (t, e) {
            var r = (0, h.length2em)(t.GetBrackets(e, ".1em"), 0.1),
              ...
              y = t.create(
                "node",
                "mpadded",
                [t.create("node", "mphantom", [g])],
                {
                  style: "border: "
                    .concat(f, " solid; border-")
                    .concat(p, ": none"),
                  height: n,
                  depth: 0,
                },
          ...
          SetOptions: function (t, e) {
            ...
            try {
              for (
                var u = a(Object.keys(c)), d = u.next();
                !d.done;
                d = u.next()
              ) {
                var f = d.value;
            ...
            (t.GetParameter = function (t, r, n) {
              ...
              for (var o = t.i, a = 0, s = 0; t.i < t.string.length; ) {
                ...
                if ("{" === l)
                  ...
                  if (e(t, n))
                    return s && (o++, (a -= 2)), t.string.substr(o, a);
                  if ("\\" === l) {
                    t.i++, a++, (s = 0);
          ...
          u = (function (t) {
            ...
            return (
              ...
              (e.prototype.toMml = function () {
                ...
                r &&
                  this.Push(
                    new c.default(r, e.stack.env, e.configuration).mml(),
                  );
        ...
        (d.Quantity = function (t, e, r, n, o, a, p) {
          ...
          if ("\\" === m) {
            if ((t.i++, !(y = t.GetCS()).match(h))) {
              ...
              return (
                t.Push(c.default.fenced(t.configuration, r, v, n)),
                void (t.i = g)
              );
            }
            m = t.GetNext();
  ...
  !(function () {
    var t = r(8723),
      ...
      Tt = r(4325);
    MathJax.loader &&
      MathJax.loader.checkVersion("input/tex-full", e.q, "input"),
