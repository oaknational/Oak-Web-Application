(function () {
  ...
  var __webpack_modules__ = {
      ...
      8905: function (e, t, n) {
        ...
        !(function (e) {
          (e.locales = b.Variables.LOCALES),
            ...
            (e.getSpeechGenerator = p.generator),
            (e.getWalker = d.walker),
            (e.clearspeakStyle = function () {
              return h.DOMAIN_TO_STYLES.clearspeak;
            }),
          ...
          l = (function (e) {
            ...
            return (
              ...
              (t.prototype.post = function (t, n) {
                if (this.mathItem) {
                  if (void 0 !== n) {
                    var r = this.mathItem.inputJax.name,
                      o = this.findID("Show", "Original");
                    (o.content =
                      "MathML" === r ? "Original MathML" : r + " Commands"),
                      (this.findID("Copy", "Original").content = o.content);
                    var i = this.findID("Settings", "semantics");
                    "MathML" === r ? i.disable() : i.enable(),
                      this.getAnnotationMenu(),
                      this.dynamicSubmenus();
                  }
                  e.prototype.post.call(this, t, n);
                }
              }),
              (t.prototype.unpost = function () {
                e.prototype.unpost.call(this), (this.mathItem = null);
              }),
              ...
              (t.prototype.getAnnotationMenu = function () {
                var e = this,
                  t = this.getAnnotations(this.getSemanticNode());
                this.createAnnotationMenu("Show", t, function () {
                  return e.showAnnotation.post();
                }),
                  this.createAnnotationMenu("Copy", t, function () {
                    return e.copyAnnotation();
                  });
              }),
              (t.prototype.getSemanticNode = function () {
                for (
                  var e = this.mathItem.root;
                  e && !e.isKind("semantics");

                ) {
                  if (e.isToken || 1 !== e.childNodes.length) return null;
                  e = e.childNodes[0];
                }
                return e;
              }),
              (t.prototype.getAnnotations = function (e) {
                var t,
                  n,
                  r = [];
                if (!e) return r;
                try {
                  for (
                    ...
                    if (a.isKind("annotation")) {
                      ...
                      if (c) {
                        var l = a.childNodes.reduce(function (e, t) {
                          return e + t.toString();
                        }, "");
                        r.push([c, l]);
                      }
              ...
              (t.prototype.annotationMatch = function (e) {
                var t,
                  n,
                  r = e.attributes.get("encoding");
                try {
                  for (
                    ...
                    var a = s.value;
                    if (this.annotationTypes[a].indexOf(r) >= 0) return a;
                  }
                } catch (e) {
                  t = { error: e };
                } finally {
              ...
              (t.prototype.createAnnotationMenu = function (e, t, n) {
                var r = this,
                  o = this.findID(e, "Annotation");
                (o.submenu = this.factory.get("subMenu")(
                  ...
                  t.length ? o.enable() : o.disable();
              }),
              (t.prototype.dynamicSubmenus = function () {
                var e, n;
                try {
                  for (
                    var r = i(t.DynamicSubmenus), o = r.next();
                    !o.done;
                    o = r.next()
                  ) {
                    var a = s(o.value, 2),
                    ...
                    if (u) {
                      var d = l(this, u);
                      (u.submenu = d),
                        d.items.length ? u.enable() : u.disable();
                    }
                  }
                } catch (t) {
                  e = { error: t };
          ...
          E = (function () {
            function e(e, t) {
              ...
              (this.settings = null),
                ...
                (this.menu = null),
                (this.MmlVisitor = new d.MmlVisitor()),
                ...
                (this.about = new h.Info(
                  ...
                  function () {
                    ...
                    return (
                      ...
                      e.push("Output Jax: " + n.document.outputJax.name),
                      e.push("Document Type: " + n.document.kind),
                      e.join("<br/>")
                    );
                  },
                ...
                (this.mathmlCode = new p.SelectableInfo(
                  ...
                  function () {
                    ...
                    var e = n.toMML(n.menu.mathItem);
                    return "<pre>" + n.formatSource(e) + "</pre>";
                  },
                  "",
                )),
                ...
                (this.zoomBox = new h.Info(
                  ...
                  function () {
                    if (!n.menu.mathItem) return "";
                    var e = n.menu.mathItem.typesetRoot.cloneNode(!0);
                    return (
                      (e.style.margin = "0"),
                      '<div style="font-size: ' +
                ...
                (this.options = (0, l.userOptions)(
                  (0, l.defaultOptions)({}, this.constructor.OPTIONS),
                  t,
                )),
                this.initSettings(),
            ...
            return (
              ...
              Object.defineProperty(e.prototype, "loadingPromise", {
                get: function () {
                  return this.isLoading
                    ? (e._loadingPromise ||
                        (e._loadingPromise = new Promise(function (t, n) {
                          (e._loadingOK = t), (e._loadingFailed = n);
                        })),
                      e._loadingPromise)
                    : Promise.resolve();
                },
              ...
              (e.prototype.initMenu = function () {
                var e = this,
                  t = new f.Parser([
                    [
                      "contextMenu",
                      u.MJContextMenu.fromJson.bind(u.MJContextMenu),
                    ],
                  ]);
                this.menu = t.parse({
                  type: "contextMenu",
                  ...
                  pool: [
                    ...
                    this.variable("renderer", function (t) {
                      return e.setRenderer(t);
                    }),
                    this.variable("alt"),
                    this.variable("cmd"),
                    this.variable("ctrl"),
                    this.variable("shift"),
                    this.variable("scale", function (t) {
                      return e.setScale(t);
                    }),
                    this.variable("explorer", function (t) {
                      return e.setExplorer(t);
                    }),
                    ...
                    this.a11yVar("locale", function (e) {
                      return b.default.setupEngine({ locale: e });
                    }),
                    this.a11yVar("speechRules", function (t) {
                      var n = r(t.split("-"), 2),
                        o = n[0],
                        i = n[1];
                      (e.document.options.sre.domain = o),
                        (e.document.options.sre.style = i);
                    }),
                    ...
                    this.variable("collapsible", function (t) {
                      return e.setCollapsible(t);
                    }),
                    this.variable("inTabOrder", function (t) {
                      return e.setTabOrder(t);
                    }),
                    this.variable("assistiveMml", function (t) {
                      return e.setAssistiveMml(t);
                    }),
                  ],
                  items: [
                    this.submenu("Show", "Show Math As", [
                      this.command("MathMLcode", "MathML Code", function () {
                        return e.mathmlCode.post();
                      }),
                      this.command("Original", "Original Form", function () {
                        return e.originalText.post();
                      }),
                    ...
                    this.submenu("Settings", "Math Settings", [
                      ...
                      this.submenu("ZoomTrigger", "Zoom Trigger", [
                        this.command("ZoomNow", "Zoom Once Now", function () {
                          return e.zoom(null, "", e.menu.mathItem);
                        }),
                        this.rule(),
                ...
                this.about.attachMenu(n),
                  ...
                  g.CssStyles.addInfoStyles(this.document.document),
                  g.CssStyles.addMenuStyles(this.document.document);
              }),
              (e.prototype.checkLoadableItems = function () {
                var e, t;
                if (y && y._ && y.loader && y.startup)
                  ...
                  try {
                    for (
                      var r = o(Object.keys(this.jax)), i = r.next();
                      !i.done;
                      i = r.next()
                    ) {
                      var s = i.value;
              ...
              (e.prototype.enableExplorerItems = function (e) {
                var t,
                  n,
                  r = this.menu.findID("Accessibility", "Activate").menu;
                try {
                  for (
                    var i = o(r.items.slice(1)), s = i.next();
                    !s.done;
                    s = i.next()
                  ) {
                    var a = s.value;
                    if (a instanceof m.Rule) break;
                    e ? a.enable() : a.disable();
                  }
                } catch (e) {
                  t = { error: e };
                } finally {
              ...
              (e.prototype.mergeUserSettings = function () {
                try {
                  var t = localStorage.getItem(e.MENU_STORAGE);
                  if (!t) return;
                  Object.assign(this.settings, JSON.parse(t)),
                    this.setA11y(this.settings);
                } catch (e) {
                  console.log("MathJax localStorage error: " + e.message);
                }
              }),
              (e.prototype.saveUserSettings = function () {
                var t,
                  n,
                  r = {};
                try {
                  for (
                    var i = o(Object.keys(this.settings)), s = i.next();
                    !s.done;
                    s = i.next()
                  ) {
                    var a = s.value;
                ...
                try {
                  Object.keys(r).length
                    ? localStorage.setItem(e.MENU_STORAGE, JSON.stringify(r))
                    : localStorage.removeItem(e.MENU_STORAGE);
                } catch (e) {
                  console.log("MathJax localStorage error: " + e.message);
                }
              }),
              (e.prototype.setA11y = function (e) {
                y._.a11y &&
                  y._.a11y.explorer &&
                  y._.a11y.explorer_ts.setA11yOptions(this.document, e);
              }),
              (e.prototype.getA11y = function (e) {
                if (y._.a11y && y._.a11y.explorer)
                  return void 0 !== this.document.options.a11y[e]
                    ? this.document.options.a11y[e]
                    : this.document.options.sre[e];
              }),
              (e.prototype.applySettings = function () {
                this.setTabOrder(this.settings.inTabOrder),
                  (this.document.options.enableAssistiveMml =
                    this.settings.assistiveMml),
                  (this.document.outputJax.options.scale = parseFloat(
                    this.settings.scale,
                  )),
                  this.settings.renderer !== this.defaultSettings.renderer &&
                    this.setRenderer(this.settings.renderer);
              }),
              (e.prototype.setScale = function (e) {
                (this.document.outputJax.options.scale = parseFloat(e)),
                  this.document.rerender();
              }),
              (e.prototype.setRenderer = function (e) {
                var t = this;
                if (this.jax[e]) this.setOutputJax(e);
                else {
                  var n = e.toLowerCase();
              ...
              (e.prototype.setOutputJax = function (e) {
                this.jax[e].setAdaptor(this.document.adaptor),
                  (this.document.outputJax = this.jax[e]),
                  this.rerender();
              }),
              (e.prototype.setTabOrder = function (e) {
                this.menu.store.inTaborder(e);
              }),
              (e.prototype.setAssistiveMml = function (e) {
                (this.document.options.enableAssistiveMml = e),
                  !e || (y._.a11y && y._.a11y["assistive-mml"])
                    ? this.rerender()
                    : this.loadA11y("assistive-mml");
              }),
              (e.prototype.setExplorer = function (e) {
                this.enableExplorerItems(e),
                  (this.document.options.enableExplorer = e),
                  !e || (y._.a11y && y._.a11y.explorer)
                    ? this.rerender(
                        this.settings.collapsible
                          ? a.STATE.RERENDER
                          : a.STATE.COMPILED,
              ...
              (e.prototype.setCollapsible = function (e) {
                (this.document.options.enableComplexity = e),
                  !e || (y._.a11y && y._.a11y.complexity)
                    ? this.rerender(a.STATE.COMPILED)
                    : this.loadA11y("complexity");
              }),
              (e.prototype.scaleAllMath = function () {
                var e = (100 * parseFloat(this.settings.scale))
                    .toFixed(1)
                    .replace(/.0$/, ""),
                  t = prompt(
                ...
                if (t)
                  if (t.match(/^\s*\d+(\.\d*)?\s*%?\s*$/)) {
                    ...
                    n
                      ? this.menu.pool.lookup("scale").setValue(String(n))
                      : alert("The scale should not be zero");
                  } else alert("The scale should be a percentage (e.g., 120%)");
              }),
              (e.prototype.resetDefaults = function () {
                var t, n;
                e.loading++;
                var r = this.menu.pool,
                  i = this.defaultSettings;
                try {
                  for (
                    var s = o(Object.keys(this.settings)), c = s.next();
                    !c.done;
                    c = s.next()
                  ) {
                    var l = c.value,
                    ...
                    if (u) {
                      u.setValue(i[l]);
                      var d = u.items[0];
                      d && d.executeCallbacks_();
                    } else this.settings[l] = i[l];
                  }
                } catch (e) {
                  t = { error: e };
                } finally {
                ...
                e.loading--, this.rerender(a.STATE.COMPILED);
              }),
              (e.prototype.checkComponent = function (t) {
                var n = e.loadingPromises.get(t);
                n && s.mathjax.retryAfter(n);
              }),
              (e.prototype.loadComponent = function (t, n) {
                if (!e.loadingPromises.has(t)) {
                  var r = y.loader;
                  if (r) {
                    e.loading++;
                    var o = r
                      ...
                      .then(function () {
                        e.loading--,
                          e.loadingPromises.delete(t),
                          n(),
                          0 === e.loading &&
                            e._loadingPromise &&
                            ((e._loadingPromise = null), e._loadingOK());
                      })
                      .catch(function (t) {
                        e._loadingPromise
                          ? ((e._loadingPromise = null), e._loadingFailed(t))
                          : console.log(t);
                      });
                    e.loadingPromises.set(t, o);
                  }
                }
              }),
              (e.prototype.loadA11y = function (t) {
                var n = this,
                  r = !a.STATE.ENRICHED;
                this.loadComponent("a11y/" + t, function () {
                  var o = y.startup;
                  s.mathjax.handlers.unregister(o.handler),
                    (o.handler = o.getHandler()),
                    s.mathjax.handlers.register(o.handler);
                  var i = n.document;
                  (n.document = o.document = o.getDocument()),
                    (n.document.menu = n),
                    n.document.outputJax.reset(),
                    n.transferMathList(i),
                    (n.document.processed = i.processed),
                    e._loadingPromise ||
                      (n.document.outputJax.reset(),
                      n.rerender(
                        "complexity" === t || r
              ...
              (e.prototype.transferMathList = function (e) {
                var t,
                  n,
                  r = this.document.options.MathItem;
                try {
                  for (var i = o(e.math), s = i.next(); !s.done; s = i.next()) {
                    var a = s.value,
                      c = new r();
              ...
              (e.prototype.formatSource = function (e) {
                return e
                  .trim()
                  .replace(/&/g, "&amp;")
                  .replace(/</g, "&lt;")
              ...
              (e.prototype.toMML = function (e) {
                return this.MmlVisitor.visitTree(e.root, e, {
                  texHints: this.settings.texHints,
                  semantics:
                    this.settings.semantics && "MathML" !== e.inputJax.name,
                });
              }),
              (e.prototype.zoom = function (e, t, n) {
                (e && !this.isZoomEvent(e, t)) ||
                  ((this.menu.mathItem = n),
                  e && this.menu.post(e),
                  this.zoomBox.post());
              }),
              (e.prototype.isZoomEvent = function (e, t) {
                return (
                  this.settings.zoom === t &&
                  (!this.settings.alt || e.altKey) &&
                  (!this.settings.ctrl || e.ctrlKey) &&
                  (!this.settings.cmd || e.metaKey) &&
                  (!this.settings.shift || e.shiftKey)
                );
              }),
              (e.prototype.rerender = function (t) {
                void 0 === t && (t = a.STATE.TYPESET),
                  (this.rerenderStart = Math.min(t, this.rerenderStart)),
                  e.loading ||
                    (this.rerenderStart <= a.STATE.COMPILED &&
                      this.document.reset({ inputJax: [] }),
                    this.document.rerender(this.rerenderStart),
                    (this.rerenderStart = a.STATE.LAST));
              }),
              (e.prototype.copyMathML = function () {
                this.copyToClipboard(this.toMML(this.menu.mathItem));
              }),
              (e.prototype.copyOriginal = function () {
                this.copyToClipboard(this.menu.mathItem.math.trim());
              }),
              (e.prototype.copyAnnotation = function () {
              ...
              (e.prototype.copyToClipboard = function (e) {
                ...
                try {
                  ...
                  alert("Can't copy to clipboard: " + e.message);
                }
                document.body.removeChild(t);
              }),
              (e.prototype.addMenu = function (e) {
                var t = this,
                  n = e.typesetRoot;
                n.addEventListener(
                  "contextmenu",
                  function () {
                    return (t.menu.mathItem = e);
                  },
                  !0,
                ),
                  n.addEventListener(
              ...
              (e.prototype.variable = function (e, t) {
                ...
                return {
                  ...
                  setter: function (r) {
                    (n.settings[e] = r), t && t(r), n.saveUserSettings();
                  },
                };
              }),
              (e.prototype.a11yVar = function (e, t) {
                var n = this;
                return {
                  name: e,
                  getter: function () {
                  ...
                  setter: function (r) {
                    n.settings[e] = r;
                    var o = {};
                    (o[e] = r), n.setA11y(o), t && t(r), n.saveUserSettings();
                  },
                };
              }),
              (e.prototype.submenu = function (e, t, n, r) {
                var i, s;
                void 0 === n && (n = []), void 0 === r && (r = !1);
                var a = [];
                try {
                  for (var c = o(n), l = c.next(); !l.done; l = c.next()) {
                    var u = l.value;
              ...
              (e.prototype.command = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign(
                    { type: "command", id: e, content: t, action: n },
                    r,
                  )
                );
              }),
              (e.prototype.checkbox = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign(
                    { type: "checkbox", id: e, content: t, variable: n },
                    r,
                  )
                );
              }),
              (e.prototype.radioGroup = function (e, t) {
                var n = this;
                return t.map(function (t) {
                  return n.radio(t[0], t[1] || t[0], e);
                });
              }),
              (e.prototype.radio = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign(
                    { type: "radio", id: e, content: t, variable: n },
                    r,
                  )
                );
              }),
              (e.prototype.label = function (e, t) {
                return { type: "label", id: e, content: t };
              }),
              (e.prototype.rule = function () {
                return { type: "rule" };
              }),
              (e.MENU_STORAGE = "MathJax-Menu-Settings"),
              (e.OPTIONS = {
                settings: {
                  texHints: !0,
                  semantics: !1,
                ...
                annotationTypes: (0, l.expandable)({
              ...
              (e.loading = 0),
              (e.loadingPromises = new Map()),
              (e._loadingPromise = null),
              (e._loadingOK = null),
              (e._loadingFailed = null),
              e
            );
          })();
        t.Menu = E;
      ...
      9003: function (e, t, n) {
        ...
        function h(e) {
          return (function (e) {
            ...
            return (
              o(t, e),
              (t.prototype.addMenu = function (e, t) {
                void 0 === t && (t = !1),
                  this.state() >= u.STATE.CONTEXT_MENU ||
                    (this.isEscaped ||
                      (!e.options.enableMenu && !t) ||
                      e.menu.addMenu(this),
                    this.state(u.STATE.CONTEXT_MENU));
              }),
              (t.prototype.checkLoading = function (e) {
                e.checkLoading();
              }),
              t
            );
          ...
          return (
            (t = (function (e) {
              function t() {
                for (var t = [], n = 0; n < arguments.length; n++)
                  t[n] = arguments[n];
                var r = e.apply(this, a([], s(t), !1)) || this;
                r.menu = new r.options.MenuClass(r, r.options.menuOptions);
                var o = r.constructor.ProcessBits;
                return (
                  o.has("context-menu") || o.allocate("context-menu"),
                  (r.options.MathItem = h(r.options.MathItem)),
                  r
                );
              }
              return (
                ...
                (t.prototype.addMenu = function () {
                  ...
                  if (!this.processed.isSet("context-menu")) {
                    try {
                      for (
                        var n = c(this.math), r = n.next();
                        !r.done;
                        r = n.next()
                      ) {
                        r.value.addMenu(this);
                      }
                    } catch (t) {
                      e = { error: t };
                    } finally {
                ...
                (t.prototype.checkLoading = function () {
                  this.menu.isLoading &&
                    l.mathjax.retryAfter(
                      this.menu.loadingPromise.catch(function (e) {
                        return console.log(e);
                      }),
                    );
                  var e = this.menu.settings;
                  return (
                    e.collapsible &&
                ...
                (t.prototype.state = function (t, n) {
                  return (
                    void 0 === n && (n = !1),
                    e.prototype.state.call(this, t, n),
                    t < u.STATE.CONTEXT_MENU &&
                ...
                (t.prototype.updateDocument = function () {
                  return (
                    e.prototype.updateDocument.call(this),
            ...
            (t.OPTIONS = i(
              ...
              ),
              {
                ...
                enableMenu: !0,
                sre: e.OPTIONS.sre || (0, d.expandable)({}),
                a11y: e.OPTIONS.a11y || (0, d.expandable)({}),
                renderActions: (0, d.expandable)(
                  i(i({}, e.OPTIONS.renderActions), {
        ...
        (0, u.newState)("CONTEXT_MENU", 170),
          (t.MenuMathItemMixin = h),
          (t.MenuMathDocumentMixin = f),
          (t.MenuHandler = function (e) {
            return (e.documentClass = f(e.documentClass)), e;
          });
      },
      9232: function (e, t, n) {
        var r,
        ...
        var i = n(2433),
          ...
          a = (function (e) {
            function t() {
              var t = (null !== e && e.apply(this, arguments)) || this;
              return (
                (t.options = { texHints: !0, semantics: !1 }),
                (t.mathItem = null),
                t
              );
            }
            return (
              o(t, e),
              (t.prototype.visitTree = function (e, t, n) {
                return (
                  void 0 === t && (t = null),
                  void 0 === n && (n = {}),
                  (this.mathItem = t),
                  (0, s.userOptions)(this.options, n),
                  this.visitNode(e, "")
                );
              }),
              (t.prototype.visitTeXAtomNode = function (t, n) {
                return this.options.texHints
                  ? e.prototype.visitTeXAtomNode.call(this, t, n)
                  : t.childNodes[0] && 1 === t.childNodes[0].childNodes.length
                  ? this.visitNode(t.childNodes[0], n)
                  : n +
                    "<mrow" +
              ...
              (t.prototype.visitMathNode = function (t, n) {
                if (
                  !this.options.semantics ||
                  "TeX" !== this.mathItem.inputJax.name
                )
                  return e.prototype.visitDefault.call(this, t, n);
                var r =
                  t.childNodes.length && t.childNodes[0].childNodes.length > 1;
                return (
                  n +
                  "<math" +
                  this.getAttributes(t) +
      ...
      7309: function (e, t, n) {
        ...
        var i = n(6932),
          ...
          a = (function (e) {
            ...
            return (
              o(t, e),
              (t.prototype.addEvents = function (e) {
                var t = this;
                e.addEventListener("keypress", function (e) {
                  "a" === e.key &&
                    (e.ctrlKey || e.metaKey) &&
                    (t.selectAll(), t.stop(e));
                });
              }),
              ...
              (t.prototype.generateHtml = function () {
                var t = this;
                e.prototype.generateHtml.call(this);
                var n = this.html
      ...
      4769: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.protoItem = MathJax._.core.MathItem.protoItem),
          (t.AbstractMathItem = MathJax._.core.MathItem.AbstractMathItem),
          (t.STATE = MathJax._.core.MathItem.STATE),
          (t.newState = MathJax._.core.MathItem.newState);
      },
      2433: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.DATAMJX = MathJax._.core.MmlTree.SerializedMmlVisitor.DATAMJX),
          (t.toEntity = MathJax._.core.MmlTree.SerializedMmlVisitor.toEntity),
          (t.SerializedMmlVisitor =
      ...
      2612: function (e, t, n) {
        ...
        var i = n(9943),
          ...
          a = (function (e) {
            ...
            return (
              o(t, e),
              Object.defineProperty(t.prototype, "menu", {
                get: function () {
                  return this._menu;
                },
                set: function (e) {
          ...
          l = (function (e) {
            ...
            return (
              ...
              (t.prototype.activate = function () {
                this.disabled ||
                  this.html.classList.add(c.HtmlClasses.MENUACTIVE);
              }),
              ...
              (t.prototype.unfocus = function () {
                this.deactivate(), e.prototype.unfocus.call(this);
              }),
              (t.prototype.escape = function (e) {
              ...
              (t.prototype.disable = function () {
                this.disabled = !0;
                var e = this.html;
                e.classList.add(c.HtmlClasses.MENUDISABLED),
                  e.setAttribute("aria-disabled", "true");
              }),
              (t.prototype.enable = function () {
                this.disabled = !1;
                var e = this.html;
                e.classList.remove(c.HtmlClasses.MENUDISABLED),
                  e.removeAttribute("aria-disabled");
              }),
              (t.prototype.executeCallbacks_ = function () {
                var e, t;
                try {
                  for (
                    var n = i(this.callbacks), r = n.next();
                    !r.done;
                    r = n.next()
                  ) {
                    var o = r.value;
        ...
        var s = n(3757),
          ...
          u = (function (e) {
            function t() {
              var t = (null !== e && e.apply(this, arguments)) || this;
              return (
                (t.className = c.HtmlClasses.CONTEXTMENU),
                (t.role = "menu"),
                (t._items = []),
                (t._baseMenu = null),
                t
            ...
            return (
              o(t, e),
              Object.defineProperty(t.prototype, "baseMenu", {
                get: function () {
              ...
              (t.prototype.up = function (e) {
                var t = this.items.filter(function (e) {
                  return e instanceof a.AbstractItem && !e.isHidden();
                });
                if (0 !== t.length)
                  if (this.focused) {
                    var n = t.indexOf(this.focused);
                    -1 !== n && t[(n = n ? --n : t.length - 1)].focus();
                  } else t[t.length - 1].focus();
              }),
              (t.prototype.down = function (e) {
                var t = this.items.filter(function (e) {
                  return e instanceof a.AbstractItem && !e.isHidden();
                ...
                if (0 !== t.length)
                  if (this.focused) {
                    var n = t.indexOf(this.focused);
                    -1 !== n && t[(n = ++n === t.length ? 0 : n)].focus();
                  } else t[0].focus();
              }),
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this), this.generateMenu();
              }),
              (t.prototype.generateMenu = function () {
                var e,
                  t,
                  n = this.html;
                n.classList.add(c.HtmlClasses.MENU);
                try {
                  for (
                    var r = i(this.items), o = r.next();
                    !o.done;
                    o = r.next()
                  ) {
                    var s = o.value;
              ...
              (t.prototype.post = function (t, n) {
                this.variablePool.update(), e.prototype.post.call(this, t, n);
              }),
              (t.prototype.unpostSubmenus = function () {
                var e,
                  t,
                  n = this.items.filter(function (e) {
                    return e instanceof l.Submenu;
                  });
                try {
      ...
      2817: function (e, t, n) {
        ...
        var r = n(2635),
          ...
          i = (function () {
            ...
            return (
              (e.prototype.bubbleKey = function () {
                this.bubble = !0;
              }),
              (e.prototype.keydown = function (e) {
                ...
                this.bubble ? (this.bubble = !1) : this.stop(e);
              }),
              ...
              (e.prototype.addEvents = function (e) {
                e.addEventListener(o.MOUSE.DOWN, this.mousedown.bind(this)),
                  e.addEventListener(o.MOUSE.UP, this.mouseup.bind(this)),
                  e.addEventListener(o.MOUSE.OVER, this.mouseover.bind(this)),
                  e.addEventListener(o.MOUSE.OUT, this.mouseout.bind(this)),
                  e.addEventListener(o.MOUSE.CLICK, this.click.bind(this)),
                  e.addEventListener("keydown", this.keydown.bind(this)),
                  e.addEventListener("dragstart", this.stop.bind(this)),
                  e.addEventListener(o.MOUSE.SELECTSTART, this.stop.bind(this)),
                  e.addEventListener("contextmenu", this.stop.bind(this)),
                  e.addEventListener(o.MOUSE.DBLCLICK, this.stop.bind(this));
              }),
              e
            );
          })();
        t.AbstractNavigatable = i;
      },
      3757: function (e, t, n) {
        var r,
          o =
        ...
        var i = (function (e) {
          ...
          return (
            ...
            (t.prototype.unpost = function () {
              if (this.posted) {
                var e = this.html;
                e.parentNode && e.parentNode.removeChild(e), (this.posted = !1);
              }
            }),
            t
          );
        })(n(9943).MenuElement);
        t.AbstractPostable = i;
      },
      2467: function (e, t, n) {
        var r,
          o =
          ...
          a = (function (e) {
            ...
            return (
              ...
              (t.prototype.generateHtml = function () {
                ...
                (t.textContent = "\xd7"), e.appendChild(t), (this.html = e);
              }),
              (t.prototype.display = function () {}),
              (t.prototype.unpost = function () {
                e.prototype.unpost.call(this), this.element.unpost();
              }),
              (t.prototype.keydown = function (t) {
                this.bubbleKey(), e.prototype.keydown.call(this, t);
              }),
              (t.prototype.space = function (e) {
                this.unpost(), this.stop(e);
              }),
              (t.prototype.mousedown = function (e) {
                this.unpost(), this.stop(e);
              }),
          ...
          l = (function (e) {
            function t(t) {
              ...
              return (
                ...
                (n.widgets = []),
                (n.variablePool = new c.VariablePool()),
                n
              );
            }
            return (
              o(t, e),
              (t.fromJson = function (e, t) {
                var n = t.pool,
                  r = t.items,
                  o = t.id,
                  i = void 0 === o ? "" : o,
                  s = new this(e);
                s.id = i;
                var a = e.get("variable");
                n.forEach(function (t) {
                  return a(e, t, s.pool);
                });
                var c = e.get("items")(e, r, s);
                return (s.items = c), s;
              }),
              (t.prototype.generateHtml = function () {
                ...
                this._frame.setAttribute("style", "position: absolute; " + t);
                var n = document.createElement("div");
                n.setAttribute("style", "position: fixed; " + t),
                  this._frame.appendChild(n),
                  n.addEventListener(
                    "mousedown",
                    function (e) {
                      this.unpost(), this.unpostWidgets(), this.stop(e);
                    }.bind(this),
                  );
              }),
              (t.prototype.display = function () {
              ...
              (t.prototype.unpost = function () {
                if (
                  (e.prototype.unpost.call(this), !(this.widgets.length > 0))
                ) {
                  this.frame.parentNode.removeChild(this.frame);
                  var t = this.store;
                  this.moving || t.insertTaborder(), t.active.focus();
                }
              }),
              (t.prototype.left = function (e) {
              ...
              (t.prototype.post = function (t, n) {
                if (void 0 !== n)
                  return (
                    ...
                    void e.prototype.post.call(this, t, n)
                  );
                var r,
                  o,
                  i,
                ...
                (this.store.active = r), (this.anchor = this.store.active);
                var u = this.html;
                o + u.offsetWidth > document.body.offsetWidth - 5 &&
                  (o = document.body.offsetWidth - u.offsetWidth - 5),
                  this.post(o, i);
              }),
              (t.prototype.registerWidget = function (e) {
                this.widgets.push(e);
              }),
              (t.prototype.unregisterWidget = function (e) {
                var t = this.widgets.indexOf(e);
                t > -1 && this.widgets.splice(t, 1),
                  0 === this.widgets.length && this.unpost();
              }),
              (t.prototype.unpostWidgets = function () {
      ...
      6837: function (e, t, n) {
        ...
        !(function (e) {
          function t(e) {
            return "." + (r.HtmlClasses[e] || e);
          }
          var n = {};
          (n[t("INFOCLOSE")] = "{  top:.2em; right:.2em;}"),
            (n[t("INFOCONTENT")] =
            ...
            (n[t("INFO") + t("MOUSEPOST")] = "{outline:none;}"),
            (n[t("INFO")] =
          ...
          (o[t("MENU")] =
            ...
            (o[t("MENUACTIVE") + " " + t("MENUARROW")] = "{color:white}"),
            (o[t("MENUARROW") + t("RTL")] = "{left:.5em; right:auto}"),
            (o[t("MENUCHECK")] =
              "{  position:absolute; left:.7em;  font-family: null}"),
            (o[t("MENUCHECK") + t("RTL")] = "{ right:.7em; left:auto }"),
            (o[t("MENURADIOCHECK")] = "{  position:absolute; left: .7em;}"),
            (o[t("MENURADIOCHECK") + t("RTL")] = "{  right: .7em; left:auto}"),
            (o[t("MENUINPUTBOX")] =
              "{  padding-left: 1em; right:.5em; color:#666666;  font-family: null;}"),
            (o[t("MENUINPUTBOX") + t("RTL")] = "{  left: .1em;}"),
            (o[t("MENUCOMBOBOX")] = "{  left:.1em; padding-bottom:.5em;}"),
            (o[t("MENUSLIDER")] = "{  left: .1em;}"),
            (o[t("SLIDERVALUE")] =
              "{  position:absolute; right:.1em; padding-top:.25em; color:#333333;  font-size: .75em}"),
            (o[t("SLIDERBAR")] = "{  outline: none; background: #d3d3d3}"),
            (o[t("MENULABEL")] =
              "{  padding: 1px 2em 3px 1.33em;  font-style:italic}"),
            (o[t("MENURULE")] =
              "{  border-top: 1px solid #DDDDDD;  margin: 4px 3px;}"),
            (o[t("MENUDISABLED")] = "{  color:GrayText}"),
            (o[t("MENUACTIVE")] =
              "{  background-color: #606872;  color: white;}"),
            (o[t("MENUDISABLED") + ":focus"] = "{  background-color: #E8E8E8}"),
            (o[t("MENULABEL") + ":focus"] = "{  background-color: #E8E8E8}"),
            (o[t("CONTEXTMENU") + ":focus"] = "{  outline:none}"),
            (o[t("CONTEXTMENU") + " " + t("MENUITEM") + ":focus"] =
              "{  outline:none}"),
            (o[t("SELECTIONMENU")] =
              "{  position:relative; float:left;  border-bottom: none; -webkit-box-shadow:none; -webkit-border-radius:0px; }"),
            (o[t("SELECTIONITEM")] = "{  padding-right: 1em;}"),
            (o[t("SELECTION")] = "{  right: 40%; width:50%; }"),
            (o[t("SELECTIONBOX")] =
              "{  padding: 0em; max-height:20em; max-width: none;  background-color:#FFFFFF;}"),
            (o[t("SELECTIONDIVIDER")] =
              "{  clear: both; border-top: 2px solid #000000;}"),
            (o[t("MENU") + " " + t("MENUCLOSE")] = "{  top:-10px; left:-10px}");
          var i = {};
          (i[t("MENUCLOSE")] =
            ...
            (i[t("MENUCLOSE") + ":hover span"] =
              "{  background-color:#CCC!important}"),
            (i[t("MENUCLOSE") + ":hover:focus"] = "{  outline:none}");
          var s = !1,
            a = !1,
            c = !1;
          function l(e) {
          ...
          function u(e, t) {
            ...
            r.type = "text/css";
            var o = "";
            for (var i in e) (o += i), (o += " "), (o += e[i]), (o += "\n");
            (r.innerHTML = o), n.head.appendChild(r);
          }
          (e.addMenuStyles = function (e) {
            a || (u(o, e), (a = !0), l(e));
          }),
            (e.addInfoStyles = function (e) {
              s || (u(n, e), (s = !0), l(e));
            });
        })(t.CssStyles || (t.CssStyles = {}));
      },
      1698: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.HtmlAttrs = t.HtmlClasses = void 0);
        function n(e) {
          return "CtxtMenu_" + e;
        }
        function r(e) {
        ...
        (t.HtmlClasses = {
          ...
          MENU: r("Menu"),
          MENUARROW: r("MenuArrow"),
          MENUACTIVE: r("MenuActive"),
          MENUCHECK: r("MenuCheck"),
          MENUCLOSE: r("MenuClose"),
          MENUCOMBOBOX: r("MenuComboBox"),
          MENUDISABLED: r("MenuDisabled"),
          MENUFRAME: r("MenuFrame"),
          MENUITEM: r("MenuItem"),
          MENULABEL: r("MenuLabel"),
          MENURADIOCHECK: r("MenuRadioCheck"),
          MENUINPUTBOX: r("MenuInputBox"),
          MENURULE: r("MenuRule"),
          MENUSLIDER: r("MenuSlider"),
          MOUSEPOST: r("MousePost"),
          RTL: r("RTL"),
          INFO: r("Info"),
          INFOCLOSE: r("InfoClose"),
          INFOCONTENT: r("InfoContent"),
          INFOSIGNATURE: r("InfoSignature"),
          INFOTITLE: r("InfoTitle"),
          SLIDERVALUE: r("SliderValue"),
          SLIDERBAR: r("SliderBar"),
          SELECTION: r("Selection"),
          SELECTIONBOX: r("SelectionBox"),
          SELECTIONMENU: r("SelectionMenu"),
          SELECTIONDIVIDER: r("SelectionDivider"),
          SELECTIONITEM: r("SelectionItem"),
        }),
          (t.HtmlAttrs = {
            COUNTER: o("Counter"),
      ...
      6932: function (e, t, n) {
        ...
        var i = n(725),
          ...
          a = (function (e) {
            ...
            return (
              o(t, e),
              (t.prototype.attachMenu = function (e) {
                this.menu = e;
              }),
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this);
                var t = this.html;
                t.appendChild(this.generateTitle()),
                  t.appendChild(this.contentDiv),
                  t.appendChild(this.generateSignature()),
                  t.appendChild(this.close.html),
                  t.setAttribute("tabindex", "0");
              }),
              (t.prototype.post = function () {
                e.prototype.post.call(this);
                var t = document.documentElement,
                  n = this.html,
                  r =
                    window.innerHeight || t.clientHeight || t.scrollHeight || 0,
                  o = Math.floor(-n.offsetWidth / 2),
                  i = Math.floor((r - n.offsetHeight) / 3);
                n.setAttribute(
                  "style",
              ...
              (t.prototype.generateClose = function () {
                var e = new i.CloseButton(this),
                  t = e.html;
                return (
                  t.classList.add(s.HtmlClasses.INFOCLOSE),
                  t.setAttribute("aria-label", "Close Dialog Box"),
                  e
                );
              }),
              (t.prototype.generateTitle = function () {
                var e = document.createElement("span");
                return (
                  (e.innerHTML = this.title),
                  e.classList.add(s.HtmlClasses.INFOTITLE),
                  e
                );
              }),
              (t.prototype.generateContent = function () {
                var e = document.createElement("div");
                return (
                  e.classList.add(s.HtmlClasses.INFOCONTENT),
                  e.setAttribute("tabindex", "0"),
                  e
                );
              }),
              (t.prototype.generateSignature = function () {
                var e = document.createElement("span");
                return (
                  (e.innerHTML = this.signature),
                  e.classList.add(s.HtmlClasses.INFOSIGNATURE),
                  e
                );
              }),
              (t.prototype.toJson = function () {
      ...
      3177: function (e, t, n) {
        ...
        var i = n(2467),
          ...
          c = (function (e) {
            function t(t, n, r, o) {
              var i = e.call(this, t, "checkbox", n, o) || this;
              return (
                (i.role = "menuitemcheckbox"),
                (i.variable = t.pool.lookup(r)),
                i.register(),
                i
              );
            }
            return (
              o(t, e),
              (t.fromJson = function (e, t, n) {
                return new this(n, t.content, t.variable, t.id);
              }),
              (t.prototype.executeAction = function () {
                this.variable.setValue(!this.variable.getValue()),
                  s.MenuUtil.close(this);
              }),
              (t.prototype.generateSpan = function () {
                (this.span = document.createElement("span")),
                  (this.span.textContent = "\u2713"),
                  this.span.classList.add(a.HtmlClasses.MENUCHECK);
              }),
              (t.prototype.updateAria = function () {
                this.html.setAttribute(
                  "aria-checked",
                  this.variable.getValue() ? "true" : "false",
                );
              }),
              (t.prototype.updateSpan = function () {
      ...
      7253: function (e, t, n) {
        ...
        var i = n(2467),
          ...
          l = (function (e) {
            function t(t, n, r, o) {
              var i = e.call(this, t, "combobox", n, o) || this;
              return (
                (i.role = "combobox"),
                (i.inputEvent = !1),
                (i.variable = t.pool.lookup(r)),
            ...
            return (
              ...
              (t.prototype.space = function (t) {
                e.prototype.space.call(this, t), s.MenuUtil.close(this);
              }),
              (t.prototype.focus = function () {
                e.prototype.focus.call(this), this.input.focus();
              }),
              (t.prototype.unfocus = function () {
                e.prototype.unfocus.call(this), this.updateSpan();
              }),
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this),
              ...
              (t.prototype.inputKey = function (e) {
                this.bubbleKey(), (this.inputEvent = !0);
              }),
              (t.prototype.keydown = function (t) {
                if (
                  this.inputEvent &&
                  t.keyCode !== c.KEY.ESCAPE &&
                  t.keyCode !== c.KEY.RETURN
                )
                  return (this.inputEvent = !1), void t.stopPropagation();
                e.prototype.keydown.call(this, t), t.stopPropagation();
              }),
              (t.prototype.updateAria = function () {}),
              (t.prototype.updateSpan = function () {
                var e;
                try {
                  e = this.variable.getValue(s.MenuUtil.getActiveElement(this));
                } catch (t) {
                  e = "";
                }
                this.input.value = e;
      ...
      9665: function (e, t, n) {
        ...
        var i = n(1341),
          ...
          a = (function (e) {
            function t(t, n, r, o) {
              var i = e.call(this, t, "command", n, o) || this;
              return (i.command = r), i;
            }
            return (
              o(t, e),
              (t.fromJson = function (e, t, n) {
                return new this(n, t.content, t.action, t.id);
              }),
              (t.prototype.executeAction = function () {
                try {
                  this.command(s.MenuUtil.getActiveElement(this));
                } catch (e) {
                  s.MenuUtil.error(e, "Illegal command callback.");
                }
                s.MenuUtil.close(this);
              }),
              (t.prototype.toJson = function () {
      ...
      1817: function (e, t, n) {
        ...
        var i = n(1341),
          ...
          a = (function (e) {
            function t(t, n, r) {
              return e.call(this, t, "label", n, r) || this;
            }
            return (
              o(t, e),
              (t.fromJson = function (e, t, n) {
                return new this(n, t.content, t.id);
              }),
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this),
      ...
      3348: function (e, t, n) {
        ...
        var i = n(2467),
          ...
          c = (function (e) {
            function t(t, n, r, o) {
              var i = e.call(this, t, "radio", n, o) || this;
              return (
          ...
          a = (function (e) {
            ...
            return (
              ...
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this);
                var t = this.html;
                t.classList.add(s.HtmlClasses.MENURULE),
      ...
      2129: function (e, t, n) {
        ...
        var i = n(2467),
          ...
          l = (function (e) {
            function t(t, n, r, o) {
              var i = e.call(this, t, "slider", n, o) || this;
              return (
                (i.role = "slider"),
            ...
            return (
              ...
              (t.prototype.keydown = function (t) {
                var n = t.keyCode;
                return n === c.KEY.UP || n === c.KEY.DOWN
                  ? (t.preventDefault(), void e.prototype.keydown.call(this, t))
                  : this.inputEvent && n !== c.KEY.ESCAPE && n !== c.KEY.RETURN
                  ? ((this.inputEvent = !1), void t.stopPropagation())
                  : (e.prototype.keydown.call(this, t),
                    void t.stopPropagation());
              }),
              (t.prototype.updateAria = function () {
                var e = this.variable.getValue();
                e &&
                  this.input &&
                  (this.input.setAttribute("aria-valuenow", e),
                  this.input.setAttribute("aria-valuetext", e + "%"));
              }),
              (t.prototype.updateSpan = function () {
                var e;
                try {
                  (e = this.variable.getValue(
                    s.MenuUtil.getActiveElement(this),
                  )),
                    (this.valueSpan.innerHTML = e + "%");
                } catch (t) {
                  e = "";
                }
                this.input.value = e;
      ...
      2745: function (e, t, n) {
        ...
        var i = n(1341),
          ...
          a = (function (e) {
            function t(t, n, r) {
              var o = e.call(this, t, "submenu", n, r) || this;
            ...
            return (
              ...
              (t.fromJson = function (e, t, n) {
                var r = t.content,
                  o = t.menu,
                  i = new this(n, r, t.id),
                  s = e.get("subMenu")(e, o, i);
                return (i.submenu = s), i;
              }),
              Object.defineProperty(t.prototype, "submenu", {
                get: function () {
        ...
        var i = (function (e) {
          ...
          return (
            ...
            (t.prototype.addAttributes = function (e) {
              for (var t in e) this.html.setAttribute(t, e[t]);
            }),
          ...
          a = (function () {
            ...
            return (
              ...
              (e.prototype.next = function () {
                var e = this.store.length;
                if (0 === e) return (this.active = null), null;
                var t = this.store.indexOf(this.active);
                return (
                  (t = -1 === t ? 0 : t < e - 1 ? t + 1 : 0),
                  (this.active = this.store[t]),
                  this.active
                );
              }),
              ...
              (e.prototype.insert = function (e) {
                var t,
                  n,
                  o = e instanceof HTMLElement ? [e] : e;
                try {
                  for (var i = r(o), s = i.next(); !s.done; s = i.next()) {
                    var a = s.value;
              ...
              (e.prototype.inTaborder = function (e) {
                this.taborder && !e && this.removeTaborder(),
                  !this.taborder && e && this.insertTaborder(),
                  (this.taborder = e);
              }),
              (e.prototype.insertTaborder = function () {
                this.taborder && this.insertTaborder_();
              }),
              (e.prototype.removeTaborder = function () {
                this.taborder && this.removeTaborder_();
              }),
              (e.prototype.insertElement = function (e) {
                e.classList.contains(this.attachedClass) ||
                  (e.classList.add(this.attachedClass),
                  this.taborder && this.addTabindex(e),
                  this.addEvents(e));
              }),
              (e.prototype.removeElement = function (e) {
                e.classList.contains(this.attachedClass) &&
                  (e.classList.remove(this.attachedClass),
                  this.taborder && this.removeTabindex(e),
                  this.removeEvents(e));
              }),
              (e.prototype.sort = function () {
                var e = document.getElementsByClassName(this.attachedClass);
                this.store = [].slice.call(e);
              }),
              (e.prototype.insertTaborder_ = function () {
                this.store.forEach(function (e) {
                  return e.setAttribute("tabindex", "0");
                });
              }),
              (e.prototype.removeTaborder_ = function () {
                this.store.forEach(function (e) {
                  return e.setAttribute("tabindex", "-1");
                });
              }),
              (e.prototype.addTabindex = function (e) {
              ...
              (e.prototype.removeTabindex = function (e) {
                e.hasAttribute(i.HtmlAttrs.OLDTAB)
                  ? (e.setAttribute(
                      "tabindex",
                      e.getAttribute(i.HtmlAttrs.OLDTAB),
                    ),
                    e.removeAttribute(i.HtmlAttrs.OLDTAB))
                  : e.removeAttribute("tabindex");
              }),
              (e.prototype.addEvents = function (e) {
                e.hasAttribute(i.HtmlAttrs.COUNTER) ||
                  (this.addEvent(
                    e,
                    "contextmenu",
                    this.menu.post.bind(this.menu),
                  ),
                  this.addEvent(e, "keydown", this.keydown.bind(this)),
                  e.setAttribute(i.HtmlAttrs.COUNTER, this.counter.toString()),
                  this.counter++);
              }),
              (e.prototype.addEvent = function (e, t, n) {
                var r = i.HtmlAttrs[t.toUpperCase() + "FUNC"];
                (this.attrMap[r + this.counter] = n), e.addEventListener(t, n);
              }),
              (e.prototype.removeEvents = function (e) {
                if (e.hasAttribute(i.HtmlAttrs.COUNTER)) {
                  var t = e.getAttribute(i.HtmlAttrs.COUNTER);
                  this.removeEvent(e, "contextmenu", t),
                    this.removeEvent(e, "keydown", t),
                    e.removeAttribute(i.HtmlAttrs.COUNTER);
                }
              }),
      ...
      865: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (function (e) {
            (e.close = function (e) {
              var t = e.menu;
              t.baseMenu ? t.baseMenu.unpost() : t.unpost();
            }),
              (e.getActiveElement = function (e) {
                var t = e.menu;
                return (t.baseMenu ? t.baseMenu : t).store.active;
              }),
              (e.error = function (e, t) {
                console.error("ContextMenu Error: " + t);
              }),
              (e.counter = function () {
                return t++;
              });
            var t = 0;
          })(t.MenuUtil || (t.MenuUtil = {}));
      },
      9674: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.MOUSE = void 0),
            ...
            function e(e) {
              ...
              void 0 === e && (e = []),
                (this._initList = [
                  ...
                  ["combo", d.Combo.fromJson.bind(d.Combo)],
                  ["slider", g.Slider.fromJson.bind(g.Slider)],
                  ["label", p.Label.fromJson.bind(p.Label)],
                  ["radio", h.Radio.fromJson.bind(h.Radio)],
                  ...
                  [
                    "selectionMenu",
                    y.SelectionMenu.fromJson.bind(y.SelectionMenu),
                  ],
                  [
                    "selectionBox",
                    y.SelectionBox.fromJson.bind(y.SelectionBox),
                  ],
                ]),
                (this._factory = new S.ParserFactory(this._initList)),
                e.forEach(function (e) {
                  var n = o(e, 2),
                    r = n[0],
                    i = n[1];
                  return t.factory.add(r, i);
                });
            }
            return (
              Object.defineProperty(e.prototype, "factory", {
                get: function () {
              ...
              (e.prototype.items = function (e, t, n) {
                var r,
                  o,
                  s = [];
                try {
              ...
              (e.prototype.parse = function (e) {
                ...
                return a ? a.apply(void 0, s([this.factory, i], t)) : null;
              }),
              e
            );
          })();
      ...
      8534: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.ParserFactory = void 0);
        var n = (function () {
          function e(e) {
            this._parser = new Map(e);
          }
          return (
      ...
      7365: function (e, t, n) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.SelectionBox = t.SelectionMenu = void 0);
        var s = n(865),
          a = n(1698),
          c = n(1585),
          l = n(6932),
            ...
            return (
              ...
              (t.fromJson = function (e, t, n) {
                var r = t.title,
                  ...
                  i = t.variable,
                  s = new this(n),
                  a = e.get("label")(e, { content: r || "", id: r || "id" }, s),
                  c = e.get("rule")(e, {}, s),
                  l = o.map(function (t) {
                    return e.get("radio")(
                      e,
                      { content: t, variable: i, id: t },
                      s,
                    );
                  }),
                  u = [a, c].concat(l);
              ...
              (t.prototype.generateHtml = function () {
                e.prototype.generateHtml.call(this),
                  this.items.forEach(function (e) {
                    return e.html.classList.add(a.HtmlClasses.SELECTIONITEM);
                  });
              }),
              (t.prototype.display = function () {}),
              (t.prototype.right = function (e) {
        ...
        var d = (function (e) {
          function t(t, n, r, o) {
            void 0 === r && (r = "none"), void 0 === o && (o = "vertical");
            var i = e.call(this, t, null, n) || this;
            return (
              (i.style = r),
              (i.grid = o),
              (i._selections = []),
          ...
          return (
            ...
            (t.fromJson = function (e, t, n) {
              var r = t.title,
                o = t.signature,
                i = t.selections,
                s = new this(r, o, t.order, t.grid);
              s.attachMenu(n);
              var a = i.map(function (t) {
                return e.get("selectionMenu")(e, t, s);
              });
            ...
            Object.defineProperty(t.prototype, "selections", {
              get: function () {
            ...
            (t.prototype.addSelection = function (e) {
              (e.anchor = this), this._selections.push(e);
            }),
            (t.prototype.rowDiv = function (e) {
              var t = this,
                n = document.createElement("div");
              this.contentDiv.appendChild(n);
              var r = e.map(function (e) {
                  return (
                    n.appendChild(e.html),
                    e.html.id || (e.html.id = t.prefix + s.MenuUtil.counter()),
                    e.html.getBoundingClientRect()
                  );
                }),
                o = r.map(function (e) {
                  return e.width;
              ...
              return (
                ...
                n.setAttribute("style", "height: " + c + "px;"),
                [n, i, c, o]
              );
            }),
            (t.prototype.display = function () {
              if (
                (e.prototype.display.call(this),
                this.order(),
                ...
                for (
                  var t = [],
                    ...
                    s = function (e) {
                      var s = a.selections.slice(e, e + o),
                        c = i(a.rowDiv(s), 4),
                        l = c[0],
                        u = c[1],
                        d = c[2],
                      ...
                      t.push(l),
                        (n = Math.max(n, u)),
                        s.forEach(function (e) {
                          return (e.html.style.height = d + "px");
                        }),
                        (r = a.combineColumn(r, p));
                    },
                    a = this,
                    c = 0;
            ...
            (t.prototype.getChunkSize = function (e) {
              switch (this.grid) {
                case "square":
                  return Math.floor(Math.sqrt(e));
                case "horizontal":
                  return Math.floor(e / t.chunkSize);
                default:
                  return t.chunkSize;
              }
            }),
            (t.prototype.balanceColumn = function (e, t) {
              e.forEach(function (e) {
                for (
                  var n = Array.from(e.children), r = 0, o = void 0;
                  (o = n[r]);
                  r++
                )
                  o.style.width = t[r] + "px";
              });
            }),
            (t.prototype.combineColumn = function (e, t) {
              for (var n = [], r = 0; e[r] || t[r]; ) {
                if (!e[r]) {
                  n = n.concat(t.slice(r));
                  break;
                }
                if (!t[r]) {
                  n = n.concat(e.slice(r));
                  break;
                }
                n.push(Math.max(e[r], t[r])), r++;
              }
              return n;
            }),
            (t.prototype.left = function (e) {
              var t = this;
              this.move(e, function (e) {
                return (0 === e ? t.selections.length : e) - 1;
              });
            }),
            (t.prototype.right = function (e) {
              var t = this;
              this.move(e, function (e) {
                return e === t.selections.length - 1 ? 0 : e + 1;
              });
            }),
            (t.prototype.generateHtml = function () {
              e.prototype.generateHtml.call(this),
            ...
            (t.prototype.generateContent = function () {
              var t = e.prototype.generateContent.call(this);
              return (
                t.classList.add(a.HtmlClasses.SELECTIONBOX),
                t.removeAttribute("tabindex"),
                t
              );
            }),
            (t.prototype.findSelection = function (e) {
              var t = e.target,
                n = null;
              if (
                (t.id &&
                  (n = this.selections.find(function (e) {
                    return e.html.id === t.id;
                  })),
                !n)
              ) {
                var r = t.parentElement.id;
                n = this.selections.find(function (e) {
                  return e.html.id === r;
                });
              }
            ...
            (t.prototype.move = function (e, t) {
              var n = this.findSelection(e);
              n.focused && n.focused.unfocus();
              var r = t(this.selections.indexOf(n));
              this.selections[r].focus();
            }),
          ...
          return (
            ...
            (t.prototype.post = function () {
              if (this.anchor.menu.isPosted()) {
                for (
                  var t = this.anchor.html,
                    n = this.html,
                    r = this.baseMenu.frame,
                    o = t.offsetWidth,
                    i = o - 2,
                    s = 0;
                  t && t !== r;
                  ...
                  (i += t.offsetLeft), (s += t.offsetTop), (t = t.parentNode);
                i + n.offsetWidth > document.body.offsetWidth - 5 &&
                  (i = Math.max(5, i - o - n.offsetWidth + 6)),
                  e.prototype.post.call(this, i, s);
              }
            }),
            (t.prototype.display = function () {
              this.baseMenu.frame.appendChild(this.html);
            }),
            (t.prototype.setBaseMenu = function () {
              var e = this;
              do {
                e = e.anchor.menu;
      ...
      4842: function (e, t, n) {
        ...
        var r = n(865),
          o = (function () {
            ...
            return (
              (e.fromJson = function (e, t, n) {
                var r = new this(t.name, t.getter, t.setter);
                n.insert(r);
              }),
              ...
              (e.prototype.registerCallback = function (e) {
                this.items.forEach(function (t) {
                  return t.registerCallback(e);
                });
              }),
              (e.prototype.unregisterCallback = function (e) {
                this.items.forEach(function (t) {
                  return t.unregisterCallback(e);
                });
              }),
      ...
      6964: function (e, t) {
        ...
        var n = (function () {
          ...
          return (
            ...
            (e.prototype.update = function () {
              for (var e in this.pool) this.pool[e].update();
            }),
            e
          );
        })();
        ...
        class a extends s.MarkupRenderer {
          markup(e) {
            ...
            for (let e, a = 0; (e = t[a]); a++) {
              if (i.isMarkupElement(e)) {
                i.mergeMarkup(r, e);
                continue;
              }
              if (i.isPauseElement(e)) {
                s && (o = i.mergePause(o, e, Math.max));
                continue;
              }
              const t = '"' + this.merge(e.span) + '"';
              (s = !0), o && (n.push(this.pause(o)), (o = null));
          ...
          pause(e) {
            return (
              "(pause . " + this.pauseValue(e[r.personalityProps.PAUSE]) + ")"
            );
          }
          prosody_(e) {
            const t = e.open,
              n = [];
            for (let r, o = 0; (r = t[o]); o++)
              n.push(this.prosodyElement(r, e[r]));
            return n.join(" ");
          }
        }
        t.AcssRenderer = a;
      ...
      2599: function (e, t, n) {
        ...
        (t.mergePause = function (e, t, n) {
          ...
          (t.sortClose = function (e, t) {
            ...
            const n = [];
            for (let r, o = 0; (r = t[o]), e.length; o++)
              r.close &&
                r.close.length &&
        ...
        function l(e, t) {
          ...
          if (n) {
            if (h(t) && h(n)) {
              if (void 0 === n.join)
                return void (n.span = n.span.concat(t.span));
              const e = n.span.pop(),
                r = t.span.shift();
              return (
            ...
            p(t) && p(n) ? (n.pause = s(n.pause, t.pause)) : e.push(t);
          } else e.push(t);
        }
        function u(e, t) {
        ...
        function p(e) {
          return (
            ...
            Object.keys(e)[0] === o.personalityProps.PAUSE
          );
        }
        function h(e) {
        ...
        function f(e, t, n, r, a, c = !1) {
          if (c) {
            ...
            let l;
            if (
              (c && (l = c[o.personalityProps.JOIN]),
              c && !t.speech && a && p(c))
            ) {
              const e = o.personalityProps.PAUSE;
              (c[e] = s(c[e], a[e])), (a = null);
            }
            if (c && t.speech && 0 === Object.keys(n).length && h(c)) {
              if (void 0 !== l) {
                const e = c.span.pop();
                t = new i.Span(e.speech + l + t.speech, e.attributes);
              }
              c.span.push(t),
                (t = new i.Span("", {})),
                (c[o.personalityProps.JOIN] = r);
            }
          }
        ...
        function m(e, t) {
          if (!t) return e;
          const n = {};
          for (const r of o.personalityPropList) {
            const o = e[r],
              i = t[r];
            ...
            d(n) || ((n.open = []), (n.close = [])),
              o || n.close.push(r),
              i || n.open.push(r),
              i && o && (n.close.push(r), n.open.push(r)),
              (t[r] = s),
              (n[r] = s),
          ...
          if (d(n)) {
            ...
            for (; e.length > 0; ) {
              let o = c.pop();
              const i = (0, r.setdifference)(o, e);
              if (((e = (0, r.setdifference)(e, o)), (o = i), 0 !== e.length)) {
                if (0 !== o.length) {
                  (n.close = n.close.concat(o)), (n.open = n.open.concat(o));
                  for (let e, r = 0; (e = o[r]); r++) n[e] = t[e];
                }
              } else 0 !== o.length && c.push(o);
            }
            c.push(n.open);
          }
          return n;
      ...
      4148: function (e, t, n) {
        ...
        class i {
          ...
          static create(e, t = {}) {
            return (
              (e.text = r.Grammar.getInstance().apply(e.text, t)), new i(e)
            );
          }
          isEmpty() {
            return (
          ...
          descriptionSpan() {
            return new o.Span(this.descriptionString(), this.attributes);
          }
          equals(e) {
            return (
      ...
      4253: function (e, t, n) {
        ...
        (t.setSeparator = function (e) {
          ...
          (t.merge = function (e) {
            const t = e.map((e) =>
                "string" == typeof e ? new l.Span(e, {}) : e,
              ),
          ...
          (t.isXml = function () {
            return (
              m.get(r.default.getInstance().markup) instanceof h.XmlRenderer
            );
          });
      },
      1292: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.LayoutRenderer = void 0);
        const r = n(1984),
          o = n(6671),
          i = n(4998),
          s = n(2599),
        ...
        class c extends a.XmlRenderer {
          finalize(e) {
            return (function (e) {
              l = "";
              const t = o.parseInput(`<all>${e}</all>`);
              return (
                r.Debugger.getInstance().output(o.formatXml(t.toString())),
                (l = h(t)),
                l
              );
            })(e);
          ...
          prosodyElement(e, t) {
            return e === i.personalityProps.LAYOUT ? `<${t}>` : "";
          }
          closeTag(e) {
            return `</${e}>`;
          }
        ...
        const u = {
          TABLE: function (e) {
            ...
            const [n, r] = y(t);
            return (t = S(t, r)), E(t, n);
          },
          CASES: function (e) {
            let t = b(e);
            t.forEach((e) => {
              (e.cells = e.cells.slice(0, -1)),
                (e.width = e.width.slice(0, -1));
            });
            const [n, r] = y(t);
            return (t = S(t, r)), E(t, n);
          },
          CAYLEY: function (e) {
            ...
            return t.splice(1, 0, o), (t = S(t, r)), E(t, n);
          },
          MATRIX: function (e) {
            let t = b(e);
            const [n, r] = y(t);
          ...
          ROW: h,
          FRACTION: function (e) {
            const [t, n, , r, o] = Array.from(e.childNodes),
              i = d(n),
              s = d(r),
              a = m(i),
              c = m(s);
            let l = Math.max(a, c);
            const u = t + new Array(l + 1).join("\u2812") + o;
            return (l = u.length), `${v(i, l)}\n${u}\n${v(s, l)}`;
          },
          NUMERATOR: C,
          DENOMINATOR: C,
        };
        ...
        function p(e, t) {
          ...
          const n = f(e),
            r = f(t),
            o = n - r;
          (e = o < 0 ? g(e, r, m(e)) : e), (t = o > 0 ? g(t, n, m(t)) : t);
          const i = e.split(/\r\n|\r|\n/),
            s = t.split(/\r\n|\r|\n/),
            a = [];
          for (let e = 0; e < i.length; e++) a.push(i[e] + s[e]);
          return a.join("\n");
        }
        function h(e) {
          let t = "";
          for (const n of Array.from(e.childNodes))
            t =
              n.nodeType !== o.NodeType.TEXT_NODE
                ? p(t, d(n))
                : p(t, n.textContent);
          return t;
        }
        ...
        function b(e) {
          const t = Array.from(e.childNodes),
            n = [];
          for (const e of t)
            e.nodeType === o.NodeType.ELEMENT_NODE && n.push(_(e));
          return n;
        }
        function y(e) {
          ...
          for (let t = 0; t < e[0].width.length; t++)
            n.push(
              e.map((e) => e.width[t]).reduce((e, t) => Math.max(e, t), 0),
            );
          return [t, n];
        }
        function S(e, t) {
        ...
        function E(e, t) {
          if (1 === t)
            return e
              .map((e) => e.lfence + e.cells.join(e.sep) + e.rfence)
              .join("\n");
          const n = [];
          for (const t of e) {
            const e = N(t.sep, t.height);
            let r = t.cells.shift();
            for (; t.cells.length; ) (r = p(r, e)), (r = p(r, t.cells.shift()));
            (r = p(N(t.lfence, t.height), r)),
              (r = p(r, N(t.rfence, t.height))),
              n.push(r),
        ...
        function A(e) {
          return e.nodeType === o.NodeType.ELEMENT_NODE &&
            "FENCE" === o.tagName(e)
            ? d(e)
            : "";
        }
        function _(e) {
          ...
          const s = [];
          for (const e of t) {
            if (e.nodeType === o.NodeType.TEXT_NODE) {
              i = e.textContent;
              continue;
            }
            const t = d(e);
        ...
        function v(e, t) {
          const n = (t - m(e)) / 2,
            [r, o] =
              Math.floor(n) === n ? [n, n] : [Math.floor(n), Math.ceil(n)],
            i = e.split(/\r\n|\r|\n/),
            s = [],
            [a, c] = [
              new Array(r + 1).join("\u2800"),
          ...
          for (const e of i) s.push(a + e + c);
          return s.join("\n");
        }
        function C(e) {
          const t = e.firstChild,
            n = h(e);
          if (t && t.nodeType === o.NodeType.ELEMENT_NODE) {
            if ("ENGLISH" === o.tagName(t)) return "\u2830" + n;
            if ("NUMBER" === o.tagName(t)) return "\u283c" + n;
          }
          return n;
        }
      },
            ...
            for (let e, a = 0; (e = t[a]); a++)
              i.isMarkupElement(e) ||
                (i.isPauseElement(e)
                  ? s && (o = i.mergePause(o, e, Math.max))
                  : (o &&
                      ((n += this.pause(o[r.personalityProps.PAUSE])),
                      (o = null)),
      ...
      8078: function (e, t, n) {
        ...
        class i extends o.XmlRenderer {
          ...
          pause(e) {
            return (
              '<BREAK MSEC="' +
              this.pauseValue(e[r.personalityProps.PAUSE]) +
              '"/>'
            );
          }
          prosodyElement(e, t) {
      ...
      4115: function (e, t, n) {
        ...
        class s extends i.XmlRenderer {
          ...
          pause(e) {
            return (
              '<break time="' +
              this.pauseValue(e[o.personalityProps.PAUSE]) +
              'ms"/>'
            );
          }
          prosodyElement(e, t) {
      ...
      6123: function (e, t, n) {
        ...
        const r = n(4115);
        class o extends r.SsmlRenderer {
          markup(e) {
            return (o.MARKS = {}), super.markup(e);
          }
          merge(e) {
            const t = [];
            for (let n = 0; n < e.length; n++) {
              const r = e[n],
                i = r.attributes.extid;
              i &&
                !o.MARKS[i] &&
                (t.push('<mark name="' + i + '"/>'), (o.MARKS[i] = !0)),
        ...
        (t.SsmlStepRenderer = o),
          (o.CHARACTER_ATTR = "character"),
          (o.MARKS = {});
      },
      8244: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.StringRenderer = void 0);
        const r = n(7086),
          o = n(2599);
        class i extends r.AbstractAudioRenderer {
          markup(e) {
            let t = "";
            const n = (0, o.personalityMarkup)(e).filter((e) => e.span);
            if (!n.length) return t;
            const r = n.length - 1;
            for (let e, o = 0; (e = n[o]); o++) {
              if ((e.span && (t += this.merge(e.span)), o >= r)) continue;
              const n = e.join;
        ...
        class s extends i.MarkupRenderer {
          markup(e) {
            ...
            for (let e, s = 0; (e = t[s]); s++)
              if (e.span) n.push(this.merge(e.span));
              else if (o.isPauseElement(e)) n.push(this.pause(e));
              else {
                if (e.close.length)
                ...
                if (e.open.length) {
                  o.sortClose(e.open.slice(), t.slice(s + 1)).forEach((t) => {
                    n.push(this.prosodyElement(t, e[t])), i.push(t);
                  });
                }
              }
            return n.join(" ");
        ...
        function s(e, t) {
          ...
          "undefined" == typeof wgxpath && n < 10
            ...
            : n >= 10 ||
              ...
              (o.xpath.createNSResolver = document.createNSResolver));
        }
        function a() {
      ...
      6671: function (e, t, n) {
        ...
        (t.toArray = a),
          ...
          (t.createElement = function (e) {
            return i.default.document.createElement(e);
          }),
          (t.createElementNS = function (e, t) {
            return i.default.document.createElementNS(e, t);
          }),
          (t.createTextNode = function (e) {
            return i.default.document.createTextNode(e);
          }),
          (t.formatXml = function (e) {
            ...
            for (
              ...
              if (e.match(/^<\w[^>/]*>[^>]+$/)) {
                ...
                t[0]
                  ? t[1]
                    ? ((e += o.shift().slice(0, -t[1].length)),
                      t[1].trim() && o.unshift(t[1]))
                    : (e += o.shift())
                  : (n = 1);
                ...
                const t = e.indexOf(">") + 1;
                e.slice(t).trim() && o.unshift(), (e = e.slice(0, t));
              } else n = 0;
          ...
          (t.serializeXml = function (e) {
            return new i.default.xmldom.XMLSerializer().serializeToString(e);
          });
      },
      4886: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          setDynamicCstr(e) {
            if (
              ...
              for (let n = 0; n < t.length; n++) {
                const o = t[n];
                if (-1 !== r.DynamicCstr.DEFAULT_ORDER.indexOf(o)) {
                  const t = e[o];
                  this[o] = t;
                }
              }
            ...
            (this.parser = s || this.defaultParser),
              ...
              (this.comparator = i
                ? i()
                : new r.DefaultComparator(this.dynamicCstr));
          }
          configurate(e) {
      ...
      7129: function (e, t, n) {
        ...
        (t.makePath = o),
          (t.localePath = function (e, t = "json") {
            return o(r.default.jsonPath) + e + (t.match(/^\./) ? t : "." + t);
          });
      },
      3539: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          constructor(e, t) {
            (this.name = e),
              ...
              (this.processor = this.postprocess
                ...
                : this.process),
              (this.print = t.print || o.stringify_),
        ...
        class i extends o {
          constructor(e, t) {
            super(e, t), (this.key = t.key || i.getKey_);
          }
          static getKey_(e) {
      ...
      9615: function (e, t, n) {
        ...
        function S(e) {
          const t = b.get(e);
          if (!t) throw new h.SREError("Unknown processor " + e);
          return t;
        }
        function E(e, t) {
          const n = S(e);
          try {
            ...
            throw new h.SREError("Processing error for expression " + t);
          }
        }
        function N(e, t) {
          const n = S(e);
          return h.default.getInstance().pprint ? n.pprint(t) : n.print(t);
        }
        (t.set = y),
          (t.process = E),
          (t.print = N),
          (t.output = function (e, t) {
            ...
            try {
              ...
              return h.default.getInstance().pprint ? n.pprint(e) : n.print(e);
            } catch (e) {
              throw new h.SREError("Processing error for expression " + t);
            }
          }),
          (t.keypress = function (e, t) {
            const n = S(e),
              ...
              o = n.processor(r);
            return h.default.getInstance().pprint ? n.pprint(o) : n.print(o);
          }),
          y(
            new m.Processor("semantic", {
              processor: function (e) {
                const t = p.parseInput(e);
                return a.xmlTree(t);
              },
              postprocessor: function (e, t) {
                const n = h.default.getInstance().speech;
                if (n === f.Speech.NONE) return e;
                const o = p.cloneNode(e);
                let i = l.computeMarkup(o);
                if (n === f.Speech.SHALLOW)
                  return e.setAttribute("speech", r.finalize(i)), e;
                const s = g.evalXPath(".//*[@id]", e),
                  a = g.evalXPath(".//*[@id]", o);
                for (let e, t, n = 0; (e = s[n]), (t = a[n]); n++)
                  (i = l.computeMarkup(t)),
                    e.setAttribute("speech", r.finalize(i));
                return e;
              },
              pprint: function (e) {
                return p.formatXml(e.toString());
              },
            }),
          ),
          y(
            new m.Processor("speech", {
              processor: function (e) {
                const t = p.parseInput(e),
                  n = a.xmlTree(t),
                  o = l.computeSpeech(n);
                return r.finalize(r.markup(o));
              },
              pprint: function (e) {
                const t = e.toString();
                return r.isXml() ? p.formatXml(t) : t;
              },
            }),
          ),
          y(
            new m.Processor("json", {
              ...
              postprocessor: function (e, t) {
                const n = h.default.getInstance().speech;
                if (n === f.Speech.NONE) return e;
                const o = p.parseInput(t),
                  i = a.xmlTree(o),
                  s = l.computeMarkup(i);
                if (n === f.Speech.SHALLOW)
                  return (e.stree.speech = r.finalize(s)), e;
                const c = (e) => {
                  const t = g.evalXPath(`.//*[@id=${e.id}]`, i)[0],
                    n = l.computeMarkup(t);
                  (e.speech = r.finalize(n)),
          ...
          y(
            new m.Processor("enriched", {
              processor: function (e) {
                return o.semanticMathmlSync(e);
              },
              postprocessor: function (e, t) {
                const n = d.getSemanticRoot(e);
                let r;
                switch (h.default.getInstance().speech) {
                  case f.Speech.NONE:
                    break;
            ...
            new m.Processor("walker", {
              processor: function (e) {
                ...
                (m.Processor.LocalState.speechGenerator = t),
                  t.setOptions({
                    modality: h.default.getInstance().modality,
                    locale: h.default.getInstance().locale,
                    domain: h.default.getInstance().domain,
                    style: h.default.getInstance().style,
                  }),
                  (m.Processor.LocalState.highlighter = i.highlighter(
                    { color: "black" },
                    { color: "white" },
                    { renderer: "NativeMML" },
                  ));
      ...
      9037: function (e, t, n) {
            ...
            case s.Mode.ASYNC:
              return (function (e, t, n) {
                return r(this, void 0, void 0, function* () {
                  ...
                  if (n)
                    try {
                      l.default.fs.promises.writeFile(n, i);
                    } catch (e) {
                      throw new o.SREError("Can not write to file: " + n);
                    }
                  return i;
                });
              })(e, t, n);
              ...
              return (function (e, t, n) {
                const r = (function (e) {
                    ...
                    try {
                      ...
                      throw new o.SREError("Can not open file: " + e);
                    }
                    return t;
                  })(t),
                  i = c.output(e, r);
                if (n)
                  try {
                    l.default.fs.writeFileSync(n, i);
                  } catch (e) {
                    throw new o.SREError("Can not write to file: " + n);
                  }
                return i;
        ...
        (t.version = u.Variables.VERSION),
          ...
          (t.engineReady = function () {
            return r(this, void 0, void 0, function* () {
              return p({}).then(() => o.EnginePromise.getall());
            });
          }),
          ...
          (t.exit = function (e) {
            const t = e || 0;
            o.EnginePromise.getall().then(() => process.exit(t));
          }),
          (t.localePath = a.localePath),
          l.default.documentSupported
            ? p({ mode: s.Mode.HTTP }).then(() => p({}))
            : p({ mode: s.Mode.SYNC }).then(() => p({ mode: s.Mode.ASYNC }));
      },
        ...
        class n {
          static ensureLocale(e, t) {
            return n.LOCALES.get(e)
              ? e
              : (console.error(
                  `Locale ${e} does not exist! Using ${n.LOCALES.get(
                    t,
                  )} instead.`,
                ),
                t);
      ...
      5024: function (e, t, n) {
        ...
        t.xpath = {
          ...
          evaluate: s() ? document.evaluate : i.default.xpath.evaluate,
        ...
        function u(e, n, i) {
          return r.default.getInstance().mode !== o.Mode.HTTP ||
            ...
            ? t.xpath.evaluate(e, n, new l(), i, null)
            : t.xpath.currentDocument.evaluate(e, n, c, i, null);
        }
        function d(e, n) {
          let r;
          try {
          ...
          const o = [];
          for (let e = r.iterateNext(); e; e = r.iterateNext()) o.push(e);
          return o;
        }
        (t.evalXPath = d),
          ...
          (t.updateEvaluator = function (e) {
            if (r.default.getInstance().mode !== o.Mode.HTTP) return;
            let n = e;
      ...
      928: function (e, t, n) {
        ...
        const r = n(6671),
          ...
          l = n(8672),
          u = n(8171);
        class d extends i.AbstractEnrichCase {
          constructor(e) {
            super(e),
              (this.fenced = null),
              (this.fencedMml = null),
          ...
          static makeEmptyNode_(e) {
            const t = r.createElement("mrow"),
              n = new o.SemanticNode(e);
            return (n.type = "empty"), (n.mathmlTree = t), n;
          }
          static fencedMap_(e, t) {
            (t[e.id] = e.mathmlTree),
              e.embellished && d.fencedMap_(e.childNodes[0], t);
          }
          getMathml() {
            this.getFenced_(),
          ...
          fencedElement(e) {
            return (
              "fenced" === e.type || "matrix" === e.type || "vector" === e.type
            );
          }
          getFenced_() {
            let e = this.semantic;
          ...
          getFencesMml_() {
            ...
            this.ofenceMml || (this.ofenceMml = this.ofence.mathmlTree),
              ...
              this.ofenceMml &&
                (this.ofenceMml = l.ascendNewNode(this.ofenceMml)),
              this.cfenceMml &&
                (this.cfenceMml = l.ascendNewNode(this.cfenceMml));
          }
          rewrite_() {
            let e = this.semantic,
              t = null;
            ...
            for (
              ...
              const o = e.mathmlTree,
                i = this.specialCase_(e, o);
              if (i) e = i;
              else {
                (0, u.setAttributes)(o, e);
                const t = [];
              ...
              r.replaceNode(o, s),
                r.replaceNode(n, o),
                r.replaceNode(o.childNodes[0], n),
                r.replaceNode(s, a),
                t || (t = o);
            }
            return (
          ...
          specialCase_(e, t) {
            ...
            if (
              ("MSUBSUP" === n
                ? ((i = e.childNodes[0]), (o = s.CaseDoubleScript))
                : "MMULTISCRIPTS" === n &&
                  ("superscript" === e.type || "subscript" === e.type
                    ? (o = a.CaseMultiscripts)
                    : "tensor" === e.type && (o = c.CaseTensor),
                  (i =
                    o && e.childNodes[0] && "subsup" === e.childNodes[0].role
                      ? e.childNodes[0]
                      : e)),
              !i)
            )
              return null;
            const l = i.childNodes[0],
          ...
          getMathml() {
            ...
            return (
              "limboth" !== this.semantic.type &&
                ...
                (this.mml = i.introduceNewLayer([this.mml], this.semantic)),
              (0, s.setAttributes)(this.mml, this.semantic),
          ...
          completeMultiscript(e, t) {
            ...
            const c = (e) => {
              for (let t, r = 0; (t = e[r]); r++) {
                ...
                if (
                  e &&
                  t === parseInt(i.getInnerNode(e).getAttribute(s.Attribute.ID))
                )
                  i
                    .getInnerNode(e)
                    .setAttribute(
            ...
            c(e),
              n[o] && "MPRESCRIPTS" !== r.tagName(n[o])
                ? this.mml.insertBefore(n[o], r.createElement("mprescripts"))
                : o++,
              c(t);
          }
        }
      ...
      4308: function (e, t, n) {
        ...
        const r = n(6671),
          ...
          s = n(8672),
          a = n(8171);
        class c extends i.CaseMultiindex {
          static test(e) {
          ...
          getMathml() {
            ...
            if (
              ...
              (e = r.childNodes[0]),
                (t = i.CaseMultiindex.multiscriptIndex(
                  this.semantic.childNodes[1],
                )),
                (n = i.CaseMultiindex.multiscriptIndex(r.childNodes[1]));
              ...
              s.addCollapsedAttribute(this.mml, c),
                ...
                this.completeMultiscript(
                  o.SemanticSkeleton.interleaveIds(n, t),
                  [],
                );
            } else {
            ...
            const r = o.SemanticSkeleton.collapsedLeafs(n || [], t),
              c = s.walkTree(e);
            return (
              s
                .getInnerNode(c)
      ...
      6998: function (e, t, n) {
        ...
        class a extends o.AbstractEnrichCase {
          ...
          static test(e) {
            return (
              "matrix" === e.type || "vector" === e.type || "cases" === e.type
            );
          }
          getMathml() {
            const e = i.cloneContentNode(this.semantic.contentNodes[0]),
              t = this.semantic.contentNodes[1]
                ? i.cloneContentNode(this.semantic.contentNodes[1])
                : null;
            if (
              ((this.inner = this.semantic.childNodes.map(i.walkTree)),
              this.mml)
            )
              if ("MFENCED" === r.tagName(this.mml)) {
                ...
                const n = [e, this.mml];
                t && n.push(t),
                  (this.mml = i.introduceNewLayer(n, this.semantic));
              }
            else
      ...
      439: function (e, t, n) {
        ...
        class a extends o.CaseMultiindex {
          ...
          getMathml() {
            ...
            const e = o.CaseMultiindex.multiscriptIndex(
                this.semantic.childNodes[1],
              ),
              t = o.CaseMultiindex.multiscriptIndex(
                this.semantic.childNodes[2],
              ),
              n = o.CaseMultiindex.multiscriptIndex(
            ...
            i.addCollapsedAttribute(this.mml, c);
        ...
        class s extends r.AbstractEnrichCase {
          ...
          static test(e) {
            return (
              "punctuated" === e.type &&
              ("text" === e.role ||
                e.contentNodes.every((e) => "dummy" === e.role))
            );
          }
          getMathml() {
            const e = [],
              t = o.collapsePunctuated(this.semantic, e);
            return (
              (this.mml = o.introduceNewLayer(e, this.semantic)),
              (0, i.setAttributes)(this.mml, this.semantic),
              this.mml.removeAttribute(i.Attribute.CONTENT),
              o.addCollapsedAttribute(this.mml, t),
              this.mml
            );
          }
        }
      ...
      7450: function (e, t, n) {
        ...
        const r = n(1984),
          ...
          c = n(8171);
        function l(e) {
          const t = o.cloneNode(e),
            n = s.getTree(t);
          return a.enrich(t, n);
        }
        function u(e) {
          return l(o.parseInput(e));
        }
        function d(e) {
          return (
        ...
        n(7813),
          ...
          (t.testTranslation__ = function (e) {
            ...
            return (
              (0, c.removeAttributePrefix)(t),
              r.Debugger.getInstance().exit(),
              t
            );
          }),
      ...
      8171: function (e, t) {
        ...
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.makeIdList = r),
          (t.setAttributes = function (e, i) {
            e.setAttribute(n.TYPE, i.type);
            const s = i.allAttributes();
            for (let n, r = 0; (n = s[r]); r++)
              e.setAttribute(t.Prefix + n[0].toLowerCase(), n[1]);
            i.childNodes.length && e.setAttribute(n.CHILDREN, r(i.childNodes)),
              i.contentNodes.length &&
                e.setAttribute(n.CONTENT, r(i.contentNodes)),
              i.parent && e.setAttribute(n.PARENT, i.parent.id.toString()),
              o(e, i);
          }),
          (t.setPostfix = o),
      ...
      7813: function (e, t, n) {
        ...
        n(9775).factory.push(
          { test: s.CaseLimit.test, constr: (e) => new s.CaseLimit(e) },
          {
            ...
            constr: (e) => new i.CaseEmbellished(e),
          },
          {
            test: o.CaseDoubleScript.test,
            constr: (e) => new o.CaseDoubleScript(e),
          },
          { test: d.CaseTensor.test, constr: (e) => new d.CaseTensor(e) },
          {
            test: c.CaseMultiscripts.test,
            constr: (e) => new c.CaseMultiscripts(e),
          },
          ...
          { test: p.CaseText.test, constr: (e) => new p.CaseText(e) },
        );
      },
      8672: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        function p(e) {
            ...
            return (
              ...
              e.childNodes.length &&
                ...
                e.childNodes.forEach(function (e) {
                  "empty" === e.type && n.appendChild(p(e));
                })),
              x(n)
            );
          const o = e.contentNodes.map(w);
          k(e, o);
          const i = e.childNodes.map(p),
            s = c.SemanticSkeleton.combineContentChildren(e, o, i);
          if (((n = e.mathmlTree), null === n))
            r.Debugger.getInstance().output("Walktree Case 1"), (n = h(s, e));
          else {
            const e = M(s);
          ...
          return (n = D(n)), S(n, s, e), u.setAttributes(n, e), x(n);
        }
        function h(e, t) {
          const n = v(e);
          let i = n.node;
          const s = n.type;
          if (s !== _.VALID || !l.hasEmptyTag(i))
            if (
          ...
          return t.mathmlTree || (t.mathmlTree = i), i;
        }
        function f(e, t, n) {
          let i = I(t);
          if (l.hasMathTag(i)) {
            r.Debugger.getInstance().output("Walktree Case 1.1.0.0"),
              m(i, e),
              o.toArray(i.childNodes).forEach(function (t) {
                e.appendChild(t);
              });
            const t = e;
            (e = i), (i = t);
        ...
        function g(e, t) {
          const n = o.toArray(e.childNodes);
          let r = 1 / 0,
            i = -1 / 0;
          return (
            t.forEach(function (e) {
              const t = n.indexOf(e);
              -1 !== t && ((r = Math.min(r, t)), (i = Math.max(i, t)));
            }),
            n.slice(r, i + 1)
          );
        }
        ...
        function E(e, t, n) {
          ...
          for (
            ...
            o &&
            o.firstChild === r &&
            !r.hasAttribute("AuxiliaryImplicit") &&
            o !== e;

          )
            (r = o), (o = R(r));
          o && (o.insertBefore(n, r), r.removeAttribute("AuxiliaryImplicit"));
        }
        function N(e, t) {
          if (!e) return !1;
          do {
        ...
        function O(e, t) {
          const n = t || ((e) => !1),
            r = [e];
          for (; !n(e) && !l.hasMathTag(e) && e.parentNode; )
            (e = R(e)), r.unshift(e);
          return r;
        }
        function T(e, t) {
        ...
        function x(e) {
          for (; !l.hasMathTag(e) && L(e); ) e = R(e);
          return e;
        }
        function I(e) {
          const t = o.toArray(e.childNodes);
          if (!t) return e;
          const n = t.filter(function (e) {
            return e.nodeType === o.NodeType.ELEMENT_NODE && !l.hasIgnoreTag(e);
          });
          return 1 === n.length &&
            l.hasEmptyTag(n[0]) &&
        ...
        function L(e) {
          ...
          return (
            !(!t || !l.hasEmptyTag(t)) &&
            o.toArray(t.childNodes).every(function (t) {
              return t === e || P(t);
            })
          );
        }
        function P(e) {
          if (e.nodeType !== o.NodeType.ELEMENT_NODE) return !0;
          ...
          return (
            !(
              ...
              e.hasAttribute(u.Attribute.TYPE) ||
              l.isOrphanedGlyph(e)
            ) && o.toArray(e.childNodes).every(P)
          );
        }
        function R(e) {
          return e.parentNode;
        ...
        function w(e) {
          if (e.mathml.length) return p(e);
          const n = t.SETTINGS.implicit ? F(e) : o.createElement("mrow");
          return (e.mathml = [n]), n;
        }
        function D(e) {
          if ("MFENCED" !== o.tagName(e)) return e;
          const t = o.createElement("mrow");
          for (let n, r = 0; (n = e.attributes[r]); r++)
            -1 === ["open", "close", "separators"].indexOf(n.name) &&
              t.setAttribute(n.name, n.value);
          return (
            o.toArray(e.childNodes).forEach(function (e) {
              t.appendChild(e);
            }),
            o.replaceNode(e, t),
            t
        ...
        function F(e) {
          const t = o.createElement("mo"),
            n = o.createTextNode(e.textContent);
          return (
            t.appendChild(n),
            u.setAttributes(t, e),
        ...
        function B(e, t, n, r) {
          const o = r || !1;
          j(e, "Original MathML", o),
            j(n, "Semantic Tree", o),
            j(t, "Semantically enriched MathML", o);
        }
        function j(e, t, n) {
          const r = o.formatXml(e.toString());
          n
            ? console.info(
        ...
        (t.SETTINGS = { collapsed: !0, implicit: !0 }),
          ...
          (t.walkTree = p),
          (t.introduceNewLayer = h),
          (t.introduceLayerAboveLca = f),
          (t.moveSemanticAttributes_ = m),
          (t.childrenSubset_ = g),
          (t.collateChildNodes_ = b),
          (t.collectChildNodes_ = y),
          (t.mergeChildren_ = S),
          (t.insertNewChild_ = E),
          (t.isDescendant_ = N),
          ...
          (t.cloneContentNode = w),
          (t.rewriteMfenced = D),
          (t.createInvisibleOperator_ = F),
          ...
          (t.collapsePunctuated = function (e, t) {
            const n = !!t,
              r = t || [],
              o = e.parent,
              i = e.contentNodes.map(function (e) {
                return e.id;
              });
            i.unshift("c");
            const s = [e.id, i];
            for (let t, i = 0; (t = e.childNodes[i]); i++) {
              const e = p(t);
              r.push(e);
              const i = U(e);
              o && !n && i.setAttribute(u.Attribute.PARENT, o.id.toString()),
                s.push(t.id);
            }
            return s;
          }),
          (t.printNodeList__ = function (e, t) {
            console.info(e),
              o.toArray(t).forEach(function (e) {
      ...
      7228: function (e, t, n) {
        ...
        class i {
          ...
          isHighlighted(e) {
            return e.hasAttribute(i.ATTR);
          }
          setHighlighted(e) {
            e.setAttribute(i.ATTR, "true");
          }
          unsetHighlighted(e) {
            e.removeAttribute(i.ATTR);
          }
          colorizeAll(e) {
            r.evalXPath(`.//*[@${o.Attribute.ID}]`, e).forEach((e) =>
              this.colorize(e),
            );
          }
          uncolorizeAll(e) {
          ...
          colorize(e) {
            const t = (0, o.addPrefix)("foreground");
            e.hasAttribute(t) &&
              (e.setAttribute(t + "-old", e.style.color),
              (e.style.color = e.getAttribute(t)));
          }
          uncolorize(e) {
            const t = (0, o.addPrefix)("foreground") + "-old";
            e.hasAttribute(t) && (e.style.color = e.getAttribute(t));
          }
        }
        (t.AbstractHighlighter = i), (i.ATTR = "sre-highlight");
      },
      7567: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.ChtmlHighlighter = void 0);
        const r = n(9400);
        class o extends r.CssHighlighter {
          constructor() {
            super();
          }
          isMactionNode(e) {
      ...
      1123: function (e, t) {
        ...
        function r(e, t) {
          const r = e || { color: t };
          let o = Object.prototype.hasOwnProperty.call(r, "color")
            ? n[r.color]
            : r;
          return (
            o || (o = n[t]),
            (o.alpha = Object.prototype.hasOwnProperty.call(r, "alpha")
              ? r.alpha
              : 1),
            (function (e) {
              const t = (e) => (
        ...
        class o {
          constructor(e, t) {
            (this.foreground = r(t, o.DEFAULT_FOREGROUND_)),
              (this.background = r(e, o.DEFAULT_BACKGROUND_));
          }
          static toHex(e) {
          ...
          hex() {
            const e = function (e) {
              return "#" + o.toHex(e.red) + o.toHex(e.green) + o.toHex(e.blue);
            };
            return {
              background: e(this.background),
              alphaback: this.background.alpha.toString(),
              ...
              (t = (function (e, t, n) {
                ...
                return (
                  0 <= e && e < 60
                    ...
                    : 240 <= e && e < 300
                    ? ([s, a, c] = [o, 0, r])
                    : 300 <= e && e < 360 && ([s, a, c] = [r, 0, o]),
                  { red: s + i, green: a + i, blue: c + i }
                );
      ...
      9400: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.CssHighlighter = void 0);
        const r = n(7228);
        class o extends r.AbstractHighlighter {
          constructor() {
          ...
          const i = new o.ColorPicker(e, n),
            s =
              "NativeMML" === r.renderer && "Safari" === r.browser
                ...
                ? "SVG-V3"
                : r.renderer,
            a = new (t.highlighterMapping_[s] ||
              t.highlighterMapping_.NativeMML)();
          return a.setColor(i), a;
        }),
          (t.addEvents = function (e, n, r) {
            const o = t.highlighterMapping_[r.renderer];
            o && new o().addEvents(e, n);
          }),
          ...
          highlightNode(e) {
            ...
            if (o && o.w) {
              ...
              (a.style.backgroundColor = n.background),
                ...
                (a.style.marginTop = a.style.marginBottom = -i + "em"),
                (a.style.width = o.w + 2 * s + "em"),
                (a.style.marginLeft = c - s + "em"),
                (a.style.marginRight = -o.w - s - c + "em"),
      ...
      3711: function (e, t, n) {
        ...
        t.MmlCssHighlighter = o;
      },
      4662: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.MmlHighlighter = void 0);
        const r = n(7228);
        class o extends r.AbstractHighlighter {
          constructor() {
            super(), (this.mactionName = "maction");
        ...
        class i extends o.AbstractHighlighter {
          ...
          highlightNode(e) {
            ...
            return (
              ...
              n.setAttribute(o.AbstractHighlighter.ATTR, "true"),
        ...
        class c extends a.SvgHighlighter {
          ...
          highlightNode(e) {
            ...
            if (
              ...
              n.setAttribute("fill", this.colorString().background),
              e.setAttribute(i.AbstractHighlighter.ATTR, "true"),
              e.parentNode.insertBefore(n, e),
          ...
          getMactionNodes(e) {
            return Array.from(
              o.evalXPath(`.//*[@data-mml-node="${this.mactionName}"]`, e),
            );
          }
        }
      ...
      1473: function (e, t, n) {
        ...
        t.AbstractTrieNode = i;
        t.StaticTrieNode = class extends i {
          constructor(e, t) {
            super(e, t),
              (this.rule_ = null),
      ...
      2803: function (e, t, n) {
        ...
        class i {
          constructor() {
            this.root = (0, o.getNode)(r.TrieNodeKind.ROOT, "", null);
          }
          ...
          static printWithDepth_(e, t, n) {
            n +=
              new Array(t + 2).join(t.toString()) + ": " + e.toString() + "\n";
            const r = e.getChildren();
            for (let e, o = 0; (e = r[o]); o++)
              n = i.printWithDepth_(e, t + 1, n);
            return n;
          }
          static order_(e) {
            const t = e.getChildren();
            if (!t.length) return 0;
            const n = Math.max.apply(null, t.map(i.order_));
            return Math.max(t.length, n);
          }
          addRule(e) {
            let t = this.root;
            const n = e.context,
              o = e.dynamicCstr.getValues();
            for (let e = 0, i = o.length; e < i; e++)
              t = this.addNode_(t, o[e], r.TrieNodeKind.DYNAMIC, n);
            t = this.addNode_(t, e.precondition.query, r.TrieNodeKind.QUERY, n);
            const i = e.precondition.constraints;
            for (let e = 0, o = i.length; e < o; e++)
              t = this.addNode_(t, i[e], r.TrieNodeKind.BOOLEAN, n);
            t.setRule(e);
          }
          lookupRules(e, t) {
            let n = [this.root];
          ...
          enumerate_(e, t) {
            ...
            for (let e, o = 0; (e = n[o]); o++)
              e.kind === r.TrieNodeKind.DYNAMIC &&
                (t[e.getConstraint()] = this.enumerate_(
                  e,
                  t[e.getConstraint()],
                ));
            return t;
          ...
          addNode_(e, t, n, r) {
            let i = e.getChild(t);
            return i || ((i = (0, o.getNode)(n, t, r)), e.addChild(i)), i;
          }
        }
        t.Trie = i;
      },
      ...
      9146: function (e, t, n) {
        ...
        function h(e) {
          ...
          if (e.match(/^self::\w+:\w+$/)) {
            const t = e.split(":"),
              n = o.resolveNameSpace(t[2]);
            if (!n) return null;
            const r = t[3].toUpperCase();
            return (e) =>
              e.localName &&
              e.localName.toUpperCase() === r &&
              e.namespaceURI === n;
          }
          if (e.match(/^@\w+$/)) {
            const t = e.slice(1);
          ...
          if (e.match(/^contains\(\s*@grammar\s*,\s*"[\w\d ]+"\s*\)$/)) {
            const t = e.split('"')[1];
            return (e) => !!i.Grammar.getInstance().getParameter(t);
          }
          if (
            e.match(
                ...
                (null ===
                  (o =
                    null === (n = e.parentNode) || void 0 === n
                      ? void 0
                      : n.parentNode) || void 0 === o
                  ? void 0
                  : o.tagName) && r.tagName(e.parentNode.parentNode) === t
              );
            };
          }
          ...
          if (e.match(/^.+\[@category!?=".+"\]$/)) {
            ...
            const i = r.match(/^unit:(.+)$/);
            let a = "";
            return (
              i && ((r = i[1]), (a = ":unit")),
              (e) => {
                const i = o.evalXPath(t, e)[0];
                if (i) {
                  const e = s.lookupCategory(i.textContent + a);
                  return "=" === n ? e === r : e !== r;
                }
                return !1;
              }
          ...
          if (e.match(/^string-length\(.+\)\W+\d+/)) {
            const [, t, n, r] = e.match(/^string-length\((.+)\)(\W+)(\d+)/),
              ...
              s = parseInt(r, 10);
            return (e) => {
              const n = o.evalXPath(t, e)[0];
              return !!n && i(Array.from(n.textContent).length, s);
            };
          }
          return null;
        }
        ...
        class f extends c.StaticTrieNode {
          constructor(e, t) {
            super(e, h(e)),
              (this.context = t),
              (this.kind = l.TrieNodeKind.QUERY);
          }
          applyTest(e) {
            return this.test
              ? this.test(e)
        ...
        class m extends c.StaticTrieNode {
          constructor(e, t) {
            super(e, h(e)),
              (this.context = t),
              (this.kind = l.TrieNodeKind.BOOLEAN);
          }
          applyTest(e) {
            return this.test
              ? this.test(e)
      ...
      2371: function (e, t, n) {
        ...
        const r = n(4886),
          ...
          y = n(4524);
        function S() {
          const e = o.Variables.ensureLocale(
        ...
        (t.locales = {
          ...
          (t.setLocale = function () {
            ...
            if (
              ...
              for (const t of Object.getOwnPropertyNames(e)) y.LOCALE[t] = e[t];
              for (const [t, n] of Object.entries(e.CORRECTIONS))
                i.Grammar.getInstance().setCorrection(t, n);
            }
          }),
          (t.getLocale = S),
          (t.completeLocale = function (e) {
            ...
            if (!n)
              return void console.error(
                "Locale " + e.locale + " does not exist!",
              );
            const r = e.kind.toUpperCase(),
              o = e.messages;
            if (!o) return;
            const i = n();
            for (const [e, t] of Object.entries(o)) i[r][e] = t;
          });
      },
      4524: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      3319: function (e, t, n) {
        ...
        (t.nestingToString = function (e) {
          ...
          (t.localFont = function (e) {
            return i(r.LOCALE.MESSAGES.font[e], e);
          }),
          (t.localRole = function (e) {
            return i(r.LOCALE.MESSAGES.role[e], e);
          }),
          (t.localEnclose = function (e) {
            return i(r.LOCALE.MESSAGES.enclose[e], e);
          }),
          (t.extractString = i),
          ...
          return (
            a ||
              (a = (function () {
                ...
                return (
                  (e.NUMBERS = o.default),
                  (e.ALPHABETS.combiner = i.Combiners.prefixCombiner),
      ...
      13: function (e, t, n) {
        ...
        const r = n(3319),
          ...
          a = function (e, t, n) {
            return (
              e.match(/^[a-zA-Z]$/) &&
                (t = t.replace("cerchiato", "cerchiata")),
              (e = n ? e + " " + n : e),
              t ? e + " " + t : e
            );
          };
      ...
      2913: function (e, t, n) {
        ...
        const r = n(4524),
          ...
          i = n(9385),
          s = function (e) {
            return e.match(RegExp("^" + p.ALPHABETS.languagePrefix.english))
              ? e.slice(1)
              : e;
          },
          a = function (e, t, n) {
            ...
            p ||
              (p = (function () {
                ...
                return (
                  ...
                  (e.FUNCTIONS.fracNestDepth = (e) => !1),
                  (e.FUNCTIONS.fontRegexp = (e) => RegExp("^" + e)),
                  (e.FUNCTIONS.si = i.identityTransformer),
                  (e.ALPHABETS.combiner = (e, t, n) => (t ? t + n + e : s(e))),
                  (e.ALPHABETS.digitTrans = {
          ...
          const t = e % 1e3,
            ...
            o = (function (e) {
              ...
              const n = Math.floor(t / 10),
                r = a.tens[n],
                o = a.ones[t % 10];
              return r && o ? r + (2 === n ? "-i-" : "-") + o : r || o;
            })(t % 100);
          return r && o ? r + a.numSep + o : r || o;
        }
        function i(e) {
      ...
      5571: function (e, t, n) {
        ...
        function o(e, t = !1) {
          ...
          if (((o += i ? r(i, !0) + " hundrede" : ""), (n %= 100), n))
            if (
              ((o += o ? " og " : ""),
              (i = t ? a.special.smallOrdinals[n] : a.ones[n]),
              i)
            )
              o += i;
            else {
      ...
      757: function (e, t, n) {
        ...
        function o(e) {
          let t = e % 1e3,
            n = "",
            o = a.ones[Math.floor(t / 100)];
          if (((n += o ? r(o) + "hundert" : ""), (t %= 100), t))
            if (((n += n ? a.numSep : ""), (o = a.ones[t]), o)) n += o;
            else {
              const e = a.tens[Math.floor(t / 10)];
              (o = a.ones[t % 10]), (n += o ? r(o) + "und" + e : e);
            }
          return n;
        }
        function i(e) {
      ...
      6154: function (e, t, n) {
        ...
        function o(e) {
          const t = e % 1e3,
            n = Math.floor(t / 100),
            r = i.special.hundreds[n],
            o = (function (e) {
              const t = e % 100;
              if (t < 30) return i.ones[t];
              const n = i.tens[Math.floor(t / 10)],
                r = i.ones[t % 10];
        ...
        (i.numericOrdinal = function (e) {
          const t = r.Grammar.getInstance().getParameter("gender");
          return e.toString() + ("f" === t ? "a" : "o");
        }),
          (i.numberToWords = function (e) {
            if (0 === e) return i.zero;
            if (e >= Math.pow(10, 36)) return e.toString();
            let t = 0,
              n = "";
            for (; e > 0; ) {
          ...
          (i.numberToOrdinal = function (e, t) {
            if (e > 1999) return e.toString() + "a";
            if (e <= 12) return i.special.onesOrdinals[e - 1];
            const n = [];
            ...
            return (
              ...
              e <= 12
                ? n.push(i.special.onesOrdinals[e - 1])
                : ((r = Math.floor(e / 10)),
                  r > 0 && (n.push(i.special.tensOrdinals[r - 1]), (e %= 10)),
                  e > 0 && n.push(i.special.onesOrdinals[e - 1])),
              n.join(" ")
            );
          }),
          (t.default = i);
      ...
      4394: function (e, t, n) {
            ...
            if (r) {
              ...
              if (e && e.match(/^mille /)) {
                ...
                n = n.match(RegExp(r))
                  ...
                  ? o + (t ? "-mille-" : "") + n.replace(r.replace(/s$/, ""), r)
                  : o + (t ? "-" + e + "-" : "") + n;
              } else
        ...
        (u.wordOrdinal = l),
          (u.numericOrdinal = function (e) {
            const t = o.Grammar.getInstance().getParameter("gender");
            return 1 === e
      ...
      1779: function (e, t, n) {
        ...
        function o(e) {
          ...
          for (; e > 0; ) {
            const r = e % 100;
            r &&
              (n = s.ones[r] + s.numSep + s.large[t] + (n ? s.numSep + n : "")),
              (e = Math.floor(e / 100)),
              t++;
          }
      ...
      5952: function (e, t, n) {
        ...
        function i(e) {
          if (0 === e) return a.zero;
          if (e >= Math.pow(10, 36)) return e.toString();
          if (1 === e && r.Grammar.getInstance().getParameter("fraction"))
            return "un";
          let t = 0,
            n = "";
          for (; e > 0; ) {
            e % 1e3 && (n = o(e % 1e3) + (t ? "-" + a.large[t] + "-" : "") + n),
              (e = Math.floor(e / 1e3)),
              t++;
          }
          return n.replace(/-$/, "");
        ...
        function s(e) {
          const t =
            "m" === r.Grammar.getInstance().getParameter("gender") ? "o" : "a";
          let n = a.special.onesOrdinals[e];
          return n
            ? n.slice(0, -1) + t
            : ((n = i(e)), n.slice(0, -1) + "esim" + t);
        }
        const a = (0, n(4277).NUMBERS)();
        (a.wordOrdinal = s),
          (a.numericOrdinal = function (e) {
      ...
      3669: function (e, t, n) {
        ...
        function r(e) {
          return e
            ...
            .split("")
            .map(function (e) {
              return o.ones[parseInt(e, 10)];
            })
            .join("");
        }
        const o = (0, n(4277).NUMBERS)();
        (o.numberToWords = r), (o.numberToOrdinal = r), (t.default = o);
      },
      984: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 });
        const r = n(4886);
      ...
      1970: function (e, t, n) {
        ...
        class a {
          constructor() {
            (this.context = new s.SpeechRuleContext()),
              ...
              (this.parser = new o.DynamicCstrParser(this.parseOrder)),
              (this.locale = o.DynamicCstr.DEFAULT_VALUES[o.Axis.LOCALE]),
              (this.modality = o.DynamicCstr.DEFAULT_VALUES[o.Axis.MODALITY]),
              (this.domain = ""),
              (this.initialized = !1),
              (this.inherits = null),
              (this.kind = "standard"),
          ...
          defineRule(e, t, n, r, ...o) {
            const s = this.parseAction(n),
              a = this.parsePrecondition(r, o),
              c = this.parseCstr(t);
            if (!(s && a && c))
              return console.error(`Rule Error: ${r}, (${t}): ${n}`), null;
            const l = new i.SpeechRule(e, c, a, s);
          ...
          findRule(e) {
            for (let t, n = 0; (t = this.speechRules_[n]); n++)
              if (e(t)) return t;
            return null;
          }
          findAllRules(e) {
          ...
          defineAction(e, t) {
            ...
            r.conditions.forEach(([t, r]) => {
              const s = this.parseCstr(t.toString().replace(o, ""));
              this.addRule(new i.SpeechRule(e, s, r, n));
            });
          }
          getFullPreconditions(e) {
            const t = this.preconditions.get(e);
            return t || !this.inherits
              ? t
              : this.inherits.getFullPreconditions(e);
          }
          definePrecondition(e, t, n, ...r) {
            const o = this.parsePrecondition(n, r),
              i = this.parseCstr(t);
            o && i
              ? ((o.rank = this.rank++), this.preconditions.set(e, new c(i, o)))
          ...
          inheritRules() {
            ...
            this.inherits.getSpeechRules().forEach((t) => {
              ...
              this.addRule(
                new i.SpeechRule(t.name, n, t.precondition, t.action),
              );
            });
          }
          ignoreRules(e, ...t) {
        ...
        class c {
          ...
          addConstraint(e) {
            ...
            this.constraints.push(e);
            const t = [];
            for (const [n, r] of this.conditions)
              this.base.equal(n) && t.push([e, r]);
        ...
        class i extends o.MathStore {
          ...
          evaluateString(e) {
            const t = [],
              n = Array.from(e);
            for (let e = 0; e < n.length; e++)
              t.push(this.evaluateCharacter(n[e]));
            return t;
          }
          annotations() {
      ...
      8310: function (e, t) {
        ...
        class r {
          ...
          static createProp(...e) {
            const t = o.DEFAULT_ORDER,
              n = {};
            for (let r = 0, o = e.length, i = t.length; r < o && r < i; r++)
              n[t[r]] = e[r];
            return new r(n);
          }
          getProperties() {
          ...
          allProperties() {
            const e = [];
            return (
              this.order.forEach((t) => e.push(this.getProperty(t).slice())), e
            );
          }
          toString() {
            const e = [];
        ...
        class o extends r {
          ...
          static defaultCstr() {
            return o.createCstr.apply(
              null,
              o.DEFAULT_ORDER.map(function (e) {
                return o.DEFAULT_VALUES[e];
              }),
            );
          }
          static validOrder(e) {
            const t = o.DEFAULT_ORDER.slice();
            return e.every((e) => {
              const n = t.indexOf(e);
        ...
        (t.DynamicCstr = o),
          ...
          (o.DEFAULT_VALUES = {
            [n.LOCALE]: "en",
            [n.DOMAIN]: o.DEFAULT_VALUE,
            [n.STYLE]: o.DEFAULT_VALUE,
            [n.TOPIC]: o.DEFAULT_VALUE,
            [n.MODALITY]: "speech",
          });
        t.DynamicCstrParser = class {
          ...
          parse(e) {
            ...
            let r = 0;
            for (let e, o = 0; (e = this.order[o]), t.length; o++, r++) {
              const r = t.shift();
              n[e] = r;
            }
            return new o(n, this.order.slice(0, r));
          }
        };
        t.DefaultComparator = class {
          ...
          compare(e, t) {
            let n = !1;
            for (let r, o = 0; (r = this.order[o]); o++) {
      ...
      1058: function (e, t, n) {
        ...
        class a {
          ...
          static translateUnit_(e) {
            ...
            const t = o.default.getInstance(),
              ...
              r = t.strict,
              i = `${t.locale}.${t.modality}.default`;
            let c, l;
            return (
              (t.strict = !0),
              n &&
                ((c = t.defaultParser.parse(i + ".plural")),
                (l = t.evaluator(e, c))),
              l
                ? ((t.strict = r), l)
                : ((c = t.defaultParser.parse(i + ".default")),
                  (l = t.evaluator(e, c)),
                  (t.strict = r),
                  l
          ...
          static prepareUnit_(e) {
            ...
            return t
              ? e.slice(0, t.index).replace(/\s+/g, " ") + e.slice(t.index)
              : e;
          }
          static cleanUnit_(e) {
          ...
          setParameter(e, t) {
            ...
            return (
              t ? (this.parameters_[e] = t) : delete this.parameters_[e], n
            );
          }
          getParameter(e) {
        ...
        function c(e, t) {
          if (!t || !e) return e;
          const n = s.LOCALE.FUNCTIONS.fontRegexp(i.localFont(t));
          return e.replace(n, "");
        }
        function l(e) {
          return e.match(/\d+/)
            ? s.LOCALE.NUMBERS.numberToWords(parseInt(e, 10))
            : e;
        }
        (t.Grammar = a),
          (t.numbersToAlpha = l),
          ...
          a.getInstance().setCorrection("localEnclose", i.localEnclose),
          ...
          a.getInstance().setPreprocessor("noTranslateText", function (e) {
            return (
              e.match(
                new RegExp("^[" + s.LOCALE.MESSAGES.regexp.TEXT + "]+$"),
          ...
          a.getInstance().setCorrection("ignoreCaps", function (e) {
            let t =
              s.LOCALE.ALPHABETS.capPrefix[o.default.getInstance().domain];
            return (
              void 0 === t && (t = s.LOCALE.ALPHABETS.capPrefix.default),
              c(e, t)
            );
          }),
      ...
      4161: function (e, t, n) {
        ...
        function p(e, t, n, r) {
          const o = E(t);
          N(o, n), o.defineRulesFromMappings(e, c, l, t, r);
        }
        function h(e) {
          if (S(e)) return;
          const t = e.names,
            n = e.mappings,
            r = e.category;
          for (let e, o = 0; (e = t[o]); o++) p(e, e, r, n);
        }
        function f(e) {
          for (const t of Object.keys(u)) {
            ...
            for (const t of Object.keys(e.mappings)) {
              n.mappings[t] = {};
              for (const o of Object.keys(e.mappings[t]))
                n.mappings[t][o] = i.locales[c]().FUNCTIONS.si(
                  r,
                  e.mappings[t][o],
                );
            }
        ...
        function b(e, t) {
          return (
            (t = t || {}),
            e.length ? ((t[e[0]] = b(e.slice(1), t[e[0]])), t) : t
          );
        }
        function y(e) {
          const t = e.names;
        ...
        (t.defineRules = p),
          (t.defineRule = function (e, t, n, r, o, i) {
            const s = E(o);
            N(s, r), s.defineRuleFromStrings(e, c, l, t, n, o, i);
          }),
          (t.addSymbolRules = function (e) {
            if (S(e)) return;
            const t = s.MathSimpleStore.parseUnicode(e.key);
            p(e.key, t, e.category, e.mappings);
          }),
          (t.addFunctionRules = h),
          ...
          (t.lookupString = g),
          (o.default.getInstance().evaluator = g),
          (t.enumerate = function (e = {}) {
            for (const t of Object.values(d))
              for (const [, n] of t.rules.entries())
                for (const { cstr: t } of n) e = b(t.getValues(), e);
            return e;
          });
      },
      4974: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.MathSimpleStore = void 0);
        const r = n(4886),
          o = n(8310);
        class i {
          constructor() {
          ...
          defineRulesFromMappings(e, t, n, r, o) {
            for (const i in o)
              for (const s in o[i]) {
                const a = o[i][s];
                this.defineRuleFromStrings(e, t, n, i, s, r, a);
              }
          }
          getRules(e) {
          ...
          defineRuleFromStrings(e, t, n, o, i, s, a) {
            let c = this.getRules(t);
            const l =
                r.default.getInstance().parsers[o] ||
                r.default.getInstance().defaultParser,
              u = r.default.getInstance().comparators[o],
              d = `${t}.${n}.${o}.${i}`,
              p = l.parse(d),
              h = u ? u() : r.default.getInstance().comparator,
              f = h.getReference();
            h.setReference(p);
            const m = { cstr: p, action: a };
            (c = c.filter((e) => !p.equal(e.cstr))),
              c.push(m),
              this.rules.set(t, c),
              h.setReference(f);
          }
          lookupRule(e, t) {
            let n = this.getRules(t.getValue(o.Axis.LOCALE));
            return (
              (n = n.filter(function (e) {
                return i.testDynamicConstraints_(t, e);
              })),
              1 === n.length
                ? n[0]
                : n.length
      ...
      7478: function (e, t, n) {
        ...
        class c extends s.BaseRuleStore {
          ...
          annotations() {
            for (let e, t = 0; (e = this.annotators[t]); t++)
              (0, i.activate)(this.domain, e);
          }
          defineAlias(e, t, ...n) {
            const r = this.parsePrecondition(t, n);
            if (!r) return void console.error(`Precondition Error: ${t} ${n}`);
            const o = this.preconditions.get(e);
            o
              ? o.addFullCondition(r)
              : console.error(
                  `Alias Error: No precondition by the name of ${e}`,
                );
          }
          defineRulesAlias(e, t, ...n) {
            ...
            if (0 === r.length)
              throw new a.OutputError(
                "Rule with name " + e + " does not exist.",
              );
            const o = [];
            r.forEach((e) => {
              ((e) => {
                ...
                return o.push({ cstr: t, action: n }), !0;
              })(e) && this.addAlias_(e, t, n);
            });
          }
          defineSpecializedRule(e, t, n, r) {
            const o = this.parseCstr(t),
              i = this.findRule((t) => t.name === e && o.equal(t.dynamicCstr)),
              s = this.parseCstr(n);
            if (!i && r)
              throw new a.OutputError(
                "Rule named " + e + " with style " + t + " does not exist.",
              );
            const c = r ? a.Action.fromString(r) : i.action,
              l = new a.SpeechRule(i.name, s, i.precondition, c);
            this.addRule(l);
          }
          ...
          evaluateString(e) {
            ...
            const i = r.removeEmpty(e.replace(/\s/g, " ").split(" "));
            for (let e, r = 0; (e = i[r]); r++)
              if (1 === e.length) t.push(this.evaluateCharacter(e));
              else if (
                e.match(
                  new RegExp("^[" + o.LOCALE.MESSAGES.regexp.TEXT + "]+$"),
                )
              )
          ...
          addAlias_(e, t, n) {
            const r = this.parsePrecondition(t, n),
              o = new a.SpeechRule(e.name, e.dynamicCstr, r, e.action);
            (o.name = e.name), this.addRule(o);
          }
          matchNumber_(e) {
            const t = e.match(
                new RegExp("^" + o.LOCALE.MESSAGES.regexp.NUMBER),
              ),
            ...
            return {
              number: n[0]
                ...
                .replace(
                  /X/g,
                  o.LOCALE.MESSAGES.regexp.DIGIT_GROUP.replace(/\\/g, ""),
                ),
              length: n[0].length,
            };
          }
        ...
        class a {
          ...
          static attributesFromString(e) {
            ...
            for (let e = 0, r = n.length; e < r; e++) {
              const r = n[e],
                i = r.indexOf(":");
              if (-1 === i) t[r.trim()] = "true";
              else {
                const e = r.substring(0, i).trim(),
                  n = r.slice(i + 1).trim();
                t[e] = e === o.ATTRIBUTE ? a.grammarFromString(n) : n;
              }
            }
            return t;
          }
        ...
        function d(e, t) {
          ...
          for (; "" !== e; ) {
            ...
            if (-1 === o) {
              ...
              n.push(r + e), (r = ""), (e = "");
            } else if ((e.substring(0, o).match(/"/g) || []).length % 2 == 0)
              n.push(r + e.substring(0, o)), (r = ""), (e = e.substring(o + 1));
            else {
              const t = e.substring(o).search('"');
              if (-1 === t) throw new u("Invalid string in expression: " + e);
              (r += e.substring(0, o + t + 1)), (e = e.substring(o + t + 1));
            }
          }
          return r && n.push(r), n;
        }
      ...
      6060: function (e, t, n) {
        ...
        class b {
          ...
          static debugSpeechRule(e, t) {
            ...
            o.Debugger.getInstance().output(n.query, r ? r.toString() : r),
              n.constraints.forEach((n) =>
                o.Debugger.getInstance().output(
                  n,
                  e.context.applyConstraint(t, n),
                ),
              );
          }
          ...
          evaluateNode(e) {
            ...
            try {
              ...
              console.error("Something went wrong computing speech."),
                o.Debugger.getInstance().output(e);
            }
            const r = new Date().getTime();
            return o.Debugger.getInstance().output("Time:", r - t), n;
          }
          toString() {
            return this.trie
              .collectRules()
          ...
          processGrammar(e, t, n) {
            ...
            for (const o in n) {
              const i = n[o];
              r[o] = "string" == typeof i ? e.constructString(t, i) : i;
            }
            h.Grammar.getInstance().pushState(r);
          }
          addEvaluator(e) {
          ...
          getEvaluator(e, t) {
            const n =
              this.evaluators_[e] ||
              this.evaluators_[p.DynamicCstr.DEFAULT_VALUES[p.Axis.LOCALE]];
            return n[t] || n[p.DynamicCstr.DEFAULT_VALUES[p.Axis.MODALITY]];
          }
          enumerate(e) {
          ...
          evaluateTree_(e) {
            ...
            let n;
            o.Debugger.getInstance().output(
              t.mode !== a.Mode.HTTP ? e.toString() : e,
            ),
              h.Grammar.getInstance().setAttribute(e);
            const i = this.lookupRule(e, t.dynamicCstr);
            if (!i)
              return t.strict
                ? []
            ...
            for (let t, o = 0; (t = u[o]); o++) {
              ...
              if (a.engine) {
                ...
                const e = h.Grammar.parseInput(a.engine);
                s.default.getInstance().setDynamicCstr(e);
              }
              switch (t.type) {
                case m.ActionType.NODE:
                  {
                    const t = l.applyQuery(e, i);
                    t && (o = this.evaluateTree_(t));
                  }
                  break;
                case m.ActionType.MULTI:
                  {
                    u = !0;
                    const t = l.applySelector(e, i);
                    t.length > 0 &&
                ...
                case m.ActionType.TEXT:
                  {
                    ...
                    const s = l.constructString(e, i);
                    (s || "" === s) &&
                      (o = Array.isArray(s)
                        ? s.map(function (e) {
                            return r.AuditoryDescription.create(
                              { text: e.speech, attributes: e.attributes },
                              { adjust: !0 },
                            );
                          })
                        : [
                ...
                default:
                  o = [r.AuditoryDescription.create({ text: i })];
              }
              o[0] &&
                !u &&
                (a.context &&
                  (o[0].context =
                    l.constructString(e, a.context) + (o[0].context || "")),
                a.annotation && (o[0].annotation = a.annotation)),
                this.addLayout(o, a, u),
                t.grammar && h.Grammar.getInstance().popState(),
                (n = n.concat(this.addPersonality_(o, a, u, e))),
                d && s.default.getInstance().setDynamicCstr(d);
            }
            return n;
          }
          evaluateNodeList_(e, t, n, o, i, s) {
            if (!t.length) return [];
            const a = o || "",
              c = s || "",
              l = e.contextFunctions.lookup(i),
              u = l
                ? l(t, c)
                : function () {
                    return c;
          ...
          addLayout(e, t, n) {
            ...
            o &&
              (o.match(/^begin/)
                ? e.unshift(new r.AuditoryDescription({ text: "", layout: o }))
                : o.match(/^end/)
                ? e.push(new r.AuditoryDescription({ text: "", layout: o }))
                : (e.unshift(
                  ...
                  e.push(
                    new r.AuditoryDescription({ text: "", layout: `end${o}` }),
                  )));
          }
          addPersonality_(e, t, n, o) {
            const i = {};
            let s = null;
            for (const e of a.personalityPropList) {
              ...
              const r = parseFloat(n),
                o = isNaN(r) ? ('"' === n.charAt(0) ? n.slice(1, -1) : n) : r;
              e === a.personalityProps.PAUSE ? (s = o) : (i[e] = o);
            }
            for (let t, n = 0; (t = e[n]); n++)
              this.addRelativePersonality_(t, i),
                this.addExternalAttributes_(t, o);
            if (
              (n &&
                e.length &&
          ...
          updateConstraint_() {
            const e = s.default.getInstance().dynamicCstr,
              ...
              n = this.trie,
              r = {};
            let o = e.getValue(p.Axis.LOCALE),
              i = e.getValue(p.Axis.MODALITY),
              a = e.getValue(p.Axis.DOMAIN);
            n.hasSubtrie([o, i, a]) ||
              ((a = p.DynamicCstr.DEFAULT_VALUES[p.Axis.DOMAIN]),
              n.hasSubtrie([o, i, a]) ||
                ((i = p.DynamicCstr.DEFAULT_VALUES[p.Axis.MODALITY]),
                n.hasSubtrie([o, i, a]) ||
                  (o = p.DynamicCstr.DEFAULT_VALUES[p.Axis.LOCALE]))),
              (r[p.Axis.LOCALE] = [o]),
              (r[p.Axis.MODALITY] = [
                "summary" !== i
                  ? i
                  : p.DynamicCstr.DEFAULT_VALUES[p.Axis.MODALITY],
              ]),
              (r[p.Axis.DOMAIN] = [
                "speech" !== i
                  ? p.DynamicCstr.DEFAULT_VALUES[p.Axis.DOMAIN]
                  : a,
              ]);
            const c = e.getOrder();
            for (let n, o = 0; (n = c[o]); o++)
              if (!r[n]) {
                const o = e.getValue(n),
                  i = this.makeSet_(o, e.preference),
                  s = p.DynamicCstr.DEFAULT_VALUES[n];
                t || o === s || i.push(s), (r[n] = i);
              }
          ...
          lookupRule(e, t) {
            if (
              ...
              (e.nodeType !== i.NodeType.ELEMENT_NODE &&
                e.nodeType !== i.NodeType.TEXT_NODE)
            )
              return null;
        ...
        function S(e) {
          ...
          const n =
            "braille" === e.modality ? new d.BrailleStore() : new f.MathStore();
          return (
            y.set(t, n),
            e.inherits &&
              (n.inherits = y.get(`${e.inherits}.${e.modality}.${e.domain}`)),
            n.parse(e),
            n.initialize(),
            n
          );
        ...
        (t.storeFactory = S),
          (s.default.nodeEvaluator = b
            .getInstance()
            .evaluateNode.bind(b.getInstance()));
      },
      3686: function (e, t) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.CustomGenerators =
      ...
      931: function (e, t, n) {
        ...
        (t.nodeCounter = function (e, t) {
          ...
          (t.contentIterator = function (e, t) {
            let n;
            return (
              (n = e.length > 0 ? o.evalXPath("../../content/*", e[0]) : []),
              function () {
                const e = n.shift(),
                  o = t
                    ? [
                    ...
                    : [];
                if (!e) return o;
                const s = i.default.evaluateNode(e);
                return o.concat(s);
              }
            );
          });
      ...
      4036: function (e, t, n) {
        ...
        (t.annotators = new Map()),
          ...
          (t.activate = function (e, n) {
            const r = e + ":" + n,
              o = t.annotators.get(r) || t.visitors.get(r);
            o && (o.active = !0);
          }),
      ...
      4020: function (e, t) {
        ...
        const fe = String.fromCodePoint(8289),
          ...
          ye = [
            ...
            { set: p, type: "fence", role: "neutral" },
            { set: h, type: "fence", role: "metric" },
            { set: m, type: "identifier", role: "latinletter", font: "normal" },
            { set: f, type: "identifier", role: "latinletter", font: "normal" },
            { set: b, type: "identifier", role: "latinletter", font: "normal" },
            { set: g, type: "identifier", role: "latinletter", font: "normal" },
            { set: S, type: "identifier", role: "latinletter", font: "bold" },
            { set: y, type: "identifier", role: "latinletter", font: "bold" },
            { set: N, type: "identifier", role: "latinletter", font: "italic" },
            ...
            { set: v, type: "identifier", role: "latinletter", font: "script" },
            {
              set: O,
              type: "identifier",
              role: "latinletter",
            ...
            { set: J, type: "identifier", role: "greekletter", font: "normal" },
            { set: K, type: "identifier", role: "greekletter", font: "bold" },
            { set: W, type: "identifier", role: "greekletter", font: "bold" },
            { set: Y, type: "identifier", role: "greekletter", font: "italic" },
            { set: q, type: "identifier", role: "greekletter", font: "italic" },
            {
              set: Q,
              type: "identifier",
              role: "greekletter",
            ...
            { set: ie, type: "identifier", role: "greekletter", font: "bold" },
            {
              set: se,
              type: "identifier",
              role: "greekletter",
            ...
            { set: pe, type: "operator", role: "multiplication" },
            {
              set: [
                "\xaf",
                "-",
            ...
            { set: be, type: "function", role: "prefix function" },
            { set: ["mod", "rem"], type: "operator", role: "prefix function" },
          ],
          Se = (function () {
            const e = {};
            for (let t, n = 0; (t = ye[n]); n++)
        ...
        (t.equal = function (e, t) {
          ...
          (t.lookupType = function (e) {
            var t;
            return (
              (null === (t = Se[e]) || void 0 === t ? void 0 : t.type) ||
              "unknown"
            );
          }),
          (t.lookupRole = function (e) {
            var t;
            return (
              (null === (t = Se[e]) || void 0 === t ? void 0 : t.role) ||
              "unknown"
            );
          }),
          (t.lookupMeaning = function (e) {
            return (
              Se[e] || { role: "unknown", type: "unknown", font: "unknown" }
            );
          }),
          ...
          (t.isMatchingFence = function (e, t) {
            return -1 !== p.indexOf(e) || -1 !== h.indexOf(e)
              ? e === t
              : s[e] === t || a[e] === t;
          }),
        ...
        function Ae(e, t, n = "") {
          for (const r of t) Ee.set(Ne(e, r), n || e);
        }
        Ae("d", [
          "d",
          "\u2146",
      ...
      7405: function (e, t, n) {
        ...
        class i {
          ...
          add(e, t) {
            this.map[i.key(e, t.font)] = t;
          }
          addNode(e) {
            this.add(e.textContent, e.meaning());
          }
          retrieve(e, t) {
            return this.map[i.key(e, t)];
          }
          retrieveNode(e) {
        ...
        class s {
          ...
          minimize() {
            for (const e in this.map)
              1 === this.map[e].length && delete this.map[e];
          }
          minimalCollator() {
            const e = this.copy();
          ...
          toString() {
            ...
            for (const t in this.map) {
              const n = Array(t.length + 3).join(" "),
                r = this.map[t],
                o = [];
              for (let e, t = 0; (e = r[t]); t++) o.push(e.toString());
              e.push(t + ": " + o.join("\n" + n));
            }
            return e.join("\n");
          }
        ...
        class c extends s {
          ...
          reduce() {
            for (const e in this.map)
              1 !== this.map[e].length &&
                (this.map[e] = (0, o.reduce)(this.map[e]));
          }
          default() {
            const e = new i();
            for (const t in this.map)
      ...
      2721: function (e, t) {
        ...
        (t.flags = {
          ...
          (t.run = function (e, n, o) {
            const i = r(e);
            return i && !t.blacklist[e] && (t.flags[e] || i.applicable(n))
              ? i.apply(n)
              : o
              ? o(n)
              : n;
      ...
      7103: function (e, t, n) {
        ...
        function d(e, t, n) {
          ...
          if (i && s) {
            if ("infixop" === t[0].type && "implicit" === t[0].role)
              return (r = e.pop()), o.push(a.postfixNode_(o.pop(), e)), r;
            r = e.shift();
            const n = a.prefixNode_(t.shift(), e);
            return t.unshift(n), r;
          }
          return i
            ? (o.push(a.postfixNode_(o.pop(), e)), r)
        ...
        function p(e, t, n) {
          ...
          if (c.isOperator(o) || c.isOperator(l))
            return (
              r.Debugger.getInstance().output("Juxta Heuristic Case 4"),
              p(e.concat([o, i, l]).concat(a), t, n)
            );
          let u = null;
          return (
            c.isImplicitOp(o) && c.isImplicitOp(l)
              ? (r.Debugger.getInstance().output("Juxta Heuristic Case 5"),
                o.contentNodes.push(i),
                (o.contentNodes = o.contentNodes.concat(l.contentNodes)),
                o.childNodes.push(l),
                (o.childNodes = o.childNodes.concat(l.childNodes)),
                l.childNodes.forEach((e) => (e.parent = o)),
                (i.parent = o),
                o.addMathmlNodes(i.mathml),
                o.addMathmlNodes(l.mathml),
                (u = o))
              : c.isImplicitOp(o)
              ...
              ? (r.Debugger.getInstance().output("Juxta Heuristic Case 7"),
                l.contentNodes.unshift(i),
                l.childNodes.unshift(o),
                (o.parent = l),
                (i.parent = l),
        ...
        s.add(
          ...
          s.add(
            new a.SemanticTreeHeuristic(
              ...
              (e) => "clearspeak" === o.default.getInstance().domain,
            ),
          ),
          s.add(
            new a.SemanticTreeHeuristic(
              ...
              (e) => (
                "unit" !== e.role &&
                  -1 !==
                    ["f", "g", "h", "F", "G", "H"].indexOf(e.textContent) &&
          ...
          s.add(
            new a.SemanticMultiHeuristic("convert_juxtaposition", (e) => {
              let t = u.partitionNodes(e, function (e) {
                return (
                  e.textContent === i.invisibleTimes() && "operator" === e.type
                );
              });
              (t = t.rel.length
                ? (function (e) {
                    ...
                    for (; e.comp.length; )
                      if (((i = []), r.length))
                        ...
                        for (o && i.push(o); !r.length && e.comp.length; )
                          (r = e.comp.shift()), i.push(e.rel.shift());
                        o = d(i, r, n);
                      }
                    i.length || r.length
                      ? (t.push(o), n.push(r))
                ...
                : t),
                (e = t.comp[0]);
              for (let n, r, o = 1; (n = t.comp[o]), (r = t.rel[o - 1]); o++)
                e.push(r), (e = e.concat(n));
              return (
                (t = u.partitionNodes(e, function (e) {
                  return (
                    e.textContent === i.invisibleTimes() &&
                    ("operator" === e.type || "infixop" === e.type)
                  );
                })),
                t.rel.length ? p(t.comp.shift(), t.rel, t.comp) : e
              );
            }),
          ),
          s.add(
            new a.SemanticTreeHeuristic(
              ...
              (e) =>
                "braille" === o.default.getInstance().modality &&
                "identifier" === e.type,
            ),
          ),
          s.add(
      ...
      8122: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.SemanticMathml = void 0);
        const r = n(6671),
          o = n(6098),
          i = n(6161),
          s = n(7793),
          a = n(8901);
        class c extends o.SemanticAbstractParser {
          constructor() {
            super("MathML"),
              (this.parseMap_ = {
          ...
          parse(e) {
            ...
            const t = r.toArray(e.childNodes),
              n = r.tagName(e),
              o = this.parseMap_[n],
              i = (o || this.dummy_.bind(this))(e, t);
            return (
              a.addAttributes(i, e),
              -1 !==
                ["MATH", "MROW", "MPADDED", "MSTYLE", "SEMANTICS"].indexOf(n) ||
                (i.mathml.unshift(e), (i.mathmlTree = e)),
              i
            );
          }
          semantics_(e, t) {
          ...
          limits_(e, t) {
            return s.default
              .getInstance()
              .limitNode(r.tagName(e), this.parseList(t));
          }
          root_(e, t) {
            return t[1]
          ...
          tableCell_(e, t) {
            ...
            let r;
            r = n.length
              ? 1 === n.length && i.isType(n[0], "empty")
                ? n
                : [s.default.getInstance().row(n)]
              : [];
            const o = this.getFactory().makeBranchNode("cell", r, []);
            return (o.role = "table"), o;
          }
          space_(e, t) {
            const n = e.getAttribute("width"),
              o = n && n.match(/[a-z]*$/);
            if (!o) return this.empty_(e, t);
            const i = o[0],
              a = parseFloat(n.slice(0, o.index)),
              c = { cm: 0.4, pc: 0.5, em: 0.5, ex: 1, in: 0.15, pt: 5, mm: 5 }[
                i
              ];
          ...
          fenced_(e, t) {
            const n = this.parseList(a.purgeNodes(t)),
              ...
              o = c.getAttribute_(e, "open", "("),
              i = c.getAttribute_(e, "close", ")"),
              l = s.default.getInstance().mfenced(o, i, r, n);
        ...
        class s {
          ...
          xml(e, t) {
            const n = function (n, r) {
                const o = r.map(function (n) {
                    return n.xml(e, t);
                  }),
                  i = e.createElementNS("", n);
                for (let e, t = 0; (e = o[t]); t++) i.appendChild(e);
                return i;
              },
          ...
          replaceChild(e, t) {
            ...
            const r = e.mathml.filter(function (e) {
              ...
              o = t.mathml.filter(function (t) {
                return -1 === e.mathml.indexOf(t);
              });
            this.removeMathmlNodes(r), this.addMathmlNodes(o);
          }
          appendContentNode(e) {
            e &&
          ...
          equals(e) {
            ...
            for (
              let t, n, r = 0;
              (t = this.childNodes[r]), (n = e.childNodes[r]);
              r++
            )
          ...
          displayTree_(e) {
            ...
            (n += "\n" + t + this.toString()),
              ...
              (n += "\n" + t + "MathML:");
            for (let e, r = 0; (e = this.mathml[r]); r++)
              n += "\n" + t + e.toString();
            return (
              (n += "\n" + t + "Begin Content"),
          ...
          makeBranchNode(e, t, n, r) {
            ...
            return (
              ...
              t.concat(n).forEach(function (e) {
                (e.parent = o), o.addMathmlNodes(e.mathml);
              }),
              o
            );
          }
      ...
      178: function (e, t) {
        ...
        (t.add = r),
          ...
          (t.reduce = function (e) {
            ...
            do {
              (r = t.pop()), n.push(r);
            } while (r && t.length && 0 === o(t[t.length - 1], r));
            return n;
          });
        class s {
      ...
      6161: function (e, t, n) {
        ...
        function l(e) {
          return i(e, "operator") || s(e, "operator");
        }
        function u(e) {
          return i(e, "relation") || s(e, "relation");
        }
        function d(e) {
          return i(e, "punctuation") || s(e, "punctuation");
        }
        function p(e) {
          return i(e, "fence") || s(e, "fence");
        }
        function h(e) {
          return (
            !e.embellished ||
            (!(function (e) {
              return (
                i(e, "tensor") &&
                (!i(e.childNodes[1], "empty") ||
                  !i(e.childNodes[2], "empty")) &&
                (!i(e.childNodes[3], "empty") || !i(e.childNodes[4], "empty"))
              );
            })(e) &&
              (!a(e, "close") || !i(e, "tensor")) &&
              (!a(e, "open") || (!i(e, "subscript") && !i(e, "superscript"))) &&
              h(e.childNodes[0]))
          );
        }
        function f(e) {
          return !!e && (i(e, "table") || i(e, "multiline"));
        }
        function m(e) {
          return (
            !!e &&
        ...
        function y(e) {
          return (
            "number" === e.type && ("integer" === e.role || "float" === e.role)
          );
        }
        function S(e) {
        ...
        (t.isType = i),
          ...
          (t.isAccent = function (e) {
            ...
            return (
              i(e, "fence") ||
              i(e, "punctuation") ||
              (i(e, "operator") && !e.textContent.match(t)) ||
              i(e, "relation") ||
              (i(e, "identifier") &&
                a(e, "unknown") &&
          ...
          (t.isSimpleFunctionScope = function (e) {
            ...
            if ("infixop" === n.type) {
              ...
              if (n.childNodes.some((e) => i(e, "infixop"))) return !1;
            }
            return !0;
          }),
          (t.isPrefixFunctionBoundary = function (e) {
            return (l(e) && !a(e, "division")) || i(e, "appl") || c(e);
          }),
          ...
          (t.isIntegralDxBoundary = function (e, t) {
            return (
              !!t && i(t, "identifier") && r.lookupSecondary("d", e.textContent)
            );
          }),
          ...
          (t.isElligibleEmbellishedFence = function (e) {
            return !(!e || !p(e)) && (!e.embellished || h(e));
          }),
          ...
          (t.isLimitBase = function e(t) {
            return (
              ...
              i(t, "limlower") ||
              i(t, "limupper") ||
              (i(t, "function") && a(t, "limit function")) ||
              ((i(t, "overscore") || i(t, "underscore")) && e(t.childNodes[0]))
            );
          }),
          ...
          (t.singlePunctAtPosition = function (e, t, n) {
            return (
              1 === t.length &&
              ("punctuation" === e[n].type ||
                "punctuation" === e[n].embellished) &&
              e[n] === t[0]
            );
          }),
          (t.isSimpleFunction = function (e) {
            return i(e, "identifier") && a(e, "simple function");
          }),
          (t.isLeftBrace = g),
          (t.isRightBrace = b),
          (t.isSetNode = function (e) {
            return g(e.contentNodes[0]) && b(e.contentNodes[1]);
          }),
          (t.illegalSingleton_ = [
            "punctuation",
            "punctuated",
          ...
          (t.isUnitCounter = function (e) {
            return y(e) || "vulgar" === e.role || "mixed" === e.role;
          }),
      ...
      7793: function (e, t, n) {
        ...
        class l {
          ...
          static number(e) {
            ("unknown" !== e.type && "identifier" !== e.type) ||
              (e.type = "number"),
              l.numberRole_(e),
              l.exprFont_(e);
          }
          static classifyMultiline(e) {
            ...
            let r;
            for (; t < n && (!(r = e.childNodes[t]) || !r.childNodes.length); )
              t++;
            if (t >= n) return;
            const o = r.childNodes[0].role;
            "unknown" !== o &&
          ...
          static classifyFunction_(e, t) {
            if (
              ...
              return "";
            if (t[0] && t[0].textContent === o.functionApplication()) {
              l.getInstance().funcAppls[e.id] = t.shift();
              let n = "simple function";
              return (
                i.run("simple2prefix", e),
          ...
          static purgeFences_(e) {
            ...
            return o.push(n.shift()), { rel: r, comp: o };
          }
                ...
                (2 === t.length &&
                  (l.testColumns_(
                    ...
                    l.testColumns_(
                      ...
                      0,
                      (e) =>
                        l.isEndRelation_(e, n, !0) || l.isPureRelation_(e, n),
                    )))
              ) && ((e.role = n), !0)
            );
          }
          ...
          setNodeFactory(e) {
            (l.getInstance().factory_ = e),
              i.updateFactory(l.getInstance().factory_);
          }
          getNodeFactory() {
          ...
          identifierNode(e, t, n) {
            if ("MathML-Unit" === n) (e.type = "identifier"), (e.role = "unit");
              ...
              return (e.font = "italic"), i.run("simpleNamedFunction", e);
            return (
              "unknown" === e.type && (e.type = "identifier"),
              l.exprFont_(e),
              i.run("simpleNamedFunction", e)
            );
          }
          implicitNode(e) {
            if (
            ...
            return i.run("combine_juxtaposition", t);
          }
          text(e, t) {
            return (
              l.exprFont_(e),
          ...
          limitNode(e, t) {
            ...
            if (a.isLimitBase(r)) {
              ...
              if (
                ...
                (1 === i && a.isAccent(t[1])) ||
                  (2 === i && a.isAccent(t[1]) && a.isAccent(t[2])))
              )
                return (
                  ...
                  return (
                    (r = l
                      ...
                      .accentNode_(
                        r,
                        [r, t[1]],
                        { MSUBSUP: "subscript", MUNDEROVER: "underscore" }[e],
                        1,
                        !0,
                      )),
                    t[2]
                  ...
                  return (
                    (r = l
                      ...
                      .accentNode_(
                        r,
                        [r, t[2]],
                        { MSUBSUP: "superscript", MUNDEROVER: "overscore" }[e],
                        1,
                        !0,
                      )),
                    l
              ...
              return l.getInstance().makeLimitNode_(r, t, null, o);
            }
            return (
              (n = l.MML_TO_BOUNDS_[e]),
              l.getInstance().accentNode_(r, t, n.type, n.length, n.accent)
          ...
          tablesInRow(e) {
            ...
            for (let e, r = 0; (e = t.rel[r]); r++)
              (n = n.concat(t.comp.shift())),
                n.push(l.tableToMatrixOrVector_(e));
            (n = n.concat(t.comp.shift())),
          ...
          mfenced(e, t, n, r) {
            if (n && r.length > 0) {
              const e = l.nextSeparatorFunction_(n),
                t = [r.shift()];
              r.forEach((n) => {
                t.push(l.getInstance().factory_.makeContentNode(e())),
                  t.push(n);
              }),
                (r = t);
            }
          ...
          fractionLikeNode(e, t, n, r) {
            ...
            if (!r && c.isZeroLength(n)) {
              ...
              return (
                ...
                l.binomialForm_(o),
                l.classifyMultiline(o),
                o
              );
            }
            return (
              (o = l.getInstance().fractionNode_(e, t)),
              r && o.addAnnotation("general", "bevelled"),
              o
            );
          }
          tensor(e, t, n, r, o) {
            const i = l
              ...
              .factory_.makeBranchNode(
                ...
                [
                  ...
                  l.getInstance().scriptNode_(o, "rightsuper"),
                ],
                [],
              );
            return (i.role = e.role), (i.embellished = a.isEmbellished(e)), i;
          }
          pseudoTensor(e, t, n) {
            ...
            const s = o ? (i ? "MSUBSUP" : "MSUB") : "MSUP",
              c = [e];
            return (
              o && c.push(l.getInstance().scriptNode_(t, "rightsub", !0)),
              i && c.push(l.getInstance().scriptNode_(n, "rightsuper", !0)),
            ...
            if ((t.inference || t.axiom || console.log("Noise"), t.axiom)) {
              const t = l.getInstance().cleanInference(e.childNodes),
                r = t.length
                  ? l
                      .getInstance()
                      .factory_.makeBranchNode("inference", n(t), [])
                  : l.getInstance().factory_.makeEmptyNode();
              return (r.role = "axiom"), (r.mathmlTree = e), r;
            }
            const r = l.getInstance().inference(e, t, n);
            return (
              t.proof && ((r.role = "proof"), (r.childNodes[0].role = "final")),
              r
            );
          }
          inference(e, t, n) {
            ...
            const o = t.labelledRule,
              i = r.toArray(e.childNodes),
              s = [];
            ("left" !== o && "both" !== o) ||
              s.push(l.getInstance().getLabel(e, i, n, "left")),
              ("right" !== o && "both" !== o) ||
                s.push(l.getInstance().getLabel(e, i, n, "right"));
            const a = l.getInstance().getFormulas(e, i, n),
              c = l
                .getInstance()
                .factory_.makeBranchNode(
                  "inference",
          ...
          getLabel(e, t, n, o) {
            const i = l.getInstance().findNestedRow(t, "prooflabel", o),
              s = l
                .getInstance()
                .factory_.makeBranchNode(
                  "rulelabel",
                  n(r.toArray(i.childNodes)),
                  [],
                );
          ...
          getFormulas(e, t, n) {
            const o = t.length
                ? l.getInstance().findNestedRow(t, "inferenceRule")
                : e,
              i = "up" === l.getSemantics(o).inferenceRule,
              ...
              d = [];
            let p = 1;
            for (const e of u) p % 2 && d.push(e.childNodes[0]), p++;
            const h = n(d),
              f = n(r.toArray(a.childNodes[0].childNodes))[0],
              m = l.getInstance().factory_.makeBranchNode("premises", h, []);
            m.mathmlTree = c;
            const g = l
              .getInstance()
              .factory_.makeBranchNode("conclusion", [f], []);
            return (
          ...
          operatorNode(e) {
            return (
              "unknown" === e.type && (e.type = "operator"),
              i.run("multioperator", e)
            );
          }
          implicitNode_(e) {
            const t = l
          ...
          infixNode_(e, t) {
            ...
            return (n.role = t.role), i.run("propagateSimpleFunction", n);
          }
          explicitMixed_(e) {
            const t = c.partitionNodes(e, function (e) {
              return e.textContent === o.invisiblePlus();
            });
            ...
            for (let e, r = 0; (e = t.rel[r]); r++) {
              ...
              if (
                ...
                const e = l
                  .getInstance()
                  .factory_.makeBranchNode("number", [o[s], i[0]], []);
                (e.role = "mixed"),
                  (n = n.concat(o.slice(0, s))),
                  n.push(e),
                  i.shift();
              } else (n = n.concat(o)), n.push(e);
            }
          ...
          concatNode_(e, t, n) {
            ...
            const r = t
                ...
                .join(" "),
              o = l.getInstance().factory_.makeBranchNode(n, [e], t, r);
            return t.length > 1 && (o.role = "multiop"), o;
          }
          prefixNode_(e, t) {
          ...
          postfixNode_(e, t) {
            return t.length
              ? l.getInstance().concatNode_(e, t, "postfixop")
              : e;
          }
          combineUnits_(e) {
            const t = c.partitionNodes(e, function (e) {
            ...
            do {
              ...
              (o = n.pop()),
                o &&
                  (e.length && a.isUnitCounter(o) ? e.unshift(o) : n.push(o)),
                1 === e.length && (i = e.pop()),
                e.length > 1 &&
                  ((i = l.getInstance().implicitNode_(e)), (i.role = "unit")),
                i && n.push(i),
                r && n.push(r);
            } while (r);
            return n;
          ...
          getMixedNumbers_(e) {
            ...
            for (let e, r = 0; (e = t.rel[r]); r++) {
              ...
              if (
                o[i] &&
                a.isType(o[i], "number") &&
                (a.isRole(o[i], "integer") || a.isRole(o[i], "float"))
              ) {
                const t = l
                  .getInstance()
                  .factory_.makeBranchNode("number", [o[i], e], []);
                (t.role = "mixed"), (n = n.concat(o.slice(0, i))), n.push(t);
              } else (n = n.concat(o)), n.push(e);
            }
            return n.concat(t.comp[t.comp.length - 1]);
          }
          ...
          relationsInRow_(e) {
            ...
            return t.rel.some(function (e) {
              ...
              ? ((o = l
                  .getInstance()
                  .factory_.makeBranchNode("multirel", r, t.rel)),
          ...
          operationsInRow_(e) {
            ...
            if (1 === (e = l.getInstance().explicitMixed_(e)).length)
              return e[0];
            const t = [];
            ...
            e = i.run("convert_juxtaposition", e);
            const n = c.sliceNodes(e, a.isOperator),
              r = l
                .getInstance()
                .prefixNode_(l.getInstance().implicitNode(n.head), t);
            return n.div
              ? l.getInstance().operationsTree_(n.tail, r, n.div)
              : r;
          }
          operationsTree_(e, t, n, r) {
            const o = r || [];
            if (0 === e.length) {
              if ((o.unshift(n), "infixop" === t.type)) {
                const e = l.getInstance().postfixNode_(t.childNodes.pop(), o);
                return t.appendChild(e), t;
              }
              return l.getInstance().postfixNode_(t, o);
            }
            const i = c.sliceNodes(e, a.isOperator);
            if (0 === i.head.length)
              return (
                o.push(i.div), l.getInstance().operationsTree_(i.tail, t, n, o)
              );
            const s = l
                .getInstance()
                .prefixNode_(l.getInstance().implicitNode(i.head), o),
              u = l.getInstance().appendOperand_(t, n, s);
            return i.div
              ? l.getInstance().operationsTree_(i.tail, u, i.div, [])
              : u;
          }
          ...
          appendLastOperand_(e, t, n) {
            let r = e,
              o = e.childNodes[e.childNodes.length - 1];
            for (; o && "infixop" === o.type && !a.isImplicit(o); )
              (r = o), (o = r.childNodes[e.childNodes.length - 1]);
            const i = l.getInstance().infixNode_([r.childNodes.pop(), n], t);
            return r.appendChild(i), e;
          }
          ...
          fences_(e, t, n, r) {
            ...
            if (0 === e.length) {
              ...
              for (; n.length > 0; ) {
                if (o(n[0])) {
                  ...
                  const t = c.sliceNodes(n, o),
                    i = t.head.length - 1,
                    s = l.getInstance().neutralFences_(t.head, r.slice(0, i));
                  (r = r.slice(i)),
                    e.push(...s),
            ...
            if (
              "open" === s ||
              (a.isNeutralFence(e[0]) &&
                (!i || !a.compareNeutralFences(e[0], i)))
            ) {
              n.push(e.shift());
              const o = t.shift();
              return o && r.push(o), l.getInstance().fences_(e, t, n, r);
            }
            if (i && "close" === s && "open" === i.role) {
              ...
              return (
                r.push(r.pop().concat([o], t.shift())),
                l.getInstance().fences_(e, t, n, r)
              );
            }
            if (i && a.compareNeutralFences(e[0], i)) {
              if (
                !a.elligibleLeftNeutral(i) ||
                !a.elligibleRightNeutral(e[0])
              ) {
                n.push(e.shift());
                const o = t.shift();
                return o && r.push(o), l.getInstance().fences_(e, t, n, r);
            ...
            if (i && "close" === s && a.isNeutralFence(i) && n.some(o)) {
              const i = c.sliceNodes(n, o, !0),
                s = r.pop(),
                a = r.length - i.tail.length + 1,
                u = l.getInstance().neutralFences_(i.tail, r.slice(a));
              r = r.slice(0, a);
              const d = l
                .getInstance()
                .horizontalFencedNode_(i.div, e.shift(), r.pop().concat(u, s));
              return (
                r.push(r.pop().concat([d], t.shift())),
                l.getInstance().fences_(e, t, i.head, r)
              );
            }
            const u = e.shift();
            return (
          ...
          neutralFences_(e, t) {
            ...
            if (!a.elligibleLeftNeutral(n)) {
              ...
              const r = t.shift();
              return (
                r.unshift(n), r.concat(l.getInstance().neutralFences_(e, t))
              );
            }
            ...
            const o = l
              .getInstance()
              .combineFencedContent_(n, r.div, r.head, t);
            if (r.tail.length > 0) {
              const e = o.shift(),
                t = l.getInstance().neutralFences_(r.tail, o);
              return e.concat(t);
            }
            return o[0];
          }
          combineFencedContent_(e, t, n, r) {
            ...
            o.push(...c), o.push(...a);
            const u = l.getInstance().horizontalFencedNode_(e, t, o);
          ...
          horizontalFencedNode_(e, t, n) {
            ...
            let o = l
              .getInstance()
              .factory_.makeBranchNode("fenced", [r], [e, t]);
            return (
              "open" === e.role
                ? (l.getInstance().classifyHorizontalFence_(o),
                  (o = i.run("propagateComposedFunction", o)))
                : (o.role = e.role),
              (o = i.run("detect_cycle", o)),
              l.rewriteFencedNode_(o)
            );
          }
          ...
          getPunctuationInRow_(e) {
            ...
            const r = [];
            let o = n.comp.shift();
            o.length > 0 && r.push(l.getInstance().row(o));
            let i = 0;
            for (; n.comp.length > 0; )
              r.push(n.rel[i++]),
                (o = n.comp.shift()),
          ...
          punctuatedNode_(e, t) {
            const n = l
              .getInstance()
              .factory_.makeBranchNode("punctuated", e, t);
          ...
          accentRole_(e, t) {
            ...
            const n = e.textContent,
              r =
                o.lookupSecondary("bar", n) ||
                o.lookupSecondary("tilde", n) ||
                e.role;
            return (
          ...
          accentNode_(e, t, n, r, o) {
            const i = (t = t.slice(0, r + 1))[1],
              s = t[2];
            let a;
            if (
              (!o &&
                ...
                ((a = l
                  .getInstance()
                  .factory_.makeBranchNode("subscript", [e, i], [])),
                (a.role = "subsup"),
                (t = [a, s]),
                (n = "superscript")),
              o)
            ) {
              const r = l.getInstance().accentRole_(i, n);
              if (s) {
                l.getInstance().accentRole_(s, "overscore") && !r
                  ...
                  : ((a = l
                      .getInstance()
                      .factory_.makeBranchNode("underscore", [e, i], [])),
                    (t = [a, s]),
                    (n = "overscore")),
                  (a.role = "underover");
              }
          ...
          makeLimitNode_(e, t, n, r) {
            ...
            const o = l.getInstance().factory_.makeBranchNode(r, t, []),
              i = a.isEmbellished(e);
            return (
              n && (n.embellished = i),
              (o.embellished = i),
          ...
          getFunctionsInRow_(e, t) {
            ...
            const r = e.shift(),
              o = l.classifyFunction_(r, e);
            if (!o) return n.push(r), l.getInstance().getFunctionsInRow_(e, n);
            const i = l.getInstance().getFunctionsInRow_(e, []),
              s = l.getInstance().getFunctionArgs_(r, i, o);
            return n.concat(s);
          }
          getFunctionArgs_(e, t, n) {
            ...
            switch (n) {
              case "integral": {
                ...
                return (
                  (i = l.getInstance().integralNode_(e, r, n.intvar)),
                  n.rest.unshift(i),
                  n.rest
                );
              }
              case "prefix":
                if (t[0] && "fenced" === t[0].type) {
                  ...
                  return (
                    ...
                    (i = l.getInstance().functionNode_(e, n)),
                    t.unshift(i),
                    t
                  );
                }
                if (
                  ...
                  (o = l.getInstance().row(r.head)),
                    r.div && r.tail.unshift(r.div);
                else {
                  if (!r.div || !a.isType(r.div, "appl"))
                    return t.unshift(e), t;
                  o = r.div;
                }
                return (
                  (i = l.getInstance().functionNode_(e, o)),
                  r.tail.unshift(i),
                  r.tail
                );
              case "bigop":
                return (
                  ...
                  r.head.length
                    ? ((o = l.getInstance().row(r.head)),
                      (i = l.getInstance().bigOpNode_(e, o)),
                      r.div && r.tail.unshift(r.div),
                      r.tail.unshift(i),
                      r.tail)
                    : (t.unshift(e), t)
              ...
              default: {
                ...
                return "fenced" === n.type &&
                  ...
                  ? ((n.role = "leftright"),
                    ...
                    (i = l.getInstance().functionNode_(e, t.shift())),
                    t.unshift(i),
                    t)
                  : (t.unshift(e), t);
              }
          ...
          functionNode_(e, t) {
            const n = l
                .getInstance()
                .factory_.makeContentNode(o.functionApplication()),
            ...
            r &&
              ...
              (n.type = "punctuation"),
              (n.role = "application");
            const i = l.getFunctionOp_(e, function (e) {
              return (
                a.isType(e, "function") ||
                (a.isType(e, "identifier") && a.isRole(e, "simple function"))
              );
            });
            return l.getInstance().functionalNode_("appl", [e, t], i, [n]);
          }
          bigOpNode_(e, t) {
          ...
          integralNode_(e, t, n) {
            ...
            return l
              .getInstance()
              .functionalNode_("integral", [e, t, n], r, []);
          }
          functionalNode_(e, t, n, r) {
            const o = t[0];
            let i;
            n && ((i = n.parent), r.push(n));
            const s = l.getInstance().factory_.makeBranchNode(e, t, r);
            return (s.role = o.role), i && (n.parent = i), s;
          }
          fractionNode_(e, t) {
            const n = l
              .getInstance()
              .factory_.makeBranchNode("fraction", [e, t], []);
            return (
              (n.role = n.childNodes.every(function (e) {
                ...
                ? "unit"
                : "division"),
              i.run("propagateSimpleFunction", n)
            );
          }
          scriptNode_(e, t, n) {
            let r;
          ...
          findNestedRow_(e, t, n, o) {
            if (n > 3) return null;
            for (let i, s = 0; (i = e[s]); s++) {
              const e = r.tagName(i);
              if ("MSPACE" !== e) {
                if ("MROW" === e)
                  return l
                    .getInstance()
                    .findNestedRow_(r.toArray(i.childNodes), t, n + 1, o);
                if (l.findSemantics(i, t, o)) return i;
              }
            }
            return null;
          }
      ...
      7984: function (e, t, n) {
        ...
        class s {
            ...
            return e.reduce((e, t) => {
              return e.concat(
                ...
                s.simpleCollapseStructure(n)
                  ? [n]
                  : ((n = n),
                    s.contentCollapseStructure(n[1])
                      ? n.slice(2)
                      : n.slice(1))),
              );
              var n;
          ...
          static fromNode_(e) {
            ...
            const o = r.map(s.fromNode_);
            return t.length && o.unshift(n), o.unshift(e.id), o;
          }
          static tree_(e, t) {
            if (!t) return [];
            ...
            const n = t.id,
              r = [n],
              a = o.evalXPath(`.//self::*[@${i.Attribute.ID}=${n}]`, e)[0],
          ...
          static addOwns_(e, t) {
            const n = e.getAttribute(i.Attribute.COLLAPSED),
              r = n ? s.realLeafs_(s.fromString(n).array) : t.map((e) => e.id);
            e.setAttribute(i.Attribute.OWNS, r.join(" "));
          }
          static realLeafs_(e) {
      ...
      1784: function (e, t, n) {
        ...
        class l {
          ...
          static fromXml(e) {
            ...
            return (
              e.childNodes[0] &&
                (t.root = a.SemanticNode.fromXml(e.childNodes[0])),
              t
            );
          }
          xml(e) {
        ...
        t.SemanticTree = l;
        const u = new i.SemanticVisitor("general", "unit", (e, t) => {
          if (
            "infixop" === e.type &&
      ...
      8901: function (e, t, n) {
        ...
        function i(e, t, n) {
          n && e.reverse();
          const r = [];
          for (let o, i = 0; (o = e[i]); i++) {
            if (t(o))
              return n
                ? { head: e.slice(i + 1).reverse(), div: o, tail: r.reverse() }
                : { head: r, div: o, tail: e.slice(i + 1) };
            r.push(o);
          }
          return n
        ...
        (t.LEAFTAGS = ["MO", "MI", "MN", "MTEXT", "MS", "MSPACE"]),
          ...
          (t.isOrphanedGlyph = function (e) {
            return !!e && "MGLYPH" === r.tagName(e) && !o(e.parentNode);
          }),
          (t.purgeNodes = function (e) {
            const n = [];
            for (let o, i = 0; (o = e[i]); i++) {
              if (o.nodeType !== r.NodeType.ELEMENT_NODE) continue;
              const e = r.tagName(o);
              -1 === t.IGNORETAGS.indexOf(e) &&
                ((-1 !== t.EMPTYTAGS.indexOf(e) && 0 === o.childNodes.length) ||
                  n.push(o));
            }
            return n;
          }),
          ...
          (t.addAttributes = function (e, n) {
            if (n.hasAttributes()) {
              ...
              for (let n = r.length - 1; n >= 0; n--) {
                const o = r[n].name;
                o.match(/^ext/) &&
                  ((e.attributes[o] = r[n].value), (e.nobreaking = !0)),
                  -1 !== t.directSpeechKeys.indexOf(o) &&
                    ((e.attributes["ext-speech"] = r[n].value),
                    (e.nobreaking = !0)),
                  o.match(/texclass$/) && (e.attributes.texclass = r[n].value),
                  "href" === o &&
          ...
          (t.partitionNodes = function (e, t) {
            ...
            let s = null;
            do {
              (s = i(n, t)), o.push(s.head), r.push(s.div), (n = s.tail);
            } while (s.div);
            return r.pop(), { rel: r, comp: o };
          });
      },
      9135: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        t.AbstractSpeechGenerator = class {
          ...
          setOptions(e) {
            (this.options_ = e || {}),
              (this.modality = o.addPrefix(this.options_.modality || "speech"));
          }
          getOptions() {
          ...
          generateSpeech(e, t) {
            return (
              this.rebuilt_ || (this.rebuilt_ = new i.RebuildStree(t)),
      ...
      6281: function (e, t, n) {
        ...
        class c extends a.AbstractSpeechGenerator {
            ...
            if (e.childNodes.length) {
              if (
                ...
                if ("implicit" === e.role) {
                  ...
                  return t.push(r), void o.forEach((e) => t.push(e));
                }
          ...
          generateSpeech(e, t) {
            return (
              this.getRebuilt() || this.setRebuilt(new i.RebuildStree(e)),
              this.colorLeaves_(e),
      ...
      144: function (e, t, n) {
        ...
        function m(e, t) {
          ...
          for (let e, n = 0; (e = t[n]); n++) if (o(e, r.slice())) return e;
          return n;
        }
        function g(e) {
          return e
        ...
        (t.computeSpeech = u),
          ...
          (t.connectMactions = function (e, t, n) {
            ...
            for (let t, i = 0; (t = r[i]); i++) {
              const r = t.getAttribute("id"),
                i = o.querySelectorAllByAttrValue(e, "id", r)[0];
              if (!i) continue;
              ...
              if (
                ((u = i.childNodes[0]), u.getAttribute("sre-highlighter-added"))
              )
                continue;
              ...
              o.querySelectorAllByAttrValue(n, "id", c)[0].setAttribute(
                "alternative",
                c,
              );
            }
          ...
          (t.connectAllMactions = function (e, t) {
            ...
            for (let e, r = 0; (e = n[r]); r++) {
              ...
              o.querySelectorAllByAttrValue(t, "id", n)[0].setAttribute(
                "alternative",
                n,
              );
            }
      ...
      5778: function (e, t, n) {
        ...
        class i extends r.AbstractSpeechGenerator {
          getSpeech(e, t) {
            return (
              o.connectAllMactions(t, this.getRebuilt().xml),
              this.generateSpeech(e, t)
            );
          }
        }
        t.SummarySpeechGenerator = i;
      },
      7486: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        class a extends i.AbstractSpeechGenerator {
          getSpeech(e, t) {
            ...
            for (const n in i) {
              const a = i[n],
                c = o.getBySemanticId(t, n),
                l = o.getBySemanticId(e, n);
              c &&
                l &&
      ...
      650: function (e, t, n) {
        ...
        function f(e) {
          const t =
            "normal" === e || "fullwidth" === e
              ? ""
              : i.LOCALE.MESSAGES.font[e] ||
                i.LOCALE.MESSAGES.embellish[e] ||
                "";
          return (0, s.localeFontCombiner)(t);
        }
        function m(e, n, r, o, s, a) {
          const c = f(o);
          for (let o, l, u, d = 0; (o = e[d]), (l = n[d]), (u = r[d]); d++) {
            const e = a
        ...
        function g(e, n, r, o, s) {
          ...
          for (let r, c, l = 0; (r = e[l]), (c = n[l]); l++) {
            const e = i.LOCALE.ALPHABETS.digitPrefix,
              n = l + s;
            b(
              a.combiner,
              r,
        ...
        function b(e, t, n, r, o, i, s, c, l) {
          for (let u, d = 0; (u = l[d]); d++) {
            const l = u in c ? c[u] : c.default,
              d = u in i ? i[u] : i.default;
            a.defineRule(t.toString(), u, "default", s, n, e(l(r), o, d));
          }
        }
        !(function (e) {
          (e.BOLD = "bold"),
          ...
          (t.generate = function (e) {
            ...
            (r.default.getInstance().locale = n), o.setLocale();
          }),
          (t.makeInterval = h),
          (t.getFont = f),
          (t.alphabetRules = m),
      ...
      3955: function (e, t, n) {
        ...
        class l extends i.DynamicCstr {
          ...
          static toPreference(e) {
            ...
            return n.length ? n.join(":") : i.DynamicCstr.DEFAULT_VALUE;
          }
          static getLocalePreferences(e) {
            const t =
              e || a.enumerate(c.SpeechRuleEngine.getInstance().enumerate());
          ...
          static smartPreferences(e, t) {
            ...
            const r = e.explorers.speech,
              i = l.relevantPreferences(
                r.walker.getFocus().getSemanticPrimary(),
              ),
          ...
          static getLocalePreferences_(e) {
            ...
            for (const n in e) {
              ...
              for (const e in u.getProperties()) {
                ...
                if (t)
                  for (const o of t)
                    -1 !== r.indexOf(e + "_" + o) && n.push(e + "_" + o);
                o[e] = n;
              }
            }
            return t;
        ...
        class d extends s.DefaultComparator {
          ...
          compare(e, t) {
            ...
            if (r && !o) return -1;
            if (!r && !o) return 0;
            const i = Object.keys(e.preference).length,
              s = Object.keys(t.preference).length;
            return i > s ? -1 : i < s ? 1 : 0;
          }
        }
        t.Comparator = d;
        class p extends s.DynamicCstrParser {
          constructor() {
            super([
              s.Axis.LOCALE,
              s.Axis.MODALITY,
          ...
          parse(e) {
            ...
            const r = t.getValue(s.Axis.LOCALE),
              o = t.getValue(s.Axis.MODALITY);
            let a = {};
            return (
              n !== i.DynamicCstr.DEFAULT_VALUE &&
                ((a = this.fromPreference(n)), (n = this.toPreference(a))),
              new l(
                { locale: r, modality: o, domain: "clearspeak", style: n },
                a,
              )
            );
          }
      ...
      8662: function (e, t, n) {
        ...
        function f(e) {
          return (
            ...
            (y(e.childNodes[1]) ||
              ("fenced" === e.childNodes[1].type &&
                y(e.childNodes[1].childNodes[0])))
          );
        }
        function m(e) {
          return (
        ...
        function b(e) {
          return (
            ...
            ("infixop" === e.type &&
              "implicit" === e.role &&
              ((2 === e.childNodes.length &&
                (S(e.childNodes[0]) || N(e.childNodes[0])) &&
                S(e.childNodes[1])) ||
        ...
        function _(e) {
          return o.default.getInstance().style === e;
        }
        function v(e) {
        ...
        function O(e) {
          return i
            ...
            .every((e) => M(e) || "identifier" === e.tagName);
        }
        function T(e) {
          return (
            "text" === e.type ||
            ("punctuated" === e.type &&
              "text" === e.role &&
              E(e.childNodes[0]) &&
              x(e.childNodes.slice(1))) ||
            ("identifier" === e.type && "unit" === e.role) ||
            ("infixop" === e.type &&
              ("implicit" === e.role || "unit" === e.role))
          );
        }
        function x(e) {
        ...
        (t.nodeCounter = function (e, t) {
          ...
          return function () {
            const e = r();
            return s ? ((s = !1), i + e + o) : e + o;
          };
        }),
          (t.isSimpleExpression = h),
          (t.isSimpleFunction_ = f),
          (t.isSimpleNegative_ = m),
          (t.isSimpleDegree_ = g),
          (t.isSimpleLetters_ = b),
          (t.isSimple_ = y),
          (t.isLetter_ = S),
          (t.isNumber_ = E),
          (t.isSimpleNumber_ = N),
          ...
          (t.allCellsSimple = function (e) {
            ...
            return i.evalXPath(t, e).every(C) ? [e] : [];
          }),
          (t.isSmallVulgarFraction = function (e) {
            return (0, a.vulgarFractionSmall)(e, 20, 11) ? [e] : [];
          }),
          (t.isUnitExpression = T),
          (t.allTextLastContent_ = x),
          (0, u.register)(
          ...
          (t.nestingDepth = function (e) {
            ...
            const r = e.textContent,
              o = "open" === e.getAttribute("role") ? 0 : 1;
            let i = e.parentNode;
            for (; i; )
              "fenced" === i.tagName &&
                i.childNodes[0].childNodes[o].textContent === r &&
                n++,
                (i = i.parentNode);
            return (
          ...
          (t.matchingFences = function (e) {
            ...
            return (
              ...
              r && (0, p.isMatchingFence)(n.textContent, r.textContent)
                ? [e]
                : []
            );
          }),
          (t.insertNesting = I),
          c.Grammar.getInstance().setCorrection("insertNesting", I),
          (t.fencedArguments = function (e) {
            const t = r.toArray(e.parentNode.childNodes),
              n = i.evalXPath("../../children/*", e),
              o = t.indexOf(e);
            return P(n[o]) || P(n[o + 1]) ? [e] : [];
          }),
          (t.simpleArguments = function (e) {
            ...
            return L(n[o]) &&
              ...
              (L(n[o + 1]) ||
                "root" === n[o + 1].tagName ||
                "sqrt" === n[o + 1].tagName ||
                ("superscript" === n[o + 1].tagName &&
                  n[o + 1].childNodes[0].childNodes[0] &&
                  ("number" === n[o + 1].childNodes[0].childNodes[0].tagName ||
                    "identifier" ===
                      n[o + 1].childNodes[0].childNodes[0].tagName) &&
                  ("2" === n[o + 1].childNodes[0].childNodes[1].textContent ||
                    "3" === n[o + 1].childNodes[0].childNodes[1].textContent)))
              ? [e]
              : [];
          }),
          (t.simpleFactor_ = L),
      ...
      5659: function (e, t, n) {
        ...
        let m = !1;
        function g(e = i.default.getInstance().locale) {
          i.EnginePromise.loaded[e] ||
            ((i.EnginePromise.loaded[e] = [!1, !1]),
            (function (e) {
              if (
        ...
        function y(e) {
          const t = i.default.getInstance().customLoader
              ? i.default.getInstance().customLoader
              : b(),
            n = new Promise((n) => {
              t(e).then(
                (t) => {
                  S(t), (i.EnginePromise.loaded[e] = [!0, !0]), n(e);
                },
                (t) => {
                  (i.EnginePromise.loaded[e] = [!0, !1]),
        ...
        function E(e, t) {
          let n = !0;
          for (let r, o = 0; (r = Object.keys(e)[o]); o++) {
            const o = r.split("/");
            (t && t !== o[0]) ||
              ("rules" === o[1]
                ? d.SpeechRuleEngine.getInstance().addStore(e[r])
                : "messages" === o[1]
                ? (0, p.completeLocale)(e[r])
                : (n && (h.generate(o[0]), (n = !1)), e[r].forEach(f[o[1]])));
          }
        }
        function N(e, t) {
          let n = t || 1;
          o.mapsForIE
            ? E(o.mapsForIE, e)
            : n <= 5 && setTimeout((() => N(e, n++)).bind(this), 300);
        }
        function A(e) {
        ...
        (t.loadLocale = function (e = i.default.getInstance().locale) {
          return r(this, void 0, void 0, function* () {
            return (
              m || (g(l.DynamicCstr.BASE_LOCALE), (m = !0)),
              i.EnginePromise.promises[l.DynamicCstr.BASE_LOCALE].then(() =>
                r(this, void 0, void 0, function* () {
                  const t = i.default.getInstance().defaultLocale;
                  return t
                    ? (g(t),
                      i.EnginePromise.promises[t].then(() =>
                        r(this, void 0, void 0, function* () {
                          return g(e), i.EnginePromise.promises[e];
                        }),
                      ))
                    : (g(e), i.EnginePromise.promises[e]);
                }),
              )
            );
          });
          ...
          c.addStore(r.DynamicCstr.BASE_LOCALE + ".speech.mathspeak", "", {
            ...
            c.addStore(
              ...
              r.DynamicCstr.BASE_LOCALE + ".speech.mathspeak",
              {
                ...
                CSFleftsuperscriptVerbose: i.leftSuperscriptVerbose,
      ...
      3269: function (e, t, n) {
        ...
        function l(e, t) {
          ...
          for (let e, s = 0; (e = n[s]); s++) {
            const n = o.getNodeFactory().makeLeafNode(e, "unknown"),
              s = o.identifierNode(n, "unknown", "");
            t(s), r.push(s.xml(i));
          }
          return r;
        }
        function u(e, n, i, s, a, l) {
          ...
          const u = o.serializeXml(n);
          if ((c[e] || (c[e] = {}), c[e][u])) return c[e][u];
          if (l(n) || i.indexOf(n.tagName) < 0) return 0;
          const d = p(n, i, r.setdifference(s, i), a, l, 0);
          return (c[e][u] = d), d;
        }
        function d(e, t) {
          if (!e.attributes) return !1;
          const n = o.toArray(e.attributes);
          for (let e, r = 0; (e = n[r]); r++)
            if (t[e.nodeName] === e.nodeValue) return !0;
          return !1;
        }
        function p(e, t, n, r, i, s) {
          if (i(e) || n.indexOf(e.tagName) > -1 || d(e, r)) return s;
          if (
            (t.indexOf(e.tagName) > -1 && s++,
            !e.childNodes || 0 === e.childNodes.length)
          )
            return s;
          const a = o.toArray(e.childNodes);
        ...
        function f(e, t, n) {
          const r = h(e),
            o = Array(r).fill(t);
          return n && o.push(n), o.join(s.LOCALE.MESSAGES.regexp.JOINER_FRAC);
        }
        function m(e, t, n) {
          for (; e.parentNode; ) {
            const r = e.parentNode,
              o = r.parentNode;
            if (!o) break;
            const i = e.getAttribute && e.getAttribute("role");
            (("subscript" === o.tagName && e === r.childNodes[1]) ||
              ("tensor" === o.tagName &&
                i &&
                ("leftsub" === i || "rightsub" === i))) &&
              (t = n.sub + s.LOCALE.MESSAGES.regexp.JOINER_SUBSUPER + t),
              (("superscript" === o.tagName && e === r.childNodes[1]) ||
                ("tensor" === o.tagName &&
                  i &&
                  ("leftsuper" === i || "rightsuper" === i))) &&
        ...
        function b(e, t, n) {
          const r = g(e),
            o = y(e);
          return (
            (n = o ? s.LOCALE.FUNCTIONS.combineRootIndex(n, o) : n),
            1 === r
              ? n
        ...
        function y(e) {
          const t =
            "sqrt" === e.tagName
              ? "2"
              : i.evalXPath("children/*[1]", e)[0].textContent.trim();
          ...
          return u(
            ...
            function (e) {
              return (
                ...
                "underaccent" ===
                  e.childNodes[0].childNodes[1].getAttribute("role")
              );
            },
          );
        }
        ...
        (t.spaceoutText = function (e) {
          ...
          (t.getNestingDepth = u),
          (t.containsAttr = d),
          (t.computeNestingDepth_ = p),
          (t.fractionNestingDepth = h),
          (t.nestedFraction = f),
          ...
          (t.determinantIsSimple = function (e) {
            if (
              "matrix" !== e.tagName ||
              "determinant" !== e.getAttribute("role")
            )
              return [];
            const t = i.evalXPath("children/row/children/cell/children/*", e);
            for (let e, n = 0; (e = t[n]); n++)
              if ("number" !== e.tagName) {
          ...
          (t.generateBaselineConstraint = function () {
            const e = (e) => e.map((e) => "ancestor::" + e),
              ...
              r = e(["relseq", "multrel"]),
              o = e(["fraction", "punctuation", "fenced", "sqrt", "root"]);
            let i = [];
            ...
            return [
              ["ancestor::*/following-sibling::*", n, t(i.join(" | "))].join(
                " and ",
              ),
            ];
          }),
        ...
        (t.generateTensorRules = function (e, t = !0) {
          ...
          for (let r, o = 0; (r = n[o]); o++) {
            let n = "tensor" + r,
              [o, i, s] = _(r);
            e.defineRule(n, "default", i, "self::tensor", ...o),
              t &&
                (e.defineRule(n, "brief", s, "self::tensor", ...o),
                e.defineRule(n, "sbrief", s, "self::tensor", ...o));
            const a = N.get(2);
            (i += "; [t]" + a + "Verbose"),
              (s += "; [t]" + a + "Brief"),
              (n += "-baseline");
            ...
            e.defineRule(n, "default", i, "self::tensor", c, ...o),
              t &&
                (e.defineRule(n, "brief", s, "self::tensor", c, ...o),
                e.defineRule(n, "sbrief", s, "self::tensor", c, ...o));
          }
        }),
      ...
      9570: function (e, t, n) {
        ...
        function p(e, t) {
          ...
          return 1 === n
            ? t
            : new Array(n).join(u.LOCALE.MESSAGES.MS.NESTED) + t;
        }
        function h(e, t) {
          const n = t || 0;
          return e.parentNode
            ? h(
                e.parentNode,
                "root" === e.tagName || "sqrt" === e.tagName ? n + 1 : n,
              )
            : n;
        }
        function f(e) {
        ...
        function m(e, n) {
          ...
          const o = r.type;
          return (
            -1 !== t.NUMBER_PROPAGATORS_.indexOf(o) ||
            ("prefixop" === o && "negative" === r.role && !n.script) ||
            ("prefixop" === o && "geometry" === r.role) ||
            !("punctuated" !== o || (n.enclosed && "text" !== r.role))
          );
        }
        function g(e, n) {
        ...
        (t.openingFraction = function (e) {
          ...
          (t.nestedRadical = p),
          (t.radicalNestingDepth = h),
          (t.openingRadical = function (e) {
            return p(e, u.LOCALE.MESSAGES.MS.STARTROOT);
          }),
          (t.closingRadical = function (e) {
            return p(e, u.LOCALE.MESSAGES.MS.ENDROOT);
          }),
          (t.indexRadical = function (e) {
            return p(e, u.LOCALE.MESSAGES.MS.ROOTINDEX);
          }),
          (t.enlargeFence = f),
          ...
          (t.propagateNumber = g),
          (0, c.register)(
            new l.SemanticVisitor("nemeth", "number", g, { number: !0 }),
          ),
          (t.relationIterator = function (e, t) {
            ...
            let s,
              c = !0;
            return (
              (s = e.length > 0 ? i.evalXPath("../../content/*", e[0]) : []),
              function () {
                const e = s.shift(),
                  i = n.shift(),
                  l = n[0],
      ...
      2110: function (e, t, n) {
        ...
        (t.ordinalCounter = function (e, t) {
          let n = 0;
          return function () {
            return i.LOCALE.NUMBERS.numericOrdinal(++n) + " " + t;
          };
        }),
          (t.wordCounter = function (e, t) {
            let n = 0;
            return function () {
              return i.LOCALE.NUMBERS.numberToOrdinal(++n, !1) + " " + t;
            };
          }),
          (t.vulgarFraction = function (e) {
            const t = (0, s.convertVulgarFraction)(
              e,
              i.LOCALE.MESSAGES.MS.FRAC_OVER,
            );
            return t.convertible && t.enumerator && t.denominator
              ? [
                  new r.Span(i.LOCALE.NUMBERS.numberToWords(t.enumerator), {
                    extid: e.childNodes[0].childNodes[0].getAttribute("extid"),
                    separator: "",
                  }),
                  new r.Span(i.LOCALE.NUMBERS.vulgarSep, { separator: "" }),
                  new r.Span(
                    ...
                    {
                      extid:
                        e.childNodes[0].childNodes[1].getAttribute("extid"),
                    },
                  ),
                ]
              : [
                  new r.Span(t.content || "", {
                    extid: e.getAttribute("extid"),
                  }),
                ];
          }),
          (t.ordinalPosition = function (e) {
            const t = o.toArray(e.parentNode.childNodes);
            return i.LOCALE.NUMBERS.numericOrdinal(t.indexOf(e) + 1).toString();
          });
      },
      3724: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.BrailleRules = function () {
            c.addStore(
              ...
              r.DynamicCstr.BASE_LOCALE + ".speech.mathspeak",
              {
                ...
                CGFtensorRules: (e) => i.generateTensorRules(e, !1),
      ...
      7278: function (e, t, n) {
        ...
        (t.funcStore = new Map()),
          (t.addStore = function (e, n, r) {
            ...
            t.funcStore.set(e, Object.assign(o, r));
          }),
          (t.getStore = function (e, n, o) {
            return (
              t.funcStore.get([e, n, o].join(".")) ||
              t.funcStore.get(
                [r.DynamicCstr.DEFAULT_VALUES[r.Axis.LOCALE], n, o].join("."),
              ) ||
              t.funcStore.get([r.DynamicCstr.BASE_LOCALE, n, o].join(".")) ||
              {}
            );
          });
      },
        ...
        t.unitMultipliers = function (e, t) {
          ...
          return function () {
            const e = r.AuditoryDescription.create(
              {
                text: a(n[o]) && c(n[o + 1]) ? i.LOCALE.MESSAGES.unitTimes : "",
              },
              {},
            );
            return o++, [e];
      ...
      4660: function (e, t, n) {
        ...
        class N {
          constructor(e, t, n, r) {
            (this.node = e),
              ...
              this.node.id
                ...
                : this.node.hasAttribute(N.SRE_ID_ATTR)
                ? (this.id = this.node.getAttribute(N.SRE_ID_ATTR))
                : (this.node.setAttribute(
                    N.SRE_ID_ATTR,
                    N.ID_COUNTER.toString(),
                  ),
                  (this.id = N.ID_COUNTER++)),
              (this.rootNode = S.getSemanticRoot(e)),
              (this.rootId = this.rootNode.getAttribute(l.Attribute.ID)),
              (this.xmlString_ = r),
              (this.moved = y.WalkerMoves.ENTER);
          }
          getXml() {
            return (
              this.xml_ || (this.xml_ = i.parseInput(this.xmlString_)),
              this.xml_
            );
          }
          getRebuilt() {
          ...
          deactivate() {
            this.isActive() &&
              (y.WalkerState.setState(this.id, this.primaryId()),
              this.generator.end(),
              this.toggleActive_());
          }
          getFocus(e = !1) {
          ...
          speech() {
            ...
            if (null !== t) return t;
            switch (this.moved) {
              case y.WalkerMoves.DEPTH:
                return this.depth_();
              case y.WalkerMoves.SUMMARY:
                return this.summary_();
              case y.WalkerMoves.DETAIL:
                return this.detail_();
              default: {
                const t = [],
                ...
                for (let r = 0, o = e.length; r < o; r++) {
                  ...
                  t.push(
                    o
                      ? this.generator.getSpeech(o, this.getXml())
                      : f.recomputeMarkup(i),
                  );
                }
          ...
          move(e) {
            ...
            return (
              !(!n || n === this.getFocus()) &&
              (this.setFocus(n),
              this.moved === y.WalkerMoves.HOME &&
                (this.levels = this.initLevels()),
              !0)
            );
          }
          up() {
            return (this.moved = y.WalkerMoves.UP), this.getFocus();
          }
          down() {
            return (this.moved = y.WalkerMoves.DOWN), this.getFocus();
          }
          left() {
            return (this.moved = y.WalkerMoves.LEFT), this.getFocus();
          }
          right() {
            return (this.moved = y.WalkerMoves.RIGHT), this.getFocus();
          }
          repeat() {
            return (this.moved = y.WalkerMoves.REPEAT), this.getFocus().clone();
          }
          depth() {
            return (
              (this.moved = this.isSpeech()
                ? y.WalkerMoves.DEPTH
                : y.WalkerMoves.REPEAT),
              this.getFocus().clone()
            );
          }
          home() {
          ...
          getBySemanticId(e) {
            return S.getBySemanticId(this.node, e);
          }
          primaryId() {
          ...
          expand() {
            ...
            return t
              ? ((this.moved = y.WalkerMoves.EXPAND),
          ...
          restoreState() {
            ...
            const e = y.WalkerState.getState(this.id);
            if (!e) return;
          ...
          previousLevel() {
            const e = this.getFocus().getDomPrimary();
            return e
              ? S.getAttribute(e, l.Attribute.PARENT)
          ...
          nextLevel() {
            ...
            let t, n;
            if (e) {
              (t = S.splitAttribute(S.getAttribute(e, l.Attribute.CHILDREN))),
                (n = S.splitAttribute(S.getAttribute(e, l.Attribute.CONTENT)));
              const r = S.getAttribute(e, l.Attribute.TYPE),
                o = S.getAttribute(e, l.Attribute.ROLE);
              return this.combineContentChildren(r, o, n, t);
            }
            const r = (e) => e.id.toString(),
              o = this.getRebuilt().nodeDict[this.primaryId()];
            return (
              (t = o.childNodes.map(r)),
              (n = o.contentNodes.map(r)),
              0 === t.length
                ? []
                : this.combineContentChildren(o.type, o.role, n, t)
            );
          }
          singletonFocus(e) {
            this.getRebuilt();
          ...
          retrieveVisuals(e) {
            ...
            for (const e of n)
              r[e] ||
                (o.push(e.toString()), (r[e] = !0), this.subtreeIds(e, r));
            return o;
          }
          subtreeIds(e, t) {
            const n = E.evalXPath(
          ...
          update(e) {
            this.generator.setOptions(e),
              (0, a.setup)(e).then(() =>
                h.generator("Tree").getSpeech(this.node, this.getXml()),
              );
          }
          nextRules() {
            ...
            return "speech" !== e.modality
              ...
              : ((s.DOMAIN_TO_STYLES[e.domain] = e.style),
                (e.domain =
                  "mathspeak" === e.domain ? "clearspeak" : "mathspeak"),
                (e.style = s.DOMAIN_TO_STYLES[e.domain]),
                this.update(e),
                (this.moved = y.WalkerMoves.REPEAT),
                this.getFocus().clone());
          }
          nextStyle(e, t) {
            if ("mathspeak" === e) {
          ...
          mergePrefix_(e, t = []) {
            ...
            return r && e.push(r), o.finalize(o.merge(t.concat(e)));
          }
          prefix_() {
            const e = this.getFocus().getDomNodes(),
              t = this.getFocus().getSemanticNodes();
            return e[0]
              ? S.getAttribute(e[0], l.Attribute.PREFIX)
              : f.retrievePrefix(t[0]);
          }
          postfix_() {
            const e = this.getFocus().getDomNodes();
            return e[0] ? S.getAttribute(e[0], l.Attribute.POSTFIX) : "";
          }
          depth_() {
            ...
            const t = this.getFocus().getDomPrimary(),
              n = this.expandable(t)
                ...
                : "",
              i = u.LOCALE.MESSAGES.navigate.LEVEL + " " + this.getDepth(),
              s = this.getFocus().getSemanticNodes(),
              a = f.retrievePrefix(s[0]),
              c = [
                new r.AuditoryDescription({ text: i, personality: {} }),
          ...
          detail_() {
            ...
            const r = f.computeMarkup(t),
              o = this.mergePrefix_([r]);
            return t.setAttribute("alternative", n), o;
          }
        }
        (t.AbstractWalker = N),
          (N.ID_COUNTER = 0),
          (N.SRE_ID_ATTR = "sre-explorer-id");
      },
      4296: function (e, t, n) {
        Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.DummyWalker = void 0);
        const r = n(4660);
      ...
      5658: function (e, t, n) {
        ...
        class o {
          ...
          static factory(e, t, n, i) {
            const s = (e) => r.getBySemanticId(i, e),
              a = n.nodeDict,
              c = s(e),
              l = t.map(s),
              u = t.map(function (e) {
            ...
            return (
              (d.domNodes = l),
              (d.domPrimary_ = c),
              (d.allNodes = o.generateAllVisibleNodes_(t, l, a, i)),
              d
            );
          }
          static generateAllVisibleNodes_(e, t, n, i) {
            const s = (e) => r.getBySemanticId(i, e);
            let a = [];
            for (let r = 0, c = e.length; r < c; r++) {
              ...
              const l = c.childNodes.map(function (e) {
                ...
                u = l.map(s);
              a = a.concat(o.generateAllVisibleNodes_(l, u, n, i));
            }
            return a;
          }
          getSemanticPrimary() {
          ...
          clone() {
            const e = new o(this.nodes, this.primary);
            return (
        ...
        class p {
          constructor(e) {
            (this.mathml = e),
              ...
              (this.stree = l.SemanticTree.fromNode(
                this.streeRoot,
                this.mathml,
              )),
          ...
          static textContent(e, t, n) {
            if (!n && t.textContent)
              return void (e.textContent = t.textContent);
            const r = d.splitAttribute(d.getAttribute(t, o.Attribute.OPERATOR));
          ...
          assembleTree(e) {
            const t = this.makeNode(e),
              n = d.splitAttribute(d.getAttribute(e, o.Attribute.CHILDREN)),
              r = d.splitAttribute(d.getAttribute(e, o.Attribute.CONTENT));
            if (
              (p.addAttributes(t, e, !(n.length || r.length)),
              0 === r.length && 0 === n.length)
            )
              return p.textContent(t, e), t;
            if (r.length > 0) {
              const e = d.getBySemanticId(this.mathml, r[0]);
              e && p.textContent(t, e, !0);
            }
            (t.contentNodes = r.map((e) => this.setParent(e, t))),
              (t.childNodes = n.map((e) => this.setParent(e, t)));
            const i = d.getAttribute(e, o.Attribute.COLLAPSED);
            return i ? this.postProcess(t, i) : t;
          }
          makeNode(e) {
            const t = d.getAttribute(e, o.Attribute.TYPE),
              n = d.getAttribute(e, o.Attribute.ROLE),
              r = d.getAttribute(e, o.Attribute.FONT),
              i = d.getAttribute(e, o.Attribute.ANNOTATION) || "",
              s = d.getAttribute(e, o.Attribute.ID),
              a = d.getAttribute(e, o.Attribute.EMBELLISHED),
              c = d.getAttribute(e, o.Attribute.FENCEPOINTER),
          ...
          makePunctuation(e) {
            ...
            return (
              t.updateContent((0, i.invisibleComma)()), (t.role = "dummy"), t
            );
          }
          makePunctuated(e, t, n) {
            ...
            (r.type = "punctuated"),
              ...
              (r.role = n);
            const o = t.splice(1, 1)[0].slice(1);
            (r.contentNodes = o.map(this.makePunctuation.bind(this))),
          ...
          makeIndex(e, t, n) {
            if (p.isPunctuated(t))
              return this.makePunctuated(e, t, n), void (t = t[0]);
          ...
          collapsedChildren_(e) {
            const t = (e) => {
              ...
              for (let r = 1, o = e.length; r < o; r++) {
                const o = e[r];
                n.childNodes.push(
                  c.SemanticSkeleton.simpleCollapseStructure(o)
                    ? this.nodeDict[o]
                    : t(o),
                );
              }
        ...
        class i extends r.AbstractWalker {
          ...
          combinePunctuations(e, t, n, r) {
            ...
            const o = e.shift(),
              i = t.shift();
            return o === i
              ? (n.push(i), this.combinePunctuations(e, t, n, r))
              : (t.unshift(i),
                n.push(o),
                e.length === t.length
                  ? (r.push(this.focusFromId(o, n.concat(t))), r)
                  : (r.push(this.focusFromId(o, n)),
      ...
      3531: function (e, t, n) {
        ...
        class s extends o.AbstractWalker {
          ...
          combineContentChildren(e, t, n, o) {
            switch (e) {
              case "relseq":
              case "infixop":
              case "multirel":
                return (0, r.interleaveLists)(o, n);
              case "prefixop":
                return n.concat(o);
              case "postfixop":
                return o.concat(n);
              ...
              case "vector":
              case "fenced":
                return o.unshift(n[0]), o.push(n[1]), o;
              case "cases":
                return o.unshift(n[0]), o;
              case "punctuated":
                return "text" === t ? (0, r.interleaveLists)(o, n) : o;
              case "appl":
                return [o[0], n[0], o[1]];
              case "root":
                return [o[1], o[0]];
        ...
        class a extends i.SyntaxWalker {
          constructor(e, t, n, r) {
            super(e, t, n, r),
              ...
              this.keyMapping.set(o.KeyCode.ZERO, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.ONE, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.TWO, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.THREE, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.FOUR, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.FIVE, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.SIX, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.SEVEN, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.EIGHT, this.jumpCell.bind(this)),
              this.keyMapping.set(o.KeyCode.NINE, this.jumpCell.bind(this));
          }
          move(e) {
            this.key_ = e;
          ...
          jumpCell() {
            ...
            if (this.moved === s.WalkerMoves.ROW) {
              ...
              const e = this.key_ - o.KeyCode.ZERO;
          ...
          verticalMove_(e) {
            ...
            const n = this.getFocus(),
              ...
              o = this.levels.pop(),
              i = this.levels.indexOf(t),
              s = this.levels.get(e ? i + 1 : i - 1);
            ...
            return a[r]
              ...
              : (this.setFocus(n), this.levels.push(o), null);
          }
          jumpCell_(e, t) {
            this.firstJump
              ? this.virtualize(!1)
            ...
            const o = this.currentTable_.childNodes[e - 1];
            return (
              this.setFocus(this.singletonFocus(o.id.toString())),
              this.levels.push(this.nextLevel()),
              this.singletonFocus(o.childNodes[t - 1].id.toString())
            );
          }
          isLegalJump_(e, t) {
            ...
            const o = this.currentTable_.childNodes[e - 1];
            if (!o) return !1;
            const i = r.querySelectorAllByAttrValue(
              n,
              "id",
              o.id.toString(),
            )[0];
      ...
      907: function (e, t, n) {
        ...
        (t.walker = function (e, n, r, o, i) {
          ...
          (t.walkerMapping_ = {
            dummy: (e, t, n, o) => new r.DummyWalker(e, t, n, o),
            semantic: (e, t, n, r) => new o.SemanticWalker(e, t, n, r),
            syntax: (e, t, n, r) => new i.SyntaxWalker(e, t, n, r),
      ...
      8835: function (e, t, n) {
        ...
        (t.splitAttribute = function (e) {
          ...
          (t.getSemanticRoot = function (e) {
            if (
              e.hasAttribute(o.Attribute.TYPE) &&
              !e.hasAttribute(o.Attribute.PARENT)
            )
              return e;
            const t = r.querySelectorAllByAttr(e, o.Attribute.TYPE);
            for (let e, n = 0; (e = t[n]); n++)
              if (!e.hasAttribute(o.Attribute.PARENT)) return e;
            return e;
          }),
          (t.getBySemanticId = function (e, t) {
            return e.getAttribute(o.Attribute.ID) === t
              ? e
              : r.querySelectorAllByAttrValue(e, o.Attribute.ID, t)[0];
          });
      },
    },
  ...
  var __webpack_exports__ = {},
    ...
    MmlVisitor,
    SelectableInfo;
  (global = __webpack_require__(8723)),
    (version = __webpack_require__(7306)),
    (MJContextMenu = __webpack_require__(3021)),
    (Menu = __webpack_require__(1062)),
    (MenuHandler = __webpack_require__(9003)),
    (MmlVisitor = __webpack_require__(9232)),
    (SelectableInfo = __webpack_require__(7309)),
    MathJax.loader && MathJax.loader.checkVersion("ui/menu", version.q, "ui"),
    ...
    MathJax.startup &&
      ...
      MathJax.startup.extendHandler(function (e) {
        return (0, MenuHandler.MenuHandler)(e);
      }, 20);
})();
