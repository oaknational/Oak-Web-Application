module.exports = {
  ...
  env: config => ({
    ...
    NEXT_PUBLIC_SANITY_ASSET_CDN_HOST: process.env.NEXT_PUBLIC_SANITY_ASSET_CDN_HOST,
  ...
  addons: ["@storybook/addon-links", "@storybook/addon-essentials", "@storybook/addon-interactions", "storybook-css-modules-preset", "storybook-addon-themes", "@storybook/addon-storysource", "@storybook/addon-a11y", "@storybook/addon-mdx-gfm", "storybook-addon-next"],
  framework: {
