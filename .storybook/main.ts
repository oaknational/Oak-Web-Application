...
export default {
  env: (config) => ({
    ...
    NEXT_PUBLIC_OAK_USER_LOG_URL: process.env.NEXT_PUBLIC_OAK_USER_LOG_URL,
    NEXT_PUBLIC_DOWNLOAD_API_URL: process.env.NEXT_PUBLIC_DOWNLOAD_API_URL,
    NEXT_PUBLIC_SEO_APP_URL: "NEXT_PUBLIC_SEO_APP_URL",
  }),
